...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "admission.k8s.io", kind: "DeleteOptions", version: "v1alpha1")]
  ...
  @[::K8S::GroupVersionKind(group: "autoscaling", kind: "DeleteOptions", version: "v2alpha1")]
  ...
  @[::K8S::GroupVersionKind(group: "federation", kind: "DeleteOptions", version: "v1beta1")]
