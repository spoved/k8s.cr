...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "admission.k8s.io", kind: "WatchEvent", version: "v1alpha1")]
  ...
  @[::K8S::GroupVersionKind(group: "autoscaling", kind: "WatchEvent", version: "v2alpha1")]
  ...
  @[::K8S::GroupVersionKind(group: "federation", kind: "WatchEvent", version: "v1beta1")]
