...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Apis::Networking::V1::NetworkPolicySpec | Nil, default: nil},
  ...
  class Kubernetes::Apis::Networking::V1::NetworkPolicyList < ::K8S::Kubernetes::ResourceList(Kubernetes::Apis::Networking::V1::NetworkPolicy)
