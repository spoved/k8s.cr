...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "storage.k8s.io", kind: "StorageClassList", version: "v1beta1")]
  ...
  class Kubernetes::Apis::Storage::V1beta1::StorageClassList < ::K8S::Kubernetes::Resource
