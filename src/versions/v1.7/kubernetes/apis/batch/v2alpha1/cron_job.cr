...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "batch", kind: "ScheduledJob", version: "v2alpha1")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/batch/v2alpha1/namespaces/{namespace}/scheduledjobs/{name}", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "exact", type: Bool | Nil, default: nil},
           {name: "export", type: Bool | Nil, default: nil},
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/batch/v2alpha1/namespaces/{namespace}/scheduledjobs/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "patch", verb: "path",
    path: "/apis/batch/v2alpha1/namespaces/{namespace}/scheduledjobs/{name}", toplevel: false,
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/batch/v2alpha1/namespaces/{namespace}/scheduledjobs/{name}/status", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
