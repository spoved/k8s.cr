...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "batch", kind: "CronJobList", version: "v2alpha1")]
  @[::K8S::GroupVersionKind(group: "batch", kind: "ScheduledJobList", version: "v2alpha1")]
  @[::K8S::Action(name: "list", verb: "get",
    path: "/apis/batch/v2alpha1/cronjobs", toplevel: true,
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Apis::Batch::V2alpha1::CronJobSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Apis::Batch::V2alpha1::CronJobStatus | Nil, default: nil},
  ...
  @[::K8S::Action(name: "post", verb: "post",
    path: "/apis/batch/v2alpha1/namespaces/{namespace}/scheduledjobs", toplevel: false,
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Apis::Batch::V2alpha1::CronJobSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Apis::Batch::V2alpha1::CronJobStatus | Nil, default: nil},
           {name: "context", type: String | Nil, default: nil}]
  ...
  @[::K8S::Action(name: "list", verb: "get",
    path: "/apis/batch/v2alpha1/namespaces/{namespace}/scheduledjobs", toplevel: true,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "field_selector", type: String | Nil, default: nil},
           {name: "include_uninitialized", type: Bool | Nil, default: nil},
           {name: "label_selector", type: String | Nil, default: nil},
  ...
  @[::K8S::Action(name: "list", verb: "get",
    path: "/apis/batch/v2alpha1/scheduledjobs", toplevel: true,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "field_selector", type: String | Nil, default: nil},
           {name: "include_uninitialized", type: Bool | Nil, default: nil},
           {name: "label_selector", type: String | Nil, default: nil},
