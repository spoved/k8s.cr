...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "autoscaling", kind: "HorizontalPodAutoscaler", version: "v2alpha1")]
  @[::K8S::Action(name: "post", verb: "post",
    path: "/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "list", verb: "get",
    path: "/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers", toplevel: true,
    args: [{name: "context", type: String | Nil, default: nil},
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil}]
  )]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "patch", verb: "path",
    path: "/apis/autoscaling/v2alpha1/namespaces/{namespace}/horizontalpodautoscalers/{name}/status", toplevel: false,
