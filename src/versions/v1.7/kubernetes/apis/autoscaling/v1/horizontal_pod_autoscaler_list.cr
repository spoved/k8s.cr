...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "autoscaling", kind: "HorizontalPodAutoscalerList", version: "v1")]
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscalerSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscalerStatus | Nil, default: nil},
  ...
  class Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscalerList < ::K8S::Kubernetes::ResourceList(Kubernetes::Apis::Autoscaling::V1::HorizontalPodAutoscaler)
