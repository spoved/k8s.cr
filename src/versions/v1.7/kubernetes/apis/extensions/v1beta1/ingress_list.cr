...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Apis::Extensions::V1beta1::IngressSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Apis::Extensions::V1beta1::IngressStatus | Nil, default: nil},
  ...
  class Kubernetes::Apis::Extensions::V1beta1::IngressList < ::K8S::Kubernetes::ResourceList(Kubernetes::Apis::Extensions::V1beta1::Ingress)
