...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "rbac.authorization.k8s.io", kind: "RoleList", version: "v1beta1")]
  ...
  class Kubernetes::Apis::Rbac::V1beta1::RoleList < ::K8S::Kubernetes::ResourceList(Kubernetes::Apis::Rbac::V1beta1::Role)
