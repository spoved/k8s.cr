...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "role_ref", type: Kubernetes::Apis::Rbac::V1beta1::RoleRef},
  ...
  class Kubernetes::Apis::Rbac::V1beta1::RoleBindingList < ::K8S::Kubernetes::ResourceList(Kubernetes::Apis::Rbac::V1beta1::RoleBinding)
