...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "rbac.authorization.k8s.io", kind: "ClusterRoleBindingList", version: "v1alpha1")]
  ...
  class Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBindingList < ::K8S::Kubernetes::ResourceList(Kubernetes::Apis::Rbac::V1alpha1::ClusterRoleBinding)
