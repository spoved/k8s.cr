...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "rbac.authorization.k8s.io", kind: "RoleBindingList", version: "v1alpha1")]
  @[::K8S::Action(name: "post", verb: "post",
    path: "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings", toplevel: false,
    args: [{name: "role_ref", type: Kubernetes::Apis::Rbac::V1alpha1::RoleRef},
  ...
  @[::K8S::Action(name: "list", verb: "get",
    path: "/apis/rbac.authorization.k8s.io/v1alpha1/rolebindings", toplevel: true,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "field_selector", type: String | Nil, default: nil},
           {name: "include_uninitialized", type: Bool | Nil, default: nil},
           {name: "label_selector", type: String | Nil, default: nil},
  ...
  class Kubernetes::Apis::Rbac::V1alpha1::RoleBindingList < ::K8S::Kubernetes::ResourceList(Kubernetes::Apis::Rbac::V1alpha1::RoleBinding)
