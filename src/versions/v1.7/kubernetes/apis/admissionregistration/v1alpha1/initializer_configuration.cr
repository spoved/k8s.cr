...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "admissionregistration.k8s.io", kind: "InitializerConfiguration", version: "v1alpha1")]
  ...
  class Kubernetes::Apis::Admissionregistration::V1alpha1::InitializerConfiguration < ::K8S::Kubernetes::Resource
  ...
  module Resources::Admissionregistration::V1alpha1
    alias InitializerConfiguration = ::K8S::Kubernetes::Apis::Admissionregistration::V1alpha1::InitializerConfiguration
  end
end
