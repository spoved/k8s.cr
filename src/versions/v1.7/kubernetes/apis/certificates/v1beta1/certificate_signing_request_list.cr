...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestStatus | Nil, default: nil},
  ...
  class Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequestList < ::K8S::Kubernetes::ResourceList(Kubernetes::Apis::Certificates::V1beta1::CertificateSigningRequest)
