...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "", kind: "LimitRange", version: "v1")]
  ...
  class Kubernetes::Api::V1::LimitRange < ::K8S::Kubernetes::Resource
  ...
  module Resources::V1
    alias LimitRange = ::K8S::Kubernetes::Api::V1::LimitRange
  end
end
