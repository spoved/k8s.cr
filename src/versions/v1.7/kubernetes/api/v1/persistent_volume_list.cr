...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "", kind: "PersistentVolumeList", version: "v1")]
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Api::V1::PersistentVolumeSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Api::V1::PersistentVolumeStatus | Nil, default: nil},
  ...
  class Kubernetes::Api::V1::PersistentVolumeList < ::K8S::Kubernetes::ResourceList(Kubernetes::Api::V1::PersistentVolume)
