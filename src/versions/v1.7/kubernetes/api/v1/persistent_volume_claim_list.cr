...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "", kind: "PersistentVolumeClaimList", version: "v1")]
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Api::V1::PersistentVolumeClaimSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Api::V1::PersistentVolumeClaimStatus | Nil, default: nil},
