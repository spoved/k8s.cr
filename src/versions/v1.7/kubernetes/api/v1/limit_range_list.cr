...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Api::V1::LimitRangeSpec | Nil, default: nil},
  ...
  class Kubernetes::Api::V1::LimitRangeList < ::K8S::Kubernetes::ResourceList(Kubernetes::Api::V1::LimitRange)
