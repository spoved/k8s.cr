...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "", kind: "NamespaceList", version: "v1")]
  @[::K8S::Action(name: "post", verb: "post",
    path: "/api/v1/namespaces", toplevel: false,
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Api::V1::NamespaceSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Api::V1::NamespaceStatus | Nil, default: nil},
  ...
  class Kubernetes::Api::V1::NamespaceList < ::K8S::Kubernetes::ResourceList(Kubernetes::Api::V1::Namespace)
