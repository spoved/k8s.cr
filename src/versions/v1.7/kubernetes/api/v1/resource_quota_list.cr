...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "", kind: "ResourceQuotaList", version: "v1")]
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Kubernetes::Api::V1::ResourceQuotaSpec | Nil, default: nil},
           {name: "status", type: Kubernetes::Api::V1::ResourceQuotaStatus | Nil, default: nil},
  ...
  class Kubernetes::Api::V1::ResourceQuotaList < ::K8S::Kubernetes::ResourceList(Kubernetes::Api::V1::ResourceQuota)
