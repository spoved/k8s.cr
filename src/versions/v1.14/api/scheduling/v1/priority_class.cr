...
module K8S
  ...
  class Api::Scheduling::V1::PriorityClass < ::K8S::Kubernetes::Resource::Object
    ...
    def initialize(*, api_version : String? = "scheduling/v1", kind : String? = "PriorityClass", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, description : String? = nil, global_default : ::Bool? = nil, value : Int32? = nil)
      super()
