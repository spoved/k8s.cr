...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "scheduling.k8s.io", kind: "PriorityClass", version: "v1beta1")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/scheduling.k8s.io/v1beta1/priorityclasses/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil},
           {name: "field_manager", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Scheduling::V1beta1::PriorityClass < ::K8S::Kubernetes::Resource
  ...
  module Resources::Scheduling::V1beta1
    alias PriorityClass = ::K8S::Api::Scheduling::V1beta1::PriorityClass
  end
end
