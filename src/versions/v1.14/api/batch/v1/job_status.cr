...
module K8S
  ...
  @[::K8S::Properties(
    ...
    conditions: {key: "conditions", accessor: "conditions", kind: "::Array(::K8S::Api::Batch::V1::JobCondition)", nilable: true, default: nil, read_only: false, description: "The latest available observations of an object's current state. More info: [https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/](https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/)", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Batch::V1::JobStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("active", active : Int32, true, false, "The number of actively running pods.")
    ...
    k8s_object_accessor("conditions", conditions : ::Array(::K8S::Api::Batch::V1::JobCondition), true, false, "The latest available observations of an object's current state. More info: [https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/](https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/)")
    k8s_object_accessor("failed", failed : Int32, true, false, "The number of pods which reached phase Failed.")
    k8s_object_accessor("startTime", start_time : ::Time, true, false, "Represents time when the job was acknowledged by the job controller. It is not guaranteed to be set in happens-before order across separate operations. It is represented in RFC3339 form and is in UTC.")
    k8s_object_accessor("succeeded", succeeded : Int32, true, false, "The number of pods which reached phase Succeeded.")

    def initialize(*, active : Int32? = nil, completion_time : ::Time? = nil, conditions : ::Array(::K8S::Api::Batch::V1::JobCondition)? = nil, failed : Int32? = nil, start_time : ::Time? = nil, succeeded : Int32? = nil)
      super()
      self.["active"] = active
