...
::K8S::Kubernetes::Resource.define_object("PodDisruptionBudgetSpec",
  ...
  properties: [
    ...
    {name: "selector", kind: ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector, key: "selector", nilable: true, read_only: false, description: "Label query over pods whose evictions are managed by the disruption budget."},
