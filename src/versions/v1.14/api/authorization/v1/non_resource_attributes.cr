...
module K8S
  ...
  class Api::Authorization::V1::NonResourceAttributes < ::K8S::GenericObject
    include ::K8S::Types::Api::Authorization::V1::NonResourceAttributes
    k8s_object_accessor("path", path : String, true, false, "Path is the URL path of the request")
    k8s_object_accessor("verb", verb : String, true, false, "Verb is the standard HTTP verb")
