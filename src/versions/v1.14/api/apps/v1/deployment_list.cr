...
module K8S::Types::Api::Apps::V1::DeploymentList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./deployment"

module K8S
  # Namespace holding the types for `Api::Apps::V1::DeploymentList`.
  module Types::Api::Apps::V1::DeploymentList
    ...
    abstract def items : Array(::K8S::Api::Apps::V1::Deployment)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Apps::V1::Deployment)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Apps::V1::Deployment)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Apps::V1::Deployment))
  end

  # DeploymentList is a list of Deployments.
  @[::K8S::GroupVersionKind(group: "apps", kind: "DeploymentList", version: "v1", full: "io.k8s.api.apps.v1.DeploymentList")]
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apps::V1::Deployment)", nilable: false, default: nil, read_only: false, description: "Items is the list of Deployments.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Apps::V1::DeploymentList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1::Deployment)
    include ::K8S::Types::Api::Apps::V1::DeploymentList
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Apps::V1::Deployment), false, false, "Items is the list of Deployments.")

    def initialize(*, api_version : String? = "apps/v1", kind : String? = "DeploymentList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Apps::V1::Deployment)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Apps::V1::Deployment)},
    ])
  end
end
