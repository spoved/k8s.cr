...
module K8S
  ...
  module Types::Api::Certificates::V1beta1::CertificateSigningRequest
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::K8S::Api::Certificates::V1beta1::CertificateSigningRequestSpec | ::K8S::Api::Certificates::V1beta1::CertificateSigningRequestStatus | Nil
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Certificates::V1beta1::CertificateSigningRequestSpec", nilable: true, default: nil, read_only: false, description: "The certificate request itself and any additional information."},
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Certificates::V1beta1::CertificateSigningRequestStatus", nilable: true, default: nil, read_only: false, description: "Derived information about the request."},
  )]
  class Api::Certificates::V1beta1::CertificateSigningRequest < ::K8S::Types::Api::Certificates::V1beta1::CertificateSigningRequest::Instance
    ...
    # The certificate request itself and any additional information.
    def spec : ::K8S::Api::Certificates::V1beta1::CertificateSigningRequestSpec?
      self.["spec"].as(::K8S::Api::Certificates::V1beta1::CertificateSigningRequestSpec?)
    end

    # :ditto:
    def spec! : ::K8S::Api::Certificates::V1beta1::CertificateSigningRequestSpec
      self.["spec"].as(::K8S::Api::Certificates::V1beta1::CertificateSigningRequestSpec?).not_nil!
    end
    ...
    # :ditto:
    def spec=(value : ::K8S::Api::Certificates::V1beta1::CertificateSigningRequestSpec?)
      self.["spec"] = value
    end

    # Derived information about the request.
    def status : ::K8S::Api::Certificates::V1beta1::CertificateSigningRequestStatus?
      self.["status"].as(::K8S::Api::Certificates::V1beta1::CertificateSigningRequestStatus?)
    end

    # :ditto:
    def status! : ::K8S::Api::Certificates::V1beta1::CertificateSigningRequestStatus
      self.["status"].as(::K8S::Api::Certificates::V1beta1::CertificateSigningRequestStatus?).not_nil!
    end
    ...
    # :ditto:
    def status=(value : ::K8S::Api::Certificates::V1beta1::CertificateSigningRequestStatus?)
      self.["status"] = value
    end
