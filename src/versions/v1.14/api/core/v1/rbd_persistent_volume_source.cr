...
module K8S
  ...
  class Api::Core::V1::RBDPersistentVolumeSource
    ...
    def initialize(*, @image : String, @monitors : Array(String), @fs_type : String | Nil = nil, @keyring : String | Nil = nil, @pool : String | Nil = nil, @read_only : Bool | Nil = nil, @secret_ref : Api::Core::V1::SecretReference | Nil = nil, @user : String | Nil = nil)
    end
  end
end
