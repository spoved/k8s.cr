...
module K8S
  ...
  class Api::Core::V1::CinderPersistentVolumeSource < ::K8S::GenericObject
    ...
    k8s_object_accessor("secretRef", secret_ref : ::K8S::Api::Core::V1::SecretReference, true, false, "Optional: points to a secret object containing parameters used to connect to OpenStack.")
    k8s_object_accessor("volumeID", volume_id : String, false, false, "volume id used to identify the volume in cinder More info: [https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md](https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md)")

    def initialize(*, fs_type : String? = nil, read_only : ::Bool? = nil, secret_ref : ::K8S::Api::Core::V1::SecretReference? = nil, volume_id : String? = nil)
      super()
      self.["fsType"] = fs_type
