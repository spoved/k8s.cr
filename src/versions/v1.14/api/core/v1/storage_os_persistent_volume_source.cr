...
module K8S
  ...
  class Api::Core::V1::StorageOSPersistentVolumeSource < ::K8S::GenericObject
    ...
    k8s_object_accessor("secretRef", secret_ref : ::K8S::Api::Core::V1::ObjectReference, true, false, "SecretRef specifies the secret to use for obtaining the StorageOS API credentials.  If not specified, default values will be attempted.")
    ...
    def initialize(*, fs_type : String? = nil, read_only : ::Bool? = nil, secret_ref : ::K8S::Api::Core::V1::ObjectReference? = nil, volume_name : String? = nil, volume_namespace : String? = nil)
      super()
      self.["fsType"] = fs_type
