...
module K8S
  ...
  class Api::Events::V1beta1::Event < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("deprecatedCount", deprecated_count : Int32, true, false, "Deprecated field assuring backward compatibility with core.v1 Event type")
    k8s_object_accessor("deprecatedFirstTimestamp", deprecated_first_timestamp : ::Time, true, false, "Deprecated field assuring backward compatibility with core.v1 Event type")
    k8s_object_accessor("deprecatedLastTimestamp", deprecated_last_timestamp : ::Time, true, false, "Deprecated field assuring backward compatibility with core.v1 Event type")
    k8s_object_accessor("deprecatedSource", deprecated_source : ::K8S::Api::Core::V1::EventSource, true, false, "Deprecated field assuring backward compatibility with core.v1 Event type")
    k8s_object_accessor("eventTime", event_time : ::Time, true, false, "Required. Time when this Event was first observed.")
    k8s_object_accessor("note", note : String, true, false, "Optional. A human-readable description of the status of this operation. Maximal length of the note is 1kB, but libraries should be prepared to handle values up to 64kB.")
    k8s_object_accessor("reason", reason : String, true, false, "Why the action was taken.")
    k8s_object_accessor("regarding", regarding : ::K8S::Api::Core::V1::ObjectReference, true, false, "The object this Event is about. In most cases it's an Object reporting controller implements. E.g. ReplicaSetController implements ReplicaSets and this event is emitted because it acts on some changes in a ReplicaSet object.")
    k8s_object_accessor("related", related : ::K8S::Api::Core::V1::ObjectReference, true, false, "Optional secondary object for more complex actions. E.g. when regarding object triggers a creation or deletion of related object.")
    k8s_object_accessor("reportingController", reporting_controller : String, true, false, "Name of the controller that emitted this Event, e.g. [`kubernetes.io/kubelet`.](`kubernetes.io/kubelet`.)")
