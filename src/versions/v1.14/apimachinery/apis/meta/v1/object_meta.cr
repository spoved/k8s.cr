...
module K8S
  ...
  class Apimachinery::Apis::Meta::V1::ObjectMeta < ::K8S::GenericObject
    ...
    k8s_object_accessor("initializers", initializers : ::K8S::Apimachinery::Apis::Meta::V1::Initializers, true, false, "An initializer is a controller which enforces some system invariant at object creation time. This field is a list of initializers that have not yet acted on this object. If nil or empty, this object has been completely initialized. Otherwise, the object is considered uninitialized and is hidden (in [list/watch and get calls) from clients that haven't explicitly asked to observe uninitialized objects.](list/watch and get calls) from clients that haven't explicitly asked to observe uninitialized objects.)\n\nWhen an object is created, the system will populate this list with the current set of initializers. Only privileged users may set or modify this list. Once it is empty, it may not be modified further by any user.\n\nDEPRECATED - initializers are an alpha field and will be removed in v1.15.")
    ...
    def initialize(*, annotations : ::Hash(String, String)? = nil, cluster_name : String? = nil, creation_timestamp : ::Time? = nil, deletion_grace_period_seconds : Int32? = nil, deletion_timestamp : ::Time? = nil, finalizers : ::Array(String)? = nil, generate_name : String? = nil, generation : Int32? = nil, initializers : ::K8S::Apimachinery::Apis::Meta::V1::Initializers? = nil, labels : ::Hash(String, String)? = nil, managed_fields : ::Array(::K8S::Apimachinery::Apis::Meta::V1::ManagedFieldsEntry)? = nil, name : String? = nil, namespace : String? = nil, owner_references : ::Array(::K8S::Apimachinery::Apis::Meta::V1::OwnerReference)? = nil, resource_version : String? = nil, self_link : String? = nil, uid : String? = nil)
      super()
