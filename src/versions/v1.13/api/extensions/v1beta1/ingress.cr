...
module K8S
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Extensions::V1beta1::IngressSpec", nilable: true, default: nil, read_only: false, description: "Spec is the desired state of the Ingress. More info: [https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)"},
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Extensions::V1beta1::IngressStatus", nilable: true, default: nil, read_only: false, description: "Status is the current state of the Ingress. More info: [https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)"},
  )]
