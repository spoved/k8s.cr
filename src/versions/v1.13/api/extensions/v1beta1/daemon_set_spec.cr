...
module K8S
  ...
  @[::K8S::Properties(
    ...
    selector: {key: "selector", accessor: "selector", kind: "::K8S::Apimachinery::Apis::Meta::V1::LabelSelector", nilable: true, default: nil, read_only: false, description: "A label query over pods that are managed by the daemon set. Must match in order to be controlled. If empty, defaulted to labels on Pod template. More info: [https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors)", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    template_generation: {key: "templateGeneration", accessor: "template_generation", kind: "Int32", nilable: true, default: nil, read_only: false, description: "DEPRECATED. A sequence number representing a specific generation of the template. Populated by the system. It can be set only during the creation.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    update_strategy: {key: "updateStrategy", accessor: "update_strategy", kind: "::K8S::Api::Extensions::V1beta1::DaemonSetUpdateStrategy", nilable: true, default: nil, read_only: false, description: "An update strategy to replace existing DaemonSet pods with new pods.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Extensions::V1beta1::DaemonSetSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("selector", selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector, true, false, "A label query over pods that are managed by the daemon set. Must match in order to be controlled. If empty, defaulted to labels on Pod template. More info: [https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors)")
    ...
    k8s_object_accessor("templateGeneration", template_generation : Int32, true, false, "DEPRECATED. A sequence number representing a specific generation of the template. Populated by the system. It can be set only during the creation.")
    k8s_object_accessor("updateStrategy", update_strategy : ::K8S::Api::Extensions::V1beta1::DaemonSetUpdateStrategy, true, false, "An update strategy to replace existing DaemonSet pods with new pods.")

    def initialize(*, min_ready_seconds : Int32? = nil, revision_history_limit : Int32? = nil, selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector? = nil, template : ::K8S::Api::Core::V1::PodTemplateSpec? = nil, template_generation : Int32? = nil, update_strategy : ::K8S::Api::Extensions::V1beta1::DaemonSetUpdateStrategy? = nil)
      super()
      self.["minReadySeconds"] = min_ready_seconds
      self.["revisionHistoryLimit"] = revision_history_limit
      self.["selector"] = selector
      self.["template"] = template
      self.["templateGeneration"] = template_generation
