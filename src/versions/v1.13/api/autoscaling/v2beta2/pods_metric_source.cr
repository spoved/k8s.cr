...
module K8S::Types::Api::Autoscaling::V2beta2::PodsMetricSource; end

require "./metric_identifier"
require "./metric_target"

module K8S
  # Namespace holding the types for `Api::Autoscaling::V2beta2::PodsMetricSource`.
  module Types::Api::Autoscaling::V2beta2::PodsMetricSource
  ...
  class Api::Autoscaling::V2beta2::PodsMetricSource < ::K8S::Types::Api::Autoscaling::V2beta2::PodsMetricSource::Instance
    include ::K8S::Types::Api::Autoscaling::V2beta2::PodsMetricSource
