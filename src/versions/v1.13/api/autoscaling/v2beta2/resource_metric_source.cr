...
module K8S
  ...
  class Api::Autoscaling::V2beta2::ResourceMetricSource < ::K8S::GenericObject
    ...
    def initialize(*, name : String? = nil, target : ::K8S::Api::Autoscaling::V2beta2::MetricTarget? = nil)
      super()
      self.["name"] = name
      self.["target"] = target
    end
