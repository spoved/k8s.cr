...
module K8S
  # Namespace holding the types for `Api::Autoscaling::V2beta2::MetricIdentifier`.
  module Types::Api::Autoscaling::V2beta2::MetricIdentifier
  ...
  class Api::Autoscaling::V2beta2::MetricIdentifier < ::K8S::Types::Api::Autoscaling::V2beta2::MetricIdentifier::Instance
    include ::K8S::Types::Api::Autoscaling::V2beta2::MetricIdentifier
