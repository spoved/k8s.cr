...
module K8S::Types::Api::Rbac::V1::Role; end

require "../../../apimachinery/apis/meta/v1/object_meta"
require "./policy_rule"

module K8S
  # Namespace holding the types for `Api::Rbac::V1::Role`.
  module Types::Api::Rbac::V1::Role
  ...
  class Api::Rbac::V1::Role < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("rules", rules : ::Array(::K8S::Api::Rbac::V1::PolicyRule), false, false, "Rules holds all the PolicyRules for this Role")

    def initialize(*, api_version : String? = "rbac.authorization.k8s.io/v1", kind : String? = "Role", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, rules : ::Array(::K8S::Api::Rbac::V1::PolicyRule)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "kind", accessor: "kind", nilable: false, read_only: true, default: "Role", kind: String},
      {key: "metadata", accessor: "metadata", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta},
      {key: "rules", accessor: "rules", nilable: false, read_only: false, default: nil, kind: ::Array(::K8S::Api::Rbac::V1::PolicyRule)},
    ])
  end
