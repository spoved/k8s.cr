...
::K8S::Kubernetes::Resource.define_resource("rbac.authorization.k8s.io", "v1", "ClusterRoleBinding",
  ...
  properties: [
    ...
    {name: "role_ref", kind: ::K8S::Api::Rbac::V1::RoleRef, key: "roleRef", nilable: false, read_only: false, description: "RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error."},
