...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Rbac::V1alpha1::ClusterRoleBinding)", nilable: false, default: nil, read_only: false, description: "Items is a list of ClusterRoleBindings", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Rbac::V1alpha1::ClusterRoleBindingList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Rbac::V1alpha1::ClusterRoleBinding)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Rbac::V1alpha1::ClusterRoleBinding), false, false, "Items is a list of ClusterRoleBindings")

    def initialize(*, api_version : String? = "rbac.authorization.k8s.io/v1alpha1", kind : String? = "ClusterRoleBindingList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Rbac::V1alpha1::ClusterRoleBinding)? = nil)
      super()
