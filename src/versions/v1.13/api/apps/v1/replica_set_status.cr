...
module K8S
  ...
  @[::K8S::Properties(
    ...
    ready_replicas: {key: "readyReplicas", accessor: "ready_replicas", kind: "Int32", nilable: true, default: nil, read_only: false, description: "The number of ready replicas for this replica set.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Apps::V1::ReplicaSetStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("availableReplicas", available_replicas : Int32, true, false, "The number of available replicas (ready for at least minReadySeconds) for this replica set.")
    k8s_object_accessor("conditions", conditions : ::Array(::K8S::Api::Apps::V1::ReplicaSetCondition), true, false, "Represents the latest available observations of a replica set's current state.")
    k8s_object_accessor("fullyLabeledReplicas", fully_labeled_replicas : Int32, true, false, "The number of pods that have labels matching the labels of the pod template of the replicaset.")
    k8s_object_accessor("observedGeneration", observed_generation : Int32, true, false, "ObservedGeneration reflects the generation of the most recently observed ReplicaSet.")
    k8s_object_accessor("readyReplicas", ready_replicas : Int32, true, false, "The number of ready replicas for this replica set.")
    ...
    def initialize(*, available_replicas : Int32? = nil, conditions : ::Array(::K8S::Api::Apps::V1::ReplicaSetCondition)? = nil, fully_labeled_replicas : Int32? = nil, observed_generation : Int32? = nil, ready_replicas : Int32? = nil, replicas : Int32? = nil)
      super()
