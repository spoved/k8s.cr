...
module K8S
  ...
  @[::K8S::Properties(
    ...
    ready_replicas: {key: "readyReplicas", accessor: "ready_replicas", kind: "Int32", nilable: true, default: nil, read_only: false, description: "Total number of ready pods targeted by this deployment."},
