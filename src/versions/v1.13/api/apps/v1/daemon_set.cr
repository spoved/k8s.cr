...
module K8S
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "patch", verb: "path",
  ...
  class Api::Apps::V1::DaemonSet < ::K8S::Kubernetes::Resource
