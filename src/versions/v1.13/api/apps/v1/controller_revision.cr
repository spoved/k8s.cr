...
module K8S
  ...
  class Api::Apps::V1::ControllerRevision < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("kind", kind : String = "ControllerRevision", false, true, "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))")
    ...
    k8s_object_accessor("data", data : ::K8S::Apimachinery::Runtime::RawExtension, true, false, "Data is the serialized representation of the state.")
    k8s_object_accessor("revision", revision : Int32, false, false, "Revision indicates the revision of the state represented by Data.")

    def initialize(*, api_version : String? = "apps/v1", kind : String? = "ControllerRevision", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, data : ::K8S::Apimachinery::Runtime::RawExtension? = nil, revision : Int32? = nil)
      super()
