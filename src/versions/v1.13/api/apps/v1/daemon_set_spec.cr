...
module K8S
  ...
  @[::K8S::Properties(
    ...
    update_strategy: {key: "updateStrategy", accessor: "update_strategy", kind: "::K8S::Api::Apps::V1::DaemonSetUpdateStrategy", nilable: true, default: nil, read_only: false, description: "An update strategy to replace existing DaemonSet pods with new pods."},
  )]
