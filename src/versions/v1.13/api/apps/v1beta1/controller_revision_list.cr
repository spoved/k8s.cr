...
module K8S
  ...
  module Types::Api::Apps::V1beta1::ControllerRevisionList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Apps::V1beta1::ControllerRevision) | Nil
  ...
  class Api::Apps::V1beta1::ControllerRevisionList < ::K8S::Types::Api::Apps::V1beta1::ControllerRevisionList::Instance
    include ::K8S::Types::Api::Apps::V1beta1::ControllerRevisionList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1beta1::ControllerRevision)
    ...
    # Items is the list of ControllerRevisions
    def items : Array(::K8S::Api::Apps::V1beta1::ControllerRevision)
      self.["items"].as(Array(::K8S::Api::Apps::V1beta1::ControllerRevision))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Apps::V1beta1::ControllerRevision)
      self.["items"].as(Array(::K8S::Api::Apps::V1beta1::ControllerRevision)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Apps::V1beta1::ControllerRevision))
      self.["items"] = value
    end
