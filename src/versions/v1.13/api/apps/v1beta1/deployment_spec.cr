...
::K8S::Kubernetes::Resource.define_object("DeploymentSpec",
  ...
  properties: [
    ...
    {name: "revision_history_limit", kind: Int32, key: "revisionHistoryLimit", nilable: true, read_only: false, description: "The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. Defaults to 2."},
    {name: "rollback_to", kind: ::K8S::Api::Apps::V1beta1::RollbackConfig, key: "rollbackTo", nilable: true, read_only: false, description: "DEPRECATED. The config this deployment is rolling back to. Will be cleared after rollback is done."},
    {name: "selector", kind: ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector, key: "selector", nilable: true, read_only: false, description: "Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment."},
    {name: "strategy", kind: ::K8S::Api::Apps::V1beta1::DeploymentStrategy, key: "strategy", nilable: true, read_only: false, description: "The deployment strategy to use to replace existing pods with new ones."},
