...
module K8S::Types::Api::Apps::V1beta2::StatefulSetList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./stateful_set"

module K8S
  # Namespace holding the types for `Api::Apps::V1beta2::StatefulSetList`.
  module Types::Api::Apps::V1beta2::StatefulSetList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Apps::V1beta2::StatefulSet) | Nil
    ...
    #
    abstract def items : Array(::K8S::Api::Apps::V1beta2::StatefulSet)
    # :ditto:
    abstract def items! : Array(::K8S::Api::Apps::V1beta2::StatefulSet)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Apps::V1beta2::StatefulSet)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Apps::V1beta2::StatefulSet))
  end

  # StatefulSetList is a collection of StatefulSets.
  @[::K8S::GroupVersionKind(group: "apps", kind: "StatefulSetList", version: "v1beta2", full: "io.k8s.api.apps.v1beta2.StatefulSetList")]
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apps::V1beta2::StatefulSet)", nilable: false, default: nil, read_only: false, description: nil, x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Apps::V1beta2::StatefulSetList < ::K8S::Types::Api::Apps::V1beta2::StatefulSetList::Instance
    include ::K8S::Types::Api::Apps::V1beta2::StatefulSetList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1beta2::StatefulSet)
    ...
    #
    def items : Array(::K8S::Api::Apps::V1beta2::StatefulSet)
      self.["items"].as(Array(::K8S::Api::Apps::V1beta2::StatefulSet))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Apps::V1beta2::StatefulSet)
      self.["items"].as(Array(::K8S::Api::Apps::V1beta2::StatefulSet)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Apps::V1beta2::StatefulSet))
      self.["items"] = value
    end
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        ...
        { key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Apps::V1beta2::StatefulSet) },
      ])
end
  end
end
