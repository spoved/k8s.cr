...
module K8S
  ...
  class Api::Batch::V1::JobSpec < ::K8S::GenericObject
    ...
    def initialize(*, active_deadline_seconds : Int32? = nil, backoff_limit : Int32? = nil, completions : Int32? = nil, manual_selector : ::Bool? = nil, parallelism : Int32? = nil, selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector? = nil, template : ::K8S::Api::Core::V1::PodTemplateSpec? = nil, ttl_seconds_after_finished : Int32? = nil)
      super()
