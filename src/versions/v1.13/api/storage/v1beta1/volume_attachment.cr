...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "storage.k8s.io", kind: "VolumeAttachment", version: "v1beta1")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/storage.k8s.io/v1beta1/volumeattachments/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/storage.k8s.io/v1beta1/volumeattachments/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  ...
  module Resources::Storage::V1beta1
    alias VolumeAttachment = ::K8S::Api::Storage::V1beta1::VolumeAttachment
  end
end
