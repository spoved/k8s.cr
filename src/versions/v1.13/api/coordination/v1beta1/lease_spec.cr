...
module K8S
  # Namespace holding the types for `Api::Coordination::V1beta1::LeaseSpec`.
  module Types::Api::Coordination::V1beta1::LeaseSpec
  ...
  @[::K8S::Properties(
    acquire_time: {key: "acquireTime", accessor: "acquire_time", kind: "::Time", nilable: true, default: nil, read_only: false, description: "acquireTime is a time when the current lease was acquired."},
    holder_identity: {key: "holderIdentity", accessor: "holder_identity", kind: "String", nilable: true, default: nil, read_only: false, description: "holderIdentity contains the identity of the holder of a current lease."},
    lease_duration_seconds: {key: "leaseDurationSeconds", accessor: "lease_duration_seconds", kind: "Int32", nilable: true, default: nil, read_only: false, description: "leaseDurationSeconds is a duration that candidates for a lease need to wait to force acquire it. This is measure against time of last observed RenewTime."},
    lease_transitions: {key: "leaseTransitions", accessor: "lease_transitions", kind: "Int32", nilable: true, default: nil, read_only: false, description: "leaseTransitions is the number of transitions of a lease between holders."},
    renew_time: {key: "renewTime", accessor: "renew_time", kind: "::Time", nilable: true, default: nil, read_only: false, description: "renewTime is a time when the current holder of a lease has last updated the lease."},
  )]
  class Api::Coordination::V1beta1::LeaseSpec < ::K8S::Types::Api::Coordination::V1beta1::LeaseSpec::Instance
    include ::K8S::Types::Api::Coordination::V1beta1::LeaseSpec
