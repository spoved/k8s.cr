...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhookConfiguration)", nilable: false, default: nil, read_only: false, description: "List of MutatingWebhookConfiguration."},
  )]
