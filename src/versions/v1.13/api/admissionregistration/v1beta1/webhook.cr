...
module K8S
  ...
  class Api::Admissionregistration::V1beta1::Webhook < ::K8S::GenericObject
    ...
    def initialize(*, client_config : ::K8S::Api::Admissionregistration::V1beta1::WebhookClientConfig? = nil, failure_policy : String? = nil, name : String? = nil, namespace_selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector? = nil, rules : ::Array(::K8S::Api::Admissionregistration::V1beta1::RuleWithOperations)? = nil, side_effects : String? = nil)
      super()
