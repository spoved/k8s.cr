...
::K8S::Kubernetes::Resource.define_object("Volume",
  ...
  properties: [
    ...
    {name: "cinder", kind: ::K8S::Api::Core::V1::CinderVolumeSource, key: "cinder", nilable: true, read_only: false, description: "Cinder represents a cinder volume attached and mounted on kubelets host machine More info: [https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md](https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md)"},
    ...
    {name: "glusterfs", kind: ::K8S::Api::Core::V1::GlusterfsVolumeSource, key: "glusterfs", nilable: true, read_only: false, description: "Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: [https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md](https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md)"},
    ...
    {name: "iscsi", kind: ::K8S::Api::Core::V1::ISCSIVolumeSource, key: "iscsi", nilable: true, read_only: false, description: "ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: [https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md](https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md)"},
