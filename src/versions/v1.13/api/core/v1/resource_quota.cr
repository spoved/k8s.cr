...
module K8S
  ...
  module Types::Api::Core::V1::ResourceQuota
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::K8S::Api::Core::V1::ResourceQuotaSpec | ::K8S::Api::Core::V1::ResourceQuotaStatus | Nil
  ...
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "ResourceQuota", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))"},
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Core::V1::ResourceQuotaSpec", nilable: true, default: nil, read_only: false, description: "Spec defines the desired quota. [https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)"},
  ...
  class Api::Core::V1::ResourceQuota < ::K8S::Types::Api::Core::V1::ResourceQuota::Instance
