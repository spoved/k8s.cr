...
module K8S::Types::Api::Core::V1::ReplicationController; end
...
module K8S
  # Namespace holding the types for `Api::Core::V1::ReplicationController`.
  module Types::Api::Core::V1::ReplicationController
    ...
    # Spec defines the specification of the desired behavior of the replication controller. More info: [[https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status))
    abstract def spec : ::K8S::Api::Core::V1::ReplicationControllerSpec?
    # :ditto:
    abstract def spec! : ::K8S::Api::Core::V1::ReplicationControllerSpec
    # :ditto:
    abstract def spec? : ::K8S::Api::Core::V1::ReplicationControllerSpec?
    # :ditto:
    abstract def spec=(value : ::K8S::Api::Core::V1::ReplicationControllerSpec)
    ...
    abstract def status : ::K8S::Api::Core::V1::ReplicationControllerStatus?
    # :ditto:
    abstract def status! : ::K8S::Api::Core::V1::ReplicationControllerStatus
    # :ditto:
    abstract def status? : ::K8S::Api::Core::V1::ReplicationControllerStatus?
    # :ditto:
    abstract def status=(value : ::K8S::Api::Core::V1::ReplicationControllerStatus)
  end
  ...
  class Api::Core::V1::ReplicationController < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("spec", spec : ::K8S::Api::Core::V1::ReplicationControllerSpec, true, false, "Spec defines the specification of the desired behavior of the replication controller. More info: [https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)")
    k8s_object_accessor("status", status : ::K8S::Api::Core::V1::ReplicationControllerStatus, true, false, "Status is the most recently observed status of the replication controller. This data may be out of date by some window of time. Populated by the system. Read-only. More info: [https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)")

    def initialize(*, api_version : String? = "v1", kind : String? = "ReplicationController", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, spec : ::K8S::Api::Core::V1::ReplicationControllerSpec? = nil, status : ::K8S::Api::Core::V1::ReplicationControllerStatus? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "kind", accessor: "kind", nilable: false, read_only: true, default: "ReplicationController", kind: String},
      {key: "metadata", accessor: "metadata", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta},
      {key: "spec", accessor: "spec", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Core::V1::ReplicationControllerSpec},
      {key: "status", accessor: "status", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Core::V1::ReplicationControllerStatus},
    ])
  end
