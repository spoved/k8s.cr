...
module K8S
  ...
  class Api::Core::V1::NodeSpec < ::K8S::GenericObject
    ...
    def initialize(*, config_source : ::K8S::Api::Core::V1::NodeConfigSource? = nil, external_id : String? = nil, pod_cidr : String? = nil, provider_id : String? = nil, taints : ::Array(::K8S::Api::Core::V1::Taint)? = nil, unschedulable : ::Bool? = nil)
      super()
