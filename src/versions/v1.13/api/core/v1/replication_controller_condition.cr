...
::K8S::Kubernetes::Resource.define_object("ReplicationControllerCondition",
  ...
  properties: [
    ...
    {name: "type", kind: String, key: "type", nilable: false, read_only: false, description: "Type of replication controller condition."},
