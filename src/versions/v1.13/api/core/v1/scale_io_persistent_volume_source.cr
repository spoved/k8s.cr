...
module K8S
  ...
  @[::K8S::Properties(
    fs_type: {key: "fsType", accessor: "fs_type", kind: "String", nilable: true, default: nil, read_only: false, description: "Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". Default is \"xfs\"", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    secret_ref: {key: "secretRef", accessor: "secret_ref", kind: "::K8S::Api::Core::V1::SecretReference", nilable: false, default: nil, read_only: false, description: "SecretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Core::V1::ScaleIOPersistentVolumeSource < ::K8S::GenericObject
    ...
    k8s_object_accessor("fsType", fs_type : String, true, false, "Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". Default is \"xfs\"")
    ...
    k8s_object_accessor("secretRef", secret_ref : ::K8S::Api::Core::V1::SecretReference, false, false, "SecretRef references to the secret for ScaleIO user and other sensitive information. If this is not provided, Login operation will fail.")
    ...
    k8s_object_accessor("storageMode", storage_mode : String, true, false, "Indicates whether the storage for a volume should be ThickProvisioned or ThinProvisioned. Default is ThinProvisioned.")
    ...
    def initialize(*, fs_type : String? = nil, gateway : String? = nil, protection_domain : String? = nil, read_only : ::Bool? = nil, secret_ref : ::K8S::Api::Core::V1::SecretReference? = nil, ssl_enabled : ::Bool? = nil, storage_mode : String? = nil, storage_pool : String? = nil, system : String? = nil, volume_name : String? = nil)
      super()
      self.["fsType"] = fs_type
