...
module K8S
  ...
  @[::K8S::Properties(
    ...
    state: {key: "state", accessor: "state", kind: "String", nilable: false, default: nil, read_only: false, description: "Information whether this series is ongoing or finished."},
  )]
