...
::K8S::Kubernetes::Resource.define_resource("", "v1", "Status",
  ...
  properties: [
    ...
    {name: "status", kind: String, key: "status", nilable: true, read_only: false, description: "Status of the operation. One of: \"Success\" or \"Failure\". More info: [https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)"},
