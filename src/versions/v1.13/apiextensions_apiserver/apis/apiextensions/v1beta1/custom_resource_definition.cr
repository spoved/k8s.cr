...
module K8S
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinition < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("spec", spec : ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionSpec, false, false, "Spec describes how the user wants the resources to appear")
    k8s_object_accessor("status", status : ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionStatus, true, false, "Status indicates the actual state of the CustomResourceDefinition")

    def initialize(*, api_version : String? = "apiextensions/v1beta1", kind : String? = "CustomResourceDefinition", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, spec : ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionSpec? = nil, status : ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionStatus? = nil)
      super()
