...
::K8S::Kubernetes::Resource.define_resource("resource.k8s.io", "v1alpha1", "ResourceClass",
  ...
  properties: [
    ...
    {name: "parameters_ref", kind: ::K8S::Api::Resource::V1alpha1::ResourceClassParametersReference, key: "parametersRef", nilable: true, read_only: false, description: "ParametersRef references an arbitrary separate object that may hold parameters that will be used by the driver when allocating a resource that uses this class. A dynamic resource driver can distinguish between parameters stored here and and those stored in ResourceClaimSpec."},
  ...
  versions: [{group: "resource.k8s.io", kind: "ResourceClass", version: "v1alpha1"}],
)
