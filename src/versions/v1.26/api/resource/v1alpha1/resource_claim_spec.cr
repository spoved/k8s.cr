...
::K8S::Kubernetes::Resource.define_object("ResourceClaimSpec",
  ...
  properties: [
    ...
    {name: "parameters_ref", kind: ::K8S::Api::Resource::V1alpha1::ResourceClaimParametersReference, key: "parametersRef", nilable: true, read_only: false, description: "ParametersRef references a separate object with arbitrary parameters that will be used by the driver when allocating a resource for the claim.\n\nThe object must be in the same namespace as the ResourceClaim."},
