...
::K8S::Kubernetes::Resource.define_object("ResourceClaimTemplateSpec",
  ...
  properties: [
    ...
    {name: "spec", kind: ::K8S::Api::Resource::V1alpha1::ResourceClaimSpec, key: "spec", nilable: false, read_only: false, description: "Spec for the ResourceClaim. The entire content is copied unchanged into the ResourceClaim that gets created from this template. The same fields as in a ResourceClaim are also valid here."},
