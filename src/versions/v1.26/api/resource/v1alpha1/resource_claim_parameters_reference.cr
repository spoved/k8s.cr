...
::K8S::Kubernetes::Resource.define_object("ResourceClaimParametersReference",
  ...
  properties: [
    ...
    {name: "kind", kind: String, key: "kind", nilable: false, read_only: false, description: "Kind is the type of resource being referenced. This is the same value as in the parameter object's metadata, for example \"ConfigMap\"."},
