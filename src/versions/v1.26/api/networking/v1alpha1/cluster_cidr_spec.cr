...
::K8S::Kubernetes::Resource.define_object("ClusterCIDRSpec",
  ...
  properties: [
    ...
    {name: "ipv6", kind: String, key: "ipv6", nilable: true, read_only: false, description: "IPv6 defines an IPv6 IP block in CIDR notation(e.g. \"2001:db8::/64\"). At least one of IPv4 and IPv6 must be specified. This field is immutable."},
