module ::K8S::Kubernetes
  VERSION       = SemanticVersion.parse("1.26.0")
  VERSION_MINOR =  1
  VERSION_MAJOR = 26
  ...
  abstract struct Resource
    MAPPINGS = [
      ...
      {"resource/v1alpha1", "PodScheduling", K8S::Api::Resource::V1alpha1::PodScheduling},
      {"resource/v1alpha1", "PodSchedulingList", K8S::Api::Resource::V1alpha1::PodSchedulingList},
      {"resource/v1alpha1", "ResourceClaim", K8S::Api::Resource::V1alpha1::ResourceClaim},
      {"resource/v1alpha1", "ResourceClaimList", K8S::Api::Resource::V1alpha1::ResourceClaimList},
      {"resource/v1alpha1", "ResourceClaimTemplate", K8S::Api::Resource::V1alpha1::ResourceClaimTemplate},
      {"resource/v1alpha1", "ResourceClaimTemplateList", K8S::Api::Resource::V1alpha1::ResourceClaimTemplateList},
      {"resource/v1alpha1", "ResourceClass", K8S::Api::Resource::V1alpha1::ResourceClass},
      {"resource/v1alpha1", "ResourceClassList", K8S::Api::Resource::V1alpha1::ResourceClassList},
