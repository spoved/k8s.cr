...
module K8S
  ...
  class Apimachinery::Apis::Meta::V1::ManagedFieldsEntry < ::K8S::GenericObject
    ...
    def initialize(*, api_version : String? = nil, fields_type : String? = nil, fields_v1 : ::K8S::Apimachinery::Apis::Meta::V1::FieldsV1? = nil, manager : String? = nil, operation : String? = nil, time : ::Time? = nil)
      super()
