...
module K8S
  ...
  class Api::Storage::V1::CSINodeList < ::K8S::Kubernetes::ResourceList(Api::Storage::V1::CSINode)
    ...
    def initialize(*, @items : Array(Api::Storage::V1::CSINode), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
