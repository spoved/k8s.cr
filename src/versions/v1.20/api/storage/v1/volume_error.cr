...
module K8S
  ...
  class Api::Storage::V1::VolumeError < ::K8S::GenericObject
    ...
    k8s_object_accessor("message", message : String, true, false, "String detailing the error encountered during Attach or Detach operation. This string may be logged, so it should not contain sensitive information.")
