...
module K8S::Types::Api::Storage::V1::CSIDriver; end

require "../../../apimachinery/apis/meta/v1/object_meta"
require "./csi_driver_spec"

module K8S
  # Namespace holding the types for `Api::Storage::V1::CSIDriver`.
  module Types::Api::Storage::V1::CSIDriver
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::K8S::Api::Storage::V1::CSIDriverSpec | Nil
    ...
    abstract def spec : ::K8S::Api::Storage::V1::CSIDriverSpec
    # :ditto:
    abstract def spec! : ::K8S::Api::Storage::V1::CSIDriverSpec
    # :ditto:
    abstract def spec? : ::K8S::Api::Storage::V1::CSIDriverSpec?
    # :ditto:
    abstract def spec=(value : ::K8S::Api::Storage::V1::CSIDriverSpec)
  end

  # CSIDriver captures information about a Container Storage Interface (CSI) volume driver deployed on the cluster. Kubernetes attach detach controller uses this object to determine whether attach is required. Kubelet uses this object to determine whether pod information needs to be passed on mount. CSIDriver objects are non-namespaced.
  @[::K8S::GroupVersionKind(group: "storage.k8s.io", kind: "CSIDriver", version: "v1", full: "io.k8s.api.storage.v1.CSIDriver")]
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Storage::V1::CSIDriverSpec", nilable: false, default: nil, read_only: false, description: "Specification of the CSI Driver.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Storage::V1::CSIDriver < ::K8S::Types::Api::Storage::V1::CSIDriver::Instance
    include ::K8S::Types::Api::Storage::V1::CSIDriver
    ...
    # Specification of the CSI Driver.
    def spec : ::K8S::Api::Storage::V1::CSIDriverSpec
      self.["spec"].as(::K8S::Api::Storage::V1::CSIDriverSpec)
    end

    # :ditto:
    def spec! : ::K8S::Api::Storage::V1::CSIDriverSpec
      self.["spec"].as(::K8S::Api::Storage::V1::CSIDriverSpec).not_nil!
    end
    ...
    # :ditto:
    def spec=(value : ::K8S::Api::Storage::V1::CSIDriverSpec)
      self.["spec"] = value
    end
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        ...
        { key: "spec", accessor: "spec", nilable: false, read_only: false, default: nil, kind: ::K8S::Api::Storage::V1::CSIDriverSpec },
      ])
end
  end

  module Resources::Storage::V1
    alias CSIDriver = ::K8S::Api::Storage::V1::CSIDriver
  end
end
