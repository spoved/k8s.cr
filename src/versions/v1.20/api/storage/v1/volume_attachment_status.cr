...
module K8S
  ...
  @[::K8S::Properties(
    ...
    detach_error: {key: "detachError", accessor: "detach_error", kind: "::K8S::Api::Storage::V1::VolumeError", nilable: true, default: nil, read_only: false, description: "The last error encountered during detach operation, if any. This field must only be set by the entity completing the detach operation, i.e. the external-attacher.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
