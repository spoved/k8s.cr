...
module K8S
  ...
  module Types::Api::Core::V1::ISCSIVolumeSource
    alias ValueType = ::Bool | String | Int32 | ::Array(String) | ::K8S::Api::Core::V1::LocalObjectReference | Nil
  ...
  @[::K8S::Properties(
    ...
    secret_ref: {key: "secretRef", accessor: "secret_ref", kind: "::K8S::Api::Core::V1::LocalObjectReference", nilable: true, default: nil, read_only: false, description: "CHAP Secret for iSCSI target and initiator authentication"},
  ...
  class Api::Core::V1::ISCSIVolumeSource < ::K8S::Types::Api::Core::V1::ISCSIVolumeSource::Instance
