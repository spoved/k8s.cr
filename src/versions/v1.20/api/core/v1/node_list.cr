...
module K8S
  ...
  class Api::Core::V1::NodeList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Core::V1::Node)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Core::V1::Node), false, false, "List of nodes")

    def initialize(*, api_version : String? = "v1", kind : String? = "NodeList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Core::V1::Node)? = nil)
      super()
