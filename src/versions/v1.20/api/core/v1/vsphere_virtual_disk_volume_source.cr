...
module K8S
  ...
  @[::K8S::Properties(
    ...
    storage_policy_id: {key: "storagePolicyID", accessor: "storage_policy_id", kind: "String", nilable: true, default: nil, read_only: false, description: "Storage Policy Based Management (SPBM) profile ID associated with the StoragePolicyName."},
    storage_policy_name: {key: "storagePolicyName", accessor: "storage_policy_name", kind: "String", nilable: true, default: nil, read_only: false, description: "Storage Policy Based Management (SPBM) profile name."},
    volume_path: {key: "volumePath", accessor: "volume_path", kind: "String", nilable: false, default: nil, read_only: false, description: "Path that identifies vSphere volume vmdk"},
  )]
