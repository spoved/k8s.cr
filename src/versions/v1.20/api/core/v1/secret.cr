...
::K8S::Kubernetes::Resource.define_resource("", "v1", "Secret",
  ...
  properties: [
    ...
    {name: "immutable", kind: ::Bool, key: "immutable", nilable: true, read_only: false, description: "Immutable, if set to true, ensures that data stored in the Secret cannot be updated (only object metadata can be modified). If not set to true, the field can be modified at any time. Defaulted to nil. This is a beta field enabled by ImmutableEphemeralVolumes feature gate."},
