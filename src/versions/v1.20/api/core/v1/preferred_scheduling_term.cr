...
module K8S
  ...
  class Api::Core::V1::PreferredSchedulingTerm < ::K8S::GenericObject
    ...
    k8s_object_accessor("preference", preference : ::K8S::Api::Core::V1::NodeSelectorTerm, false, false, "A node selector term, associated with the corresponding weight.")
    k8s_object_accessor("weight", weight : Int32, false, false, "Weight associated with matching the corresponding nodeSelectorTerm, in the range 1-100.")

    def initialize(*, preference : ::K8S::Api::Core::V1::NodeSelectorTerm? = nil, weight : Int32? = nil)
      super()
