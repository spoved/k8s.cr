...
::K8S::Kubernetes::Resource.define_object("CinderVolumeSource",
  ...
  properties: [
    ...
    {name: "secret_ref", kind: ::K8S::Api::Core::V1::LocalObjectReference, key: "secretRef", nilable: true, read_only: false, description: "Optional: points to a secret object containing parameters used to connect to OpenStack."},
    {name: "volume_id", kind: String, key: "volumeID", nilable: false, read_only: false, description: "volume id used to identify the volume in cinder. More info: [https://examples.k8s.io/mysql-cinder-pd/README.md](https://examples.k8s.io/mysql-cinder-pd/README.md)"},
