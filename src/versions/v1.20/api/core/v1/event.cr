...
module K8S
  ...
  module Types::Api::Core::V1::Event
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | Int32 | ::Time | ::K8S::Api::Core::V1::ObjectReference | ::K8S::Api::Core::V1::EventSeries | ::K8S::Api::Core::V1::EventSource | Nil
  ...
  @[::K8S::Properties(
    ...
    count: {key: "count", accessor: "count", kind: "Int32", nilable: true, default: nil, read_only: false, description: "The number of times this event has occurred."},
    ...
    first_timestamp: {key: "firstTimestamp", accessor: "first_timestamp", kind: "::Time", nilable: true, default: nil, read_only: false, description: "The time at which the event was first recorded. (Time of server receipt is in TypeMeta.)"},
    involved_object: {key: "involvedObject", accessor: "involved_object", kind: "::K8S::Api::Core::V1::ObjectReference", nilable: false, default: nil, read_only: false, description: "The object that this event is about."},
    last_timestamp: {key: "lastTimestamp", accessor: "last_timestamp", kind: "::Time", nilable: true, default: nil, read_only: false, description: "The time at which the most recent occurrence of this event was recorded."},
    ...
    reason: {key: "reason", accessor: "reason", kind: "String", nilable: true, default: nil, read_only: false, description: "This should be a short, machine understandable string that gives the reason for the transition into the object's current status."},
    related: {key: "related", accessor: "related", kind: "::K8S::Api::Core::V1::ObjectReference", nilable: true, default: nil, read_only: false, description: "Optional secondary object for more complex actions."},
    reporting_component: {key: "reportingComponent", accessor: "reporting_component", kind: "String", nilable: true, default: nil, read_only: false, description: "Name of the controller that emitted this Event, e.g. [`kubernetes.io/kubelet`.](`kubernetes.io/kubelet`.)"},
    ...
    series: {key: "series", accessor: "series", kind: "::K8S::Api::Core::V1::EventSeries", nilable: true, default: nil, read_only: false, description: "Data about the Event series this event represents or nil if it's a singleton Event."},
    source: {key: "source", accessor: "source", kind: "::K8S::Api::Core::V1::EventSource", nilable: true, default: nil, read_only: false, description: "The component reporting this event. Should be a short machine understandable string."},
  ...
  class Api::Core::V1::Event < ::K8S::Types::Api::Core::V1::Event::Instance
