...
module K8S
  ...
  @[::K8S::Properties(
    ...
    observed_generation: {key: "observedGeneration", accessor: "observed_generation", kind: "Int32", nilable: true, default: nil, read_only: false, description: "If set, this represents the .metadata.generation that the condition was set based upon."},
    reason: {key: "reason", accessor: "reason", kind: "String", nilable: false, default: nil, read_only: false, description: "The reason for the condition's last transition."},
    ...
    type: {key: "type", accessor: "type", kind: "String", nilable: false, default: nil, read_only: false, description: "Type of the condition."},
  )]
