...
module K8S::Types::Api::Apiserverinternal::V1alpha1::StorageVersionList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./storage_version"

module K8S
  # Namespace holding the types for `Api::Apiserverinternal::V1alpha1::StorageVersionList`.
  module Types::Api::Apiserverinternal::V1alpha1::StorageVersionList
    ...
    #
    abstract def items : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion))
  end
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)", nilable: false, default: nil, read_only: false, description: nil, x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Apiserverinternal::V1alpha1::StorageVersionList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)
    include ::K8S::Types::Api::Apiserverinternal::V1alpha1::StorageVersionList
    k8s_object_accessor("apiVersion", api_version : String = "apiserverinternal/v1alpha1", false, true, "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources))")
    k8s_object_accessor("kind", kind : String = "StorageVersionList", false, true, "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))")
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion), false, false, nil)

    def initialize(*, api_version : String? = "apiserverinternal/v1alpha1", kind : String? = "StorageVersionList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "kind", accessor: "kind", nilable: false, read_only: true, default: "StorageVersionList", kind: String},
      {key: "metadata", accessor: "metadata", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::ListMeta},
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)},
    ])
  end
end
