...
module K8S
  ...
  module Types::Api::Apiserverinternal::V1alpha1::StorageVersionList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion) | Nil
  ...
  class Api::Apiserverinternal::V1alpha1::StorageVersionList < ::K8S::Types::Api::Apiserverinternal::V1alpha1::StorageVersionList::Instance
    include ::K8S::Types::Api::Apiserverinternal::V1alpha1::StorageVersionList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)
    ...
    #
    def items : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)
      self.["items"].as(Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)
      self.["items"].as(Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion))
      self.["items"] = value
    end
