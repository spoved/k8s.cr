...
module K8S
  ...
  module Types::Api::Discovery::V1beta1::EndpointSlice
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::Array(::K8S::Api::Discovery::V1beta1::Endpoint) | ::Array(::K8S::Api::Discovery::V1beta1::EndpointPort) | Nil
  ...
  @[::K8S::Properties(
    ...
    endpoints: {key: "endpoints", accessor: "endpoints", kind: "::Array(::K8S::Api::Discovery::V1beta1::Endpoint)", nilable: true, default: nil, read_only: false, description: "endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints."},
  ...
  class Api::Discovery::V1beta1::EndpointSlice < ::K8S::Types::Api::Discovery::V1beta1::EndpointSlice::Instance
    ...
    # endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints.
    def endpoints : ::Array(::K8S::Api::Discovery::V1beta1::Endpoint)?
      self.["endpoints"].as(::Array(::K8S::Api::Discovery::V1beta1::Endpoint)?)
    end

    # :ditto:
    def endpoints! : ::Array(::K8S::Api::Discovery::V1beta1::Endpoint)
      self.["endpoints"].as(::Array(::K8S::Api::Discovery::V1beta1::Endpoint)?).not_nil!
    end
    ...
    # :ditto:
    def endpoints=(value : ::Array(::K8S::Api::Discovery::V1beta1::Endpoint)?)
      self.["endpoints"] = value
    end

    # ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique name. When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port value, it indicates "all ports". Each slice may include a maximum of 100 ports.
    def ports : ::Array(::K8S::Api::Discovery::V1beta1::EndpointPort)?
      self.["ports"].as(::Array(::K8S::Api::Discovery::V1beta1::EndpointPort)?)
    end

    # :ditto:
    def ports! : ::Array(::K8S::Api::Discovery::V1beta1::EndpointPort)
      self.["ports"].as(::Array(::K8S::Api::Discovery::V1beta1::EndpointPort)?).not_nil!
    end
    ...
    # :ditto:
    def ports=(value : ::Array(::K8S::Api::Discovery::V1beta1::EndpointPort)?)
      self.["ports"] = value
    end
