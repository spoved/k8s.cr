...
module K8S
  ...
  class Api::Admissionregistration::V1::RuleWithOperations < ::K8S::GenericObject
    ...
    k8s_object_accessor("operations", operations : ::Array(String), true, false, "Operations is the operations the admission hook cares about - CREATE, UPDATE, DELETE, CONNECT or * for all of those operations and any future admission operations that are added. If '*' is present, the length of the slice must be one. Required.")
