...
module K8S
  ...
  class Api::Admissionregistration::V1::ValidatingWebhookConfigurationList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Admissionregistration::V1::ValidatingWebhookConfiguration)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Admissionregistration::V1::ValidatingWebhookConfiguration), false, false, "List of ValidatingWebhookConfiguration.")

    def initialize(*, api_version : String? = "admissionregistration/v1", kind : String? = "ValidatingWebhookConfigurationList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Admissionregistration::V1::ValidatingWebhookConfiguration)? = nil)
      super()
