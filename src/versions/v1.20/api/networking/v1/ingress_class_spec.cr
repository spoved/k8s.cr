...
::K8S::Kubernetes::Resource.define_object("IngressClassSpec",
  ...
  properties: [
    ...
    {name: "parameters", kind: ::K8S::Api::Core::V1::TypedLocalObjectReference, key: "parameters", nilable: true, read_only: false, description: "Parameters is a link to a custom resource containing additional configuration for the controller. This is optional if the controller does not require extra parameters."},
