...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "flowcontrol.apiserver.k8s.io", kind: "PriorityLevelConfigurationList", version: "v1beta1")]
  ...
  class Api::Flowcontrol::V1beta1::PriorityLevelConfigurationList < ::K8S::Kubernetes::Resource
