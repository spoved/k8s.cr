...
module K8S
  ...
  class Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("limited", limited : ::K8S::Api::Flowcontrol::V1alpha1::LimitedPriorityLevelConfiguration, true, false, "`limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `\"Limited\"`.")
    ...
    def initialize(*, limited : ::K8S::Api::Flowcontrol::V1alpha1::LimitedPriorityLevelConfiguration? = nil, type : String? = nil)
      super()
