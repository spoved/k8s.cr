...
module K8S::Types::Api::Flowcontrol::V1alpha1::ResourcePolicyRule; end

module K8S
  # Namespace holding the types for `Api::Flowcontrol::V1alpha1::ResourcePolicyRule`.
  module Types::Api::Flowcontrol::V1alpha1::ResourcePolicyRule
  ...
  class Api::Flowcontrol::V1alpha1::ResourcePolicyRule < ::K8S::Types::Api::Flowcontrol::V1alpha1::ResourcePolicyRule::Instance
    include ::K8S::Types::Api::Flowcontrol::V1alpha1::ResourcePolicyRule
