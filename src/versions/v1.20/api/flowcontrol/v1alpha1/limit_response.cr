...
module K8S
  ...
  module Types::Api::Flowcontrol::V1alpha1::LimitResponse
    alias ValueType = ::K8S::Api::Flowcontrol::V1alpha1::QueuingConfiguration | String | Nil
  ...
  @[::K8S::Properties(
    queuing: {key: "queuing", accessor: "queuing", kind: "::K8S::Api::Flowcontrol::V1alpha1::QueuingConfiguration", nilable: true, default: nil, read_only: false, description: "`queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `\"Queue\"`."},
  ...
  class Api::Flowcontrol::V1alpha1::LimitResponse < ::K8S::Types::Api::Flowcontrol::V1alpha1::LimitResponse::Instance
