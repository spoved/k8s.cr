...
module K8S
  ...
  class Api::Batch::V1::JobStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("conditions", conditions : ::Array(::K8S::Api::Batch::V1::JobCondition), true, false, "The latest available observations of an object's current state. When a job fails, one of the conditions will have type == \"Failed\". More info: [https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/](https://kubernetes.io/docs/concepts/workloads/controllers/jobs-run-to-completion/)")
