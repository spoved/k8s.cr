...
module K8S::Types::Api::Scheduling::V1alpha1::PriorityClassList; end
...
module K8S
  ...
  module Types::Api::Scheduling::V1alpha1::PriorityClassList
    ...
    abstract def items : Array(::K8S::Api::Scheduling::V1alpha1::PriorityClass)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Scheduling::V1alpha1::PriorityClass)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Scheduling::V1alpha1::PriorityClass)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Scheduling::V1alpha1::PriorityClass))
  end

  # PriorityClassList is a collection of priority classes.
  @[::K8S::GroupVersionKind(group: "scheduling.k8s.io", kind: "PriorityClassList", version: "v1alpha1", full: "io.k8s.api.scheduling.v1alpha1.PriorityClassList")]
  @[::K8S::Properties(
  ...
  class Api::Scheduling::V1alpha1::PriorityClassList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Scheduling::V1alpha1::PriorityClass)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Scheduling::V1alpha1::PriorityClass), false, false, "items is the list of PriorityClasses")

    def initialize(*, api_version : String? = "scheduling/v1alpha1", kind : String? = "PriorityClassList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Scheduling::V1alpha1::PriorityClass)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Scheduling::V1alpha1::PriorityClass)},
    ])
  end
end
