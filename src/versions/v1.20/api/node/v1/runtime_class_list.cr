...
module K8S::Types::Api::Node::V1::RuntimeClassList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./runtime_class"

module K8S
  # Namespace holding the types for `Api::Node::V1::RuntimeClassList`.
  module Types::Api::Node::V1::RuntimeClassList
    ...
    abstract def items : Array(::K8S::Api::Node::V1::RuntimeClass)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Node::V1::RuntimeClass)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Node::V1::RuntimeClass)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Node::V1::RuntimeClass))
  end

  # RuntimeClassList is a list of RuntimeClass objects.
  @[::K8S::GroupVersionKind(group: "node.k8s.io", kind: "RuntimeClassList", version: "v1", full: "io.k8s.api.node.v1.RuntimeClassList")]
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Node::V1::RuntimeClass)", nilable: false, default: nil, read_only: false, description: "Items is a list of schema objects.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Node::V1::RuntimeClassList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Node::V1::RuntimeClass)
    include ::K8S::Types::Api::Node::V1::RuntimeClassList
    k8s_object_accessor("apiVersion", api_version : String = "node/v1", false, true, "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources))")
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Node::V1::RuntimeClass), false, false, "Items is a list of schema objects.")

    def initialize(*, api_version : String? = "node/v1", kind : String? = "RuntimeClassList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Node::V1::RuntimeClass)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Node::V1::RuntimeClass)},
    ])
  end
end
