...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Node::V1::RuntimeClass)", nilable: false, default: nil, read_only: false, description: "Items is a list of schema objects."},
  )]
