...
module K8S
  ...
  module Types::Api::Events::V1::Event
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | Int32 | ::Time | ::K8S::Api::Core::V1::EventSource | ::K8S::Api::Core::V1::ObjectReference | ::K8S::Api::Events::V1::EventSeries | Nil
  ...
  @[::K8S::Properties(
    ...
    deprecated_count: {key: "deprecatedCount", accessor: "deprecated_count", kind: "Int32", nilable: true, default: nil, read_only: false, description: "deprecatedCount is the deprecated field assuring backward compatibility with core.v1 Event type."},
    deprecated_first_timestamp: {key: "deprecatedFirstTimestamp", accessor: "deprecated_first_timestamp", kind: "::Time", nilable: true, default: nil, read_only: false, description: "deprecatedFirstTimestamp is the deprecated field assuring backward compatibility with core.v1 Event type."},
    deprecated_last_timestamp: {key: "deprecatedLastTimestamp", accessor: "deprecated_last_timestamp", kind: "::Time", nilable: true, default: nil, read_only: false, description: "deprecatedLastTimestamp is the deprecated field assuring backward compatibility with core.v1 Event type."},
    deprecated_source: {key: "deprecatedSource", accessor: "deprecated_source", kind: "::K8S::Api::Core::V1::EventSource", nilable: true, default: nil, read_only: false, description: "deprecatedSource is the deprecated field assuring backward compatibility with core.v1 Event type."},
    event_time: {key: "eventTime", accessor: "event_time", kind: "::Time", nilable: true, default: nil, read_only: false, description: "eventTime is the time when this Event was first observed. It is required."},
    note: {key: "note", accessor: "note", kind: "String", nilable: true, default: nil, read_only: false, description: "note is a human-readable description of the status of this operation. Maximal length of the note is 1kB, but libraries should be prepared to handle values up to 64kB."},
    reason: {key: "reason", accessor: "reason", kind: "String", nilable: true, default: nil, read_only: false, description: "reason is why the action was taken. It is human-readable. This field cannot be empty for new Events and it can have at most 128 characters."},
    ...
    related: {key: "related", accessor: "related", kind: "::K8S::Api::Core::V1::ObjectReference", nilable: true, default: nil, read_only: false, description: "related is the optional secondary object for more complex actions. E.g. when regarding object triggers a creation or deletion of related object."},
    ...
    reporting_instance: {key: "reportingInstance", accessor: "reporting_instance", kind: "String", nilable: true, default: nil, read_only: false, description: "reportingInstance is the ID of the controller instance, e.g. `kubelet-xyzf`. This field cannot be empty for new Events and it can have at most 128 characters."},
    series: {key: "series", accessor: "series", kind: "::K8S::Api::Events::V1::EventSeries", nilable: true, default: nil, read_only: false, description: "series is data about the Event series this event represents or nil if it's a singleton Event."},
    type: {key: "type", accessor: "type", kind: "String", nilable: true, default: nil, read_only: false, description: "type is the type of this event (Normal, Warning), new types could be added in the future. It is machine-readable. This field cannot be empty for new Events."},
  )]
  class Api::Events::V1::Event < ::K8S::Types::Api::Events::V1::Event::Instance
