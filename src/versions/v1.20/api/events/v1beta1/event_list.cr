...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta},
  ...
  class Api::Events::V1beta1::EventList < ::K8S::Kubernetes::ResourceList(Api::Events::V1beta1::Event)
    ...
    def initialize(*, @items : Array(Api::Events::V1beta1::Event), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
