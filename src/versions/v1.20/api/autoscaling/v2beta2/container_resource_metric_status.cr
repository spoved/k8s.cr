...
module K8S
  ...
  class Api::Autoscaling::V2beta2::ContainerResourceMetricStatus < ::K8S::GenericObject
    ...
    def initialize(*, container : String? = nil, current : ::K8S::Api::Autoscaling::V2beta2::MetricValueStatus? = nil, name : String? = nil)
      super()
