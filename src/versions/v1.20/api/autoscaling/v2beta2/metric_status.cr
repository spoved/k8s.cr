...
module K8S
  ...
  class Api::Autoscaling::V2beta2::MetricStatus
    ...
    ::YAML.mapping({
      container_resource: {type: Api::Autoscaling::V2beta2::ContainerResourceMetricStatus, nilable: true, key: "containerResource", getter: false, setter: false},
    ...
    def initialize(*, @type : String, @container_resource : Api::Autoscaling::V2beta2::ContainerResourceMetricStatus | Nil = nil, @external : Api::Autoscaling::V2beta2::ExternalMetricStatus | Nil = nil, @object : Api::Autoscaling::V2beta2::ObjectMetricStatus | Nil = nil, @pods : Api::Autoscaling::V2beta2::PodsMetricStatus | Nil = nil, @resource : Api::Autoscaling::V2beta2::ResourceMetricStatus | Nil = nil)
    end
  end
end
