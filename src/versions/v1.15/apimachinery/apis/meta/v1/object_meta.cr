...
module K8S
  ...
  module Types::Apimachinery::Apis::Meta::V1::ObjectMeta
    alias ValueType = ::Hash(String, String) | String | ::Time | Int32 | ::Array(String) | ::K8S::Apimachinery::Apis::Meta::V1::Initializers | ::Array(::K8S::Apimachinery::Apis::Meta::V1::ManagedFieldsEntry) | ::Array(::K8S::Apimachinery::Apis::Meta::V1::OwnerReference) | Nil
  ...
  class Apimachinery::Apis::Meta::V1::ObjectMeta < ::K8S::Types::Apimachinery::Apis::Meta::V1::ObjectMeta::Instance
    ...
    #
    # This field is alpha and can be changed or removed without notice.
    def managed_fields : ::Array(::K8S::Apimachinery::Apis::Meta::V1::ManagedFieldsEntry)?
      self.["managedFields"].as(::Array(::K8S::Apimachinery::Apis::Meta::V1::ManagedFieldsEntry)?)
    end

    # :ditto:
    def managed_fields! : ::Array(::K8S::Apimachinery::Apis::Meta::V1::ManagedFieldsEntry)
      self.["managedFields"].as(::Array(::K8S::Apimachinery::Apis::Meta::V1::ManagedFieldsEntry)?).not_nil!
    end
    ...
    # :ditto:
    def managed_fields=(value : ::Array(::K8S::Apimachinery::Apis::Meta::V1::ManagedFieldsEntry)?)
      self.["managedFields"] = value
    end
