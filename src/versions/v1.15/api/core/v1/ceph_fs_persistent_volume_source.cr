...
module K8S
  ...
  class Api::Core::V1::CephFSPersistentVolumeSource
    ...
    def initialize(*, @monitors : Array(String), @path : String | Nil = nil, @read_only : Bool | Nil = nil, @secret_file : String | Nil = nil, @secret_ref : Api::Core::V1::SecretReference | Nil = nil, @user : String | Nil = nil)
    end
  end
end
