...
module K8S
  ...
  module Types::Api::Core::V1::RBDVolumeSource
    alias ValueType = String | ::Array(String) | ::Bool | ::K8S::Api::Core::V1::LocalObjectReference | Nil
  ...
  class Api::Core::V1::RBDVolumeSource < ::K8S::Types::Api::Core::V1::RBDVolumeSource::Instance
