...
::K8S::Kubernetes::Resource.define_resource("", "v1", "Node",
  ...
  properties: [
    ...
    {name: "spec", kind: ::K8S::Api::Core::V1::NodeSpec, key: "spec", nilable: true, read_only: false, description: "Spec defines the behavior of a node. [https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)"},
