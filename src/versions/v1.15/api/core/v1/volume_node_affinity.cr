...
module K8S
  ...
  @[::K8S::Properties(
    required: {key: "required", accessor: "required", kind: "::K8S::Api::Core::V1::NodeSelector", nilable: true, default: nil, read_only: false, description: "Required specifies hard node constraints that must be met."},
  )]
