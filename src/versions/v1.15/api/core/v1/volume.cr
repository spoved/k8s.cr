...
module K8S
  ...
  module Types::Api::Core::V1::Volume
    ...
    # Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: [[https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md](https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md)](https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md](https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md))
    ...
    # ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: [[https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md](https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md)](https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md](https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md))
  ...
  @[::K8S::Properties(
    ...
    azure_file: {key: "azureFile", accessor: "azure_file", kind: "::K8S::Api::Core::V1::AzureFileVolumeSource", nilable: true, default: nil, read_only: false, description: "AzureFile represents an Azure File Service mount on the host and bind mount to the pod."},
    cephfs: {key: "cephfs", accessor: "cephfs", kind: "::K8S::Api::Core::V1::CephFSVolumeSource", nilable: true, default: nil, read_only: false, description: "CephFS represents a Ceph FS mount on the host that shares a pod's lifetime"},
    cinder: {key: "cinder", accessor: "cinder", kind: "::K8S::Api::Core::V1::CinderVolumeSource", nilable: true, default: nil, read_only: false, description: "Cinder represents a cinder volume attached and mounted on kubelets host machine More info: [https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md](https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md)"},
    config_map: {key: "configMap", accessor: "config_map", kind: "::K8S::Api::Core::V1::ConfigMapVolumeSource", nilable: true, default: nil, read_only: false, description: "ConfigMap represents a configMap that should populate this volume"},
    csi: {key: "csi", accessor: "csi", kind: "::K8S::Api::Core::V1::CSIVolumeSource", nilable: true, default: nil, read_only: false, description: "CSI (Container Storage Interface) represents storage that is handled by an external CSI driver (Alpha feature)."},
    downward_api: {key: "downwardAPI", accessor: "downward_api", kind: "::K8S::Api::Core::V1::DownwardAPIVolumeSource", nilable: true, default: nil, read_only: false, description: "DownwardAPI represents downward API about the pod that should populate this volume"},
    ...
    flex_volume: {key: "flexVolume", accessor: "flex_volume", kind: "::K8S::Api::Core::V1::FlexVolumeSource", nilable: true, default: nil, read_only: false, description: "FlexVolume represents a generic volume resource that is [provisioned/attached using an exec based plugin.](provisioned/attached using an exec based plugin.)"},
    flocker: {key: "flocker", accessor: "flocker", kind: "::K8S::Api::Core::V1::FlockerVolumeSource", nilable: true, default: nil, read_only: false, description: "Flocker represents a Flocker volume attached to a kubelet's host machine. This depends on the Flocker control service being running"},
    ...
    glusterfs: {key: "glusterfs", accessor: "glusterfs", kind: "::K8S::Api::Core::V1::GlusterfsVolumeSource", nilable: true, default: nil, read_only: false, description: "Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime. More info: [https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md](https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md)"},
    ...
    iscsi: {key: "iscsi", accessor: "iscsi", kind: "::K8S::Api::Core::V1::ISCSIVolumeSource", nilable: true, default: nil, read_only: false, description: "ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod. More info: [https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md](https://releases.k8s.io/HEAD/examples/volumes/iscsi/README.md)"},
    name: {key: "name", accessor: "name", kind: "String", nilable: false, default: nil, read_only: false, description: "Volume's name. Must be a DNS_LABEL and unique within the pod. More info: [https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names](https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names)"},
    ...
    projected: {key: "projected", accessor: "projected", kind: "::K8S::Api::Core::V1::ProjectedVolumeSource", nilable: true, default: nil, read_only: false, description: "Items for all in one resources secrets, configmaps, and downward API"},
    ...
    rbd: {key: "rbd", accessor: "rbd", kind: "::K8S::Api::Core::V1::RBDVolumeSource", nilable: true, default: nil, read_only: false, description: "RBD represents a Rados Block Device mount on the host that shares a pod's lifetime. More info: [https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md](https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md)"},
    scale_io: {key: "scaleIO", accessor: "scale_io", kind: "::K8S::Api::Core::V1::ScaleIOVolumeSource", nilable: true, default: nil, read_only: false, description: "ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes."},
    ...
    storageos: {key: "storageos", accessor: "storageos", kind: "::K8S::Api::Core::V1::StorageOSVolumeSource", nilable: true, default: nil, read_only: false, description: "StorageOS represents a StorageOS volume attached and mounted on Kubernetes nodes."},
