...
::K8S::Kubernetes::Resource.define_object("DaemonSetSpec",
  ...
  properties: [
    ...
    {name: "selector", kind: ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector, key: "selector", nilable: true, read_only: false, description: "A label query over pods that are managed by the daemon set. Must match in order to be controlled. If empty, defaulted to labels on Pod template. More info: [https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors)"},
    ...
    {name: "template_generation", kind: Int32, key: "templateGeneration", nilable: true, read_only: false, description: "DEPRECATED. A sequence number representing a specific generation of the template. Populated by the system. It can be set only during the creation."},
    {name: "update_strategy", kind: ::K8S::Api::Extensions::V1beta1::DaemonSetUpdateStrategy, key: "updateStrategy", nilable: true, read_only: false, description: "An update strategy to replace existing DaemonSet pods with new pods."},
