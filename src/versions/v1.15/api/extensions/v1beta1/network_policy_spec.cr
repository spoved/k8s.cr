...
module K8S
  ...
  class Api::Extensions::V1beta1::NetworkPolicySpec < ::K8S::Types::Api::Extensions::V1beta1::NetworkPolicySpec::Instance
    ...
    def egress : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyEgressRule)?
      self.["egress"].as(::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyEgressRule)?)
    end

    # :ditto:
    def egress! : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyEgressRule)
      self.["egress"].as(::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyEgressRule)?).not_nil!
    end
    ...
    # :ditto:
    def egress=(value : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyEgressRule)?)
      self.["egress"] = value
    end

    # List of ingress rules to be applied to the selected pods. Traffic is allowed to a pod if there are no NetworkPolicies selecting the pod OR if the traffic source is the pod's local node, OR if the traffic matches at least one ingress rule across all of the NetworkPolicy objects whose podSelector matches the pod. If this field is empty then this NetworkPolicy does not allow any traffic (and serves solely to ensure that the pods it selects are isolated by default).
    def ingress : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyIngressRule)?
      self.["ingress"].as(::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyIngressRule)?)
    end

    # :ditto:
    def ingress! : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyIngressRule)
      self.["ingress"].as(::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyIngressRule)?).not_nil!
    end
    ...
    # :ditto:
    def ingress=(value : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyIngressRule)?)
      self.["ingress"] = value
    end
