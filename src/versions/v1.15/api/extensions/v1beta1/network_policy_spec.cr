...
module K8S
  ...
  class Api::Extensions::V1beta1::NetworkPolicySpec
    ...
    def initialize(*, @pod_selector : Apimachinery::Apis::Meta::V1::LabelSelector, @egress : Array(Api::Extensions::V1beta1::NetworkPolicyEgressRule) | Nil = nil, @ingress : Array(Api::Extensions::V1beta1::NetworkPolicyIngressRule) | Nil = nil, @policy_types : Array(String) | Nil = nil)
    end
  end
end
