...
module K8S::Types::Api::Extensions::V1beta1::AllowedHostPath; end

module K8S
  # Namespace holding the types for `Api::Extensions::V1beta1::AllowedHostPath`.
  module Types::Api::Extensions::V1beta1::AllowedHostPath
  ...
  class Api::Extensions::V1beta1::AllowedHostPath < ::K8S::Types::Api::Extensions::V1beta1::AllowedHostPath::Instance
