...
module K8S::Types::Api::Storage::V1beta1::CSIDriver; end

require "../../../apimachinery/apis/meta/v1/object_meta"
require "./csi_driver_spec"

module K8S
  # Namespace holding the types for `Api::Storage::V1beta1::CSIDriver`.
  module Types::Api::Storage::V1beta1::CSIDriver
    ...
    abstract def spec : ::K8S::Api::Storage::V1beta1::CSIDriverSpec?
    # :ditto:
    abstract def spec! : ::K8S::Api::Storage::V1beta1::CSIDriverSpec
    # :ditto:
    abstract def spec? : ::K8S::Api::Storage::V1beta1::CSIDriverSpec?
    # :ditto:
    abstract def spec=(value : ::K8S::Api::Storage::V1beta1::CSIDriverSpec)
  end

  # CSIDriver captures information about a Container Storage Interface (CSI) volume driver deployed on the cluster. CSI drivers do not need to create the CSIDriver object directly. Instead they may use the cluster-driver-registrar sidecar container. When deployed with a CSI driver it automatically creates a CSIDriver object representing the driver. Kubernetes attach detach controller uses this object to determine whether attach is required. Kubelet uses this object to determine whether pod information needs to be passed on mount. CSIDriver objects are non-namespaced.
  @[::K8S::GroupVersionKind(group: "storage.k8s.io", kind: "CSIDriver", version: "v1beta1", full: "io.k8s.api.storage.v1beta1.CSIDriver")]
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Storage::V1beta1::CSIDriverSpec", nilable: false, default: nil, read_only: false, description: "Specification of the CSI Driver.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Storage::V1beta1::CSIDriver < ::K8S::Kubernetes::Resource::Object
    include ::K8S::Types::Api::Storage::V1beta1::CSIDriver
    k8s_object_accessor("apiVersion", api_version : String = "storage/v1beta1", false, true, "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources))")
    k8s_object_accessor("kind", kind : String = "CSIDriver", false, true, "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))")
    ...
    k8s_object_accessor("spec", spec : ::K8S::Api::Storage::V1beta1::CSIDriverSpec, false, false, "Specification of the CSI Driver.")

    def initialize(*, api_version : String? = "storage/v1beta1", kind : String? = "CSIDriver", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, spec : ::K8S::Api::Storage::V1beta1::CSIDriverSpec? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "kind", accessor: "kind", nilable: false, read_only: true, default: "CSIDriver", kind: String},
      {key: "metadata", accessor: "metadata", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta},
      {key: "spec", accessor: "spec", nilable: false, read_only: false, default: nil, kind: ::K8S::Api::Storage::V1beta1::CSIDriverSpec},
    ])
  end

  module Resources::Storage::V1beta1
    alias CSIDriver = ::K8S::Api::Storage::V1beta1::CSIDriver
  end
end
