...
module K8S
  ...
  @[::K8S::Properties(
    ...
    last_update_time: {key: "lastUpdateTime", accessor: "last_update_time", kind: "::Time", nilable: true, default: nil, read_only: false, description: "The last time this condition was updated."},
    ...
    type: {key: "type", accessor: "type", kind: "String", nilable: false, default: nil, read_only: false, description: "Type of deployment condition."},
  )]
