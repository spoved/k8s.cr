...
module K8S
  ...
  @[::K8S::Properties(
    ...
    ready_replicas: {key: "readyReplicas", accessor: "ready_replicas", kind: "Int32", nilable: true, default: nil, read_only: false, description: "Total number of ready pods targeted by this deployment.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Apps::V1::DeploymentStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("readyReplicas", ready_replicas : Int32, true, false, "Total number of ready pods targeted by this deployment.")
