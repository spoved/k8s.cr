...
::K8S::Kubernetes::Resource.define_resource("rbac.authorization.k8s.io", "v1", "ClusterRole",
  ...
  properties: [
    ...
    {name: "rules", kind: ::Array(::K8S::Api::Rbac::V1::PolicyRule), key: "rules", nilable: true, read_only: false, description: "Rules holds all the PolicyRules for this ClusterRole"},
