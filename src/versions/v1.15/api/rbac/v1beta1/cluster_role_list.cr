...
module K8S
  ...
  module Types::Api::Rbac::V1beta1::ClusterRoleList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Rbac::V1beta1::ClusterRole) | Nil
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Rbac::V1beta1::ClusterRole)", nilable: false, default: nil, read_only: false, description: "Items is a list of ClusterRoles"},
  )]
  class Api::Rbac::V1beta1::ClusterRoleList < ::K8S::Types::Api::Rbac::V1beta1::ClusterRoleList::Instance
    include ::K8S::Types::Api::Rbac::V1beta1::ClusterRoleList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Rbac::V1beta1::ClusterRole)
    ...
    # Items is a list of ClusterRoles
    def items : Array(::K8S::Api::Rbac::V1beta1::ClusterRole)
      self.["items"].as(Array(::K8S::Api::Rbac::V1beta1::ClusterRole))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Rbac::V1beta1::ClusterRole)
      self.["items"].as(Array(::K8S::Api::Rbac::V1beta1::ClusterRole)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Rbac::V1beta1::ClusterRole))
      self.["items"] = value
    end
