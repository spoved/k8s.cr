...
module K8S
  # Namespace holding the types for `Api::Admissionregistration::V1beta1::MutatingWebhookConfiguration`.
  module Types::Api::Admissionregistration::V1beta1::MutatingWebhookConfiguration
    ...
    abstract def webhooks : ::Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhook)?
    # :ditto:
    abstract def webhooks! : ::Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhook)
    # :ditto:
    abstract def webhooks? : ::Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhook)?
    # :ditto:
    abstract def webhooks=(value : ::Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhook))
  end
  ...
  @[::K8S::Properties(
    ...
    webhooks: {key: "webhooks", accessor: "webhooks", kind: "::Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhook)", nilable: true, default: nil, read_only: false, description: "Webhooks is a list of webhooks and the affected resources and operations.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Admissionregistration::V1beta1::MutatingWebhookConfiguration < ::K8S::Kubernetes::Resource::Object
    include ::K8S::Types::Api::Admissionregistration::V1beta1::MutatingWebhookConfiguration
    ...
    k8s_object_accessor("webhooks", webhooks : ::Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhook), true, false, "Webhooks is a list of webhooks and the affected resources and operations.")

    def initialize(*, api_version : String? = "admissionregistration/v1beta1", kind : String? = "MutatingWebhookConfiguration", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, webhooks : ::Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhook)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "webhooks", accessor: "webhooks", nilable: true, read_only: false, default: nil, kind: ::Array(::K8S::Api::Admissionregistration::V1beta1::MutatingWebhook)},
    ])
  end
