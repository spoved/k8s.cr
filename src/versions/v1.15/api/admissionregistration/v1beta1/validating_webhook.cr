...
module K8S
  ...
  class Api::Admissionregistration::V1beta1::ValidatingWebhook
    ...
    @[::JSON::Field(key: "admissionReviewVersions", emit_null: false)]
    @[::YAML::Field(key: "admissionReviewVersions", emit_null: false)]
    ...
    def initialize(*, @client_config : Api::Admissionregistration::V1beta1::WebhookClientConfig, @name : String, @admission_review_versions : Array(String) | Nil = nil, @failure_policy : String | Nil = nil, @match_policy : String | Nil = nil, @namespace_selector : Apimachinery::Apis::Meta::V1::LabelSelector | Nil = nil, @object_selector : Apimachinery::Apis::Meta::V1::LabelSelector | Nil = nil, @rules : Array(Api::Admissionregistration::V1beta1::RuleWithOperations) | Nil = nil, @side_effects : String | Nil = nil, @timeout_seconds : Int32 | Nil = nil)
    end
  end
end
