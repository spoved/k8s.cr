...
module K8S
  ...
  class Api::Autoscaling::V2beta2::ExternalMetricSource < ::K8S::GenericObject
    ...
    def initialize(*, metric : ::K8S::Api::Autoscaling::V2beta2::MetricIdentifier? = nil, target : ::K8S::Api::Autoscaling::V2beta2::MetricTarget? = nil)
      super()
      self.["metric"] = metric
      self.["target"] = target
    end
