...
module K8S
  ...
  @[::K8S::Properties(
    ...
    default: {key: "default", accessor: "default", kind: "::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::Json", nilable: true, default: nil, read_only: false, description: "default is a default value for undefined object fields. Defaulting is an alpha feature under the CustomResourceDefaulting feature gate. Defaulting requires spec.preserveUnknownFields to be false.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1beta1::JsonSchemaProps < ::K8S::GenericObject
    ...
    k8s_object_accessor("default", default : ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::Json, true, false, "default is a default value for undefined object fields. Defaulting is an alpha feature under the CustomResourceDefaulting feature gate. Defaulting requires spec.preserveUnknownFields to be false.")
