...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "rbac.authorization.k8s.io", kind: "ClusterRoleBinding", version: "v1")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Rbac::V1::ClusterRoleBinding < ::K8S::Kubernetes::Resource
