...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "rbac.authorization.k8s.io", kind: "RoleBinding", version: "v1alpha1")]
  @[::K8S::Action(name: "post", verb: "post",
    path: "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "list", verb: "get",
    path: "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings", toplevel: true,
    args: [{name: "context", type: String | Nil, default: nil},
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/rolebindings/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Rbac::V1alpha1::RoleBinding < ::K8S::Kubernetes::Resource
  ...
  module Resources::Rbac::V1alpha1
    alias RoleBinding = ::K8S::Api::Rbac::V1alpha1::RoleBinding
  end
end
