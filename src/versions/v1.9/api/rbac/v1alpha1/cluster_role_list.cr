...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "rbac.authorization.k8s.io", kind: "ClusterRoleList", version: "v1alpha1")]
  ...
  class Api::Rbac::V1alpha1::ClusterRoleList < ::K8S::Kubernetes::Resource
