...
module K8S
  ...
  @[::K8S::Properties(
    json_path: {key: "JSONPath", accessor: "json_path", kind: "String", nilable: false, default: nil, read_only: false, description: "JSONPath is a simple JSON path, i.e. with array notation."},
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceColumnDefinition < ::K8S::Types::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceColumnDefinition::Instance
