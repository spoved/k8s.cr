...
::K8S::Kubernetes::Resource.define_resource("apiextensions.k8s.io", "v1beta1", "CustomResourceDefinition",
  ...
  properties: [
    ...
    {name: "spec", kind: ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionSpec, key: "spec", nilable: false, read_only: false, description: "Spec describes how the user wants the resources to appear"},
