...
module K8S
  ...
  @[::K8S::Properties(
    ca_bundle: {key: "caBundle", accessor: "ca_bundle", kind: "String", nilable: true, default: nil, read_only: false, description: "CABundle is a PEM encoded CA bundle which will be used to validate an API server's serving certificate.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class KubeAggregator::Apis::Apiregistration::V1::APIServiceSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("caBundle", ca_bundle : String, true, false, "CABundle is a PEM encoded CA bundle which will be used to validate an API server's serving certificate.")
