...
::K8S::Kubernetes::Resource.define_object("APIServiceSpec",
  ...
  properties: [
    ...
    {name: "ca_bundle", kind: String, key: "caBundle", nilable: true, read_only: false, description: "CABundle is a PEM encoded CA bundle which will be used to validate an API server's serving certificate."},
