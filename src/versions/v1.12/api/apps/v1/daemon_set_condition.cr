...
::K8S::Kubernetes::Resource.define_object("DaemonSetCondition",
  ...
  properties: [
    ...
    {name: "type", kind: String, key: "type", nilable: false, read_only: false, description: "Type of DaemonSet condition."},
