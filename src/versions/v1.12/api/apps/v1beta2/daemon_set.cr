...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "apps", kind: "DaemonSet", version: "v1beta2")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apps/v1beta2/namespaces/{namespace}/daemonsets/{name}/status", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  ...
  module Resources::Apps::V1beta2
    alias DaemonSet = ::K8S::Api::Apps::V1beta2::DaemonSet
  end
end
