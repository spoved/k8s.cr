...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "apps", kind: "ReplicaSet", version: "v1beta2")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}/status", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/apps/v1beta2/namespaces/{namespace}/replicasets/{name}/status", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "patch", verb: "path",
  ...
  class Api::Apps::V1beta2::ReplicaSet < ::K8S::Kubernetes::Resource
  ...
  module Resources::Apps::V1beta2
    alias ReplicaSet = ::K8S::Api::Apps::V1beta2::ReplicaSet
  end
end
