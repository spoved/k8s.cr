...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "apps", kind: "StatefulSet", version: "v1beta1")]
  @[::K8S::Action(name: "post", verb: "post",
    path: "/apis/apps/v1beta1/namespaces/{namespace}/statefulsets", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "include_uninitialized", type: Bool | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "list", verb: "get",
    path: "/apis/apps/v1beta1/namespaces/{namespace}/statefulsets", toplevel: true,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "include_uninitialized", type: Bool | Nil, default: nil},
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}/status", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/apps/v1beta1/namespaces/{namespace}/statefulsets/{name}/status", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "patch", verb: "path",
  ...
  class Api::Apps::V1beta1::StatefulSet < ::K8S::Kubernetes::Resource
  ...
  module Resources::Apps::V1beta1
    alias StatefulSet = ::K8S::Api::Apps::V1beta1::StatefulSet
  end
end
