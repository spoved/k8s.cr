...
module K8S
  ...
  module Types::Api::Rbac::V1::Role
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::Array(::K8S::Api::Rbac::V1::PolicyRule) | Nil
  ...
  class Api::Rbac::V1::Role < ::K8S::Types::Api::Rbac::V1::Role::Instance
