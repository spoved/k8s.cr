...
module K8S
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/coordination.k8s.io/v1beta1/namespaces/{namespace}/leases/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Coordination::V1beta1::Lease < ::K8S::Kubernetes::Resource
