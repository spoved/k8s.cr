...
module K8S
  ...
  class Api::Core::V1::PodList < ::K8S::Kubernetes::ResourceList(Api::Core::V1::Pod)
    ...
    def initialize(*, @items : Array(Api::Core::V1::Pod), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
