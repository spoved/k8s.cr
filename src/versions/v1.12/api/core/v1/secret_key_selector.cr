...
module K8S
  ...
  @[::K8S::Properties(
    key: {key: "key", accessor: "key", kind: "String", nilable: false, default: nil, read_only: false, description: "The key of the secret to select from.  Must be a valid secret key.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    optional: {key: "optional", accessor: "optional", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "Specify whether the Secret or it's key must be defined", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Core::V1::SecretKeySelector < ::K8S::GenericObject
    include ::K8S::Types::Api::Core::V1::SecretKeySelector
    k8s_object_accessor("key", key : String, false, false, "The key of the secret to select from.  Must be a valid secret key.")
    ...
    k8s_object_accessor("optional", optional : ::Bool, true, false, "Specify whether the Secret or it's key must be defined")
