...
module K8S
  ...
  @[::K8S::Properties(
    ...
    cinder: {key: "cinder", accessor: "cinder", kind: "::K8S::Api::Core::V1::CinderPersistentVolumeSource", nilable: true, default: nil, read_only: false, description: "Cinder represents a cinder volume attached and mounted on kubelets host machine More info: [https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md](https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md)"},
    ...
    csi: {key: "csi", accessor: "csi", kind: "::K8S::Api::Core::V1::CSIPersistentVolumeSource", nilable: true, default: nil, read_only: false, description: "CSI represents storage that handled by an external CSI driver (Beta feature)."},
    ...
    storageos: {key: "storageos", accessor: "storageos", kind: "::K8S::Api::Core::V1::StorageOSPersistentVolumeSource", nilable: true, default: nil, read_only: false, description: "StorageOS represents a StorageOS volume that is attached to the kubelet's host machine and mounted into the pod More info: [https://releases.k8s.io/HEAD/examples/volumes/storageos/README.md](https://releases.k8s.io/HEAD/examples/volumes/storageos/README.md)"},
