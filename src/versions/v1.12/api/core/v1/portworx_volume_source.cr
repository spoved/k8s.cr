...
module K8S
  ...
  @[::K8S::Properties(
    ...
    volume_id: {key: "volumeID", accessor: "volume_id", kind: "String", nilable: false, default: nil, read_only: false, description: "VolumeID uniquely identifies a Portworx volume"},
  )]
