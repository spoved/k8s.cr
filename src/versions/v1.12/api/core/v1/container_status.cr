...
module K8S
  ...
  class Api::Core::V1::ContainerStatus < ::K8S::GenericObject
    ...
    def initialize(*, container_id : String? = nil, image : String? = nil, image_id : String? = nil, last_state : ::K8S::Api::Core::V1::ContainerState? = nil, name : String? = nil, ready : ::Bool? = nil, restart_count : Int32? = nil, state : ::K8S::Api::Core::V1::ContainerState? = nil)
      super()
