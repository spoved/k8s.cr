...
module K8S
  ...
  module Types::Api::Core::V1::Pod
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::K8S::Api::Core::V1::PodSpec | ::K8S::Api::Core::V1::PodStatus | Nil
  ...
  class Api::Core::V1::Pod < ::K8S::Types::Api::Core::V1::Pod::Instance
    ...
    # Most recently observed status of the pod. This data may not be up to date. Populated by the system. Read-only. More info: [[https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status))
    def status : ::K8S::Api::Core::V1::PodStatus?
      self.["status"].as(::K8S::Api::Core::V1::PodStatus?)
    end

    # :ditto:
    def status! : ::K8S::Api::Core::V1::PodStatus
      self.["status"].as(::K8S::Api::Core::V1::PodStatus?).not_nil!
    end
    ...
    # :ditto:
    def status=(value : ::K8S::Api::Core::V1::PodStatus?)
      self.["status"] = value
    end
