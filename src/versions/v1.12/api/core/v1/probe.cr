...
module K8S
  ...
  class Api::Core::V1::Probe < ::K8S::GenericObject
    ...
    k8s_object_accessor("successThreshold", success_threshold : Int32, true, false, "Minimum consecutive successes for the probe to be considered successful after having failed. Defaults to 1. Must be 1 for liveness. Minimum value is 1.")
    ...
    def initialize(*, exec : ::K8S::Api::Core::V1::ExecAction? = nil, failure_threshold : Int32? = nil, http_get : ::K8S::Api::Core::V1::HTTPGetAction? = nil, initial_delay_seconds : Int32? = nil, period_seconds : Int32? = nil, success_threshold : Int32? = nil, tcp_socket : ::K8S::Api::Core::V1::TCPSocketAction? = nil, timeout_seconds : Int32? = nil)
      super()
      self.["exec"] = exec
