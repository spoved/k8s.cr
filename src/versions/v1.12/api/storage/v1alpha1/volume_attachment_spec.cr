...
module K8S
  ...
  module Types::Api::Storage::V1alpha1::VolumeAttachmentSpec
    alias ValueType = String | ::K8S::Api::Storage::V1alpha1::VolumeAttachmentSource | Nil
  ...
  class Api::Storage::V1alpha1::VolumeAttachmentSpec < ::K8S::Types::Api::Storage::V1alpha1::VolumeAttachmentSpec::Instance
    ...
    # Source represents the volume that should be attached.
    def source : ::K8S::Api::Storage::V1alpha1::VolumeAttachmentSource
      self.["source"].as(::K8S::Api::Storage::V1alpha1::VolumeAttachmentSource)
    end

    # :ditto:
    def source! : ::K8S::Api::Storage::V1alpha1::VolumeAttachmentSource
      self.["source"].as(::K8S::Api::Storage::V1alpha1::VolumeAttachmentSource).not_nil!
    end
    ...
    # :ditto:
    def source=(value : ::K8S::Api::Storage::V1alpha1::VolumeAttachmentSource)
      self.["source"] = value
    end
