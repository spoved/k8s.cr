...
module K8S
  ...
  module Types::Api::Admissionregistration::V1beta1::ValidatingWebhookConfigurationList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Admissionregistration::V1beta1::ValidatingWebhookConfiguration) | Nil
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Admissionregistration::V1beta1::ValidatingWebhookConfiguration)", nilable: false, default: nil, read_only: false, description: "List of ValidatingWebhookConfiguration."},
  )]
  class Api::Admissionregistration::V1beta1::ValidatingWebhookConfigurationList < ::K8S::Types::Api::Admissionregistration::V1beta1::ValidatingWebhookConfigurationList::Instance
    include ::K8S::Types::Api::Admissionregistration::V1beta1::ValidatingWebhookConfigurationList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Admissionregistration::V1beta1::ValidatingWebhookConfiguration)
