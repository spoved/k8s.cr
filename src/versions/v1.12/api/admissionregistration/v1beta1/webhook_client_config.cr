...
module K8S
  ...
  @[::K8S::Properties(
    ca_bundle: {key: "caBundle", accessor: "ca_bundle", kind: "String", nilable: false, default: nil, read_only: false, description: "`caBundle` is a PEM encoded CA bundle which will be used to validate the webhook's server certificate. Required.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Admissionregistration::V1beta1::WebhookClientConfig < ::K8S::Types::Api::Admissionregistration::V1beta1::WebhookClientConfig::Instance
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        { key: "caBundle", accessor: "ca_bundle", nilable: false, read_only: false, default: nil, kind: String },
