...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)", nilable: false, default: nil, read_only: false, description: "list of horizontal pod autoscaler objects."},
  )]
