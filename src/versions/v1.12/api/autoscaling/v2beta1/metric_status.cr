...
module K8S
  ...
  class Api::Autoscaling::V2beta1::MetricStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("type", type : String, false, false, "type is the type of metric source.  It will be one of \"Object\", \"Pods\" or \"Resource\", each corresponds to a matching field in the object.")

    def initialize(*, external : ::K8S::Api::Autoscaling::V2beta1::ExternalMetricStatus? = nil, object : ::K8S::Api::Autoscaling::V2beta1::ObjectMetricStatus? = nil, pods : ::K8S::Api::Autoscaling::V2beta1::PodsMetricStatus? = nil, resource : ::K8S::Api::Autoscaling::V2beta1::ResourceMetricStatus? = nil, type : String? = nil)
      super()
