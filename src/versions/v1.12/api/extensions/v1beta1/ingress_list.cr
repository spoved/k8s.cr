...
module K8S
  ...
  class Api::Extensions::V1beta1::IngressList < ::K8S::Kubernetes::ResourceList(Api::Extensions::V1beta1::Ingress)
    ...
    def initialize(*, @items : Array(Api::Extensions::V1beta1::Ingress), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
