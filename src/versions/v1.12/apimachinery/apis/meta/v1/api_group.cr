...
module K8S
  ...
  @[::K8S::Properties(
    ...
    name: {key: "name", accessor: "name", kind: "String", nilable: false, default: nil, read_only: false, description: "name is the name of the group."},
    preferred_version: {key: "preferredVersion", accessor: "preferred_version", kind: "::K8S::Apimachinery::Apis::Meta::V1::GroupVersionForDiscovery", nilable: true, default: nil, read_only: false, description: "preferredVersion is the version preferred by the API server, which probably is the storage version."},
    ...
    versions: {key: "versions", accessor: "versions", kind: "::Array(::K8S::Apimachinery::Apis::Meta::V1::GroupVersionForDiscovery)", nilable: false, default: nil, read_only: false, description: "versions are the versions supported in this group."},
  )]
