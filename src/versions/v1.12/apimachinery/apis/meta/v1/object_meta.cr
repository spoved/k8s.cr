...
module K8S
  ...
  class Apimachinery::Apis::Meta::V1::ObjectMeta < ::K8S::GenericObject
    ...
    def initialize(*, annotations : ::Hash(String, String)? = nil, cluster_name : String? = nil, creation_timestamp : ::Time? = nil, deletion_grace_period_seconds : Int32? = nil, deletion_timestamp : ::Time? = nil, finalizers : ::Array(String)? = nil, generate_name : String? = nil, generation : Int32? = nil, initializers : ::K8S::Apimachinery::Apis::Meta::V1::Initializers? = nil, labels : ::Hash(String, String)? = nil, name : String? = nil, namespace : String? = nil, owner_references : ::Array(::K8S::Apimachinery::Apis::Meta::V1::OwnerReference)? = nil, resource_version : String? = nil, self_link : String? = nil, uid : String? = nil)
      super()
