...
module K8S
  ...
  class Apimachinery::Apis::Meta::V1::APIResource
    ...
    def initialize(*, @kind : String, @name : String, @namespaced : Bool, @singular_name : String, @verbs : Array(String), @categories : Array(String) | Nil = nil, @group : String | Nil = nil, @short_names : Array(String) | Nil = nil, @storage_version_hash : String | Nil = nil, @version : String | Nil = nil)
    end
  end
end
