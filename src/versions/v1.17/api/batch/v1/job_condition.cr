...
module K8S
  ...
  @[::K8S::Properties(
    ...
    type: {key: "type", accessor: "type", kind: "String", nilable: false, default: nil, read_only: false, description: "Type of job condition, Complete or Failed.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Batch::V1::JobCondition < ::K8S::GenericObject
    include ::K8S::Types::Api::Batch::V1::JobCondition
    k8s_object_accessor("lastProbeTime", last_probe_time : ::Time, true, false, "Last time the condition was checked.")
    ...
    k8s_object_accessor("type", type : String, false, false, "Type of job condition, Complete or Failed.")
