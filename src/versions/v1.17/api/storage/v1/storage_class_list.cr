...
module K8S
  ...
  class Api::Storage::V1::StorageClassList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Storage::V1::StorageClass)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Storage::V1::StorageClass), false, false, "Items is the list of StorageClasses")

    def initialize(*, api_version : String? = "storage/v1", kind : String? = "StorageClassList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Storage::V1::StorageClass)? = nil)
      super()
