...
module K8S
  ...
  class Api::Storage::V1::CSINodeSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("drivers", drivers : ::Array(::K8S::Api::Storage::V1::CSINodeDriver), true, false, "drivers is a list of information of all CSI Drivers existing on a node. If all drivers in the list are uninstalled, this can become empty.")

    def initialize(*, drivers : ::Array(::K8S::Api::Storage::V1::CSINodeDriver)? = nil)
      super()
