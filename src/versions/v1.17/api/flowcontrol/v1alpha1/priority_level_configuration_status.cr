...
module K8S
  ...
  class Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationStatus < ::K8S::GenericObject
    include ::K8S::Types::Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationStatus
    k8s_object_accessor("conditions", conditions : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationCondition), true, false, "`conditions` is the current state of \"request-priority\".")

    def initialize(*, conditions : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationCondition)? = nil)
      super()
