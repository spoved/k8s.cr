...
module K8S
  ...
  class Api::Flowcontrol::V1alpha1::FlowSchemaSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("rules", rules : ::Set(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects), true, false, "`rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.")

    def initialize(*, distinguisher_method : ::K8S::Api::Flowcontrol::V1alpha1::FlowDistinguisherMethod? = nil, matching_precedence : Int32? = nil, priority_level_configuration : ::K8S::Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationReference? = nil, rules : ::Set(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)? = nil)
      super()
