...
::K8S::Kubernetes::Resource.define_resource("flowcontrol.apiserver.k8s.io", "v1alpha1", "FlowSchema",
  ...
  properties: [
    ...
    {name: "status", kind: ::K8S::Api::Flowcontrol::V1alpha1::FlowSchemaStatus, key: "status", nilable: true, read_only: false, description: "`status` is the current status of a FlowSchema. More info: [https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status)"},
