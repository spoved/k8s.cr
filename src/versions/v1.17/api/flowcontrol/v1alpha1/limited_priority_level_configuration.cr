...
module K8S
  ...
  class Api::Flowcontrol::V1alpha1::LimitedPriorityLevelConfiguration < ::K8S::GenericObject
    ...
    k8s_object_accessor("limitResponse", limit_response : ::K8S::Api::Flowcontrol::V1alpha1::LimitResponse, true, false, "`limitResponse` indicates what to do with requests that can not be executed right now")

    def initialize(*, assured_concurrency_shares : Int32? = nil, limit_response : ::K8S::Api::Flowcontrol::V1alpha1::LimitResponse? = nil)
      super()
