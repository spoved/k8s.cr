...
module K8S::Types::Api::Apps::V1beta2::ControllerRevisionList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./controller_revision"

module K8S
  # Namespace holding the types for `Api::Apps::V1beta2::ControllerRevisionList`.
  module Types::Api::Apps::V1beta2::ControllerRevisionList
    ...
    abstract def items : Array(::K8S::Api::Apps::V1beta2::ControllerRevision)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Apps::V1beta2::ControllerRevision)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Apps::V1beta2::ControllerRevision)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Apps::V1beta2::ControllerRevision))
  end

  # ControllerRevisionList is a resource containing a list of ControllerRevision objects.
  @[::K8S::GroupVersionKind(group: "apps", kind: "ControllerRevisionList", version: "v1beta2", full: "io.k8s.api.apps.v1beta2.ControllerRevisionList")]
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apps::V1beta2::ControllerRevision)", nilable: false, default: nil, read_only: false, description: "Items is the list of ControllerRevisions", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Apps::V1beta2::ControllerRevisionList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1beta2::ControllerRevision)
    include ::K8S::Types::Api::Apps::V1beta2::ControllerRevisionList
    k8s_object_accessor("apiVersion", api_version : String = "apps/v1beta2", false, true, "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources))")
    k8s_object_accessor("kind", kind : String = "ControllerRevisionList", false, true, "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))")
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Apps::V1beta2::ControllerRevision), false, false, "Items is the list of ControllerRevisions")

    def initialize(*, api_version : String? = "apps/v1beta2", kind : String? = "ControllerRevisionList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Apps::V1beta2::ControllerRevision)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "kind", accessor: "kind", nilable: false, read_only: true, default: "ControllerRevisionList", kind: String},
      {key: "metadata", accessor: "metadata", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::ListMeta},
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Apps::V1beta2::ControllerRevision)},
    ])
  end
end
