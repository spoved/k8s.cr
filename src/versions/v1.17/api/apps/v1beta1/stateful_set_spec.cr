...
module K8S::Types::Api::Apps::V1beta1::StatefulSetSpec; end
...
module K8S
  # Namespace holding the types for `Api::Apps::V1beta1::StatefulSetSpec`.
  module Types::Api::Apps::V1beta1::StatefulSetSpec
    alias ValueType = String | Int32 | ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector | ::K8S::Api::Core::V1::PodTemplateSpec | ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy | ::Array(::K8S::Api::Core::V1::PersistentVolumeClaim) | Nil
    ...
    # selector is a label query over pods that should match the replica count. If empty, defaulted to labels on the pod template. More info: [[https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors)](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors))
    ...
    abstract def update_strategy : ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy?
    # :ditto:
    abstract def update_strategy! : ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy
    # :ditto:
    abstract def update_strategy? : ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy?
    # :ditto:
    abstract def update_strategy=(value : ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy?)
  ...
  @[::K8S::Properties(
    ...
    revision_history_limit: {key: "revisionHistoryLimit", accessor: "revision_history_limit", kind: "Int32", nilable: true, default: nil, read_only: false, description: "revisionHistoryLimit is the maximum number of revisions that will be maintained in the StatefulSet's revision history. The revision history consists of all revisions not represented by a currently applied StatefulSetSpec version. The default value is 10."},
    selector: {key: "selector", accessor: "selector", kind: "::K8S::Apimachinery::Apis::Meta::V1::LabelSelector", nilable: true, default: nil, read_only: false, description: "selector is a label query over pods that should match the replica count. If empty, defaulted to labels on the pod template. More info: [https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors](https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#label-selectors)"},
  ...
  class Api::Apps::V1beta1::StatefulSetSpec < ::K8S::Types::Api::Apps::V1beta1::StatefulSetSpec::Instance
    include ::K8S::Types::Api::Apps::V1beta1::StatefulSetSpec
    ...
    # updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.
    def update_strategy : ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy?
      self.["updateStrategy"].as(::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy?)
    end

    # :ditto:
    def update_strategy! : ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy
      self.["updateStrategy"].as(::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy?).not_nil!
    end
    ...
    # :ditto:
    def update_strategy=(value : ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy?)
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        ...
        { key: "updateStrategy", accessor: "update_strategy", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Apps::V1beta1::StatefulSetUpdateStrategy },
