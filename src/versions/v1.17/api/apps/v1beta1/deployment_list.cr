...
module K8S
  ...
  class Api::Apps::V1beta1::DeploymentList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1beta1::Deployment)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Apps::V1beta1::Deployment), false, false, "Items is the list of Deployments.")

    def initialize(*, api_version : String? = "apps/v1beta1", kind : String? = "DeploymentList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Apps::V1beta1::Deployment)? = nil)
      super()
