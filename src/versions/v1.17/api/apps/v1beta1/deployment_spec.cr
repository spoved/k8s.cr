...
module K8S
  ...
  @[::K8S::Properties(
    ...
    paused: {key: "paused", accessor: "paused", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "Indicates that the deployment is paused."},
    ...
    replicas: {key: "replicas", accessor: "replicas", kind: "Int32", nilable: true, default: nil, read_only: false, description: "Number of desired pods. This is a pointer to distinguish between explicit zero and not specified. Defaults to 1."},
    revision_history_limit: {key: "revisionHistoryLimit", accessor: "revision_history_limit", kind: "Int32", nilable: true, default: nil, read_only: false, description: "The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. Defaults to 2."},
    rollback_to: {key: "rollbackTo", accessor: "rollback_to", kind: "::K8S::Api::Apps::V1beta1::RollbackConfig", nilable: true, default: nil, read_only: false, description: "DEPRECATED. The config this deployment is rolling back to. Will be cleared after rollback is done."},
    selector: {key: "selector", accessor: "selector", kind: "::K8S::Apimachinery::Apis::Meta::V1::LabelSelector", nilable: true, default: nil, read_only: false, description: "Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment."},
    strategy: {key: "strategy", accessor: "strategy", kind: "::K8S::Api::Apps::V1beta1::DeploymentStrategy", nilable: true, default: nil, read_only: false, description: "The deployment strategy to use to replace existing pods with new ones."},
    template: {key: "template", accessor: "template", kind: "::K8S::Api::Core::V1::PodTemplateSpec", nilable: false, default: nil, read_only: false, description: "Template describes the pods that will be created."},
  )]
