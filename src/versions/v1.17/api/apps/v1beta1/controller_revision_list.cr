...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apps::V1beta1::ControllerRevision)", nilable: false, default: nil, read_only: false, description: "Items is the list of ControllerRevisions"},
  )]
