...
::K8S::Kubernetes::Resource.define_object("EventSeries",
  ...
  properties: [
    ...
    {name: "state", kind: String, key: "state", nilable: true, read_only: false, description: "State of this Series: Ongoing or Finished Deprecated. Planned removal for 1.18"},
