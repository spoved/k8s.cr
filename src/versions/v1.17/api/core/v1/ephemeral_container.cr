...
::K8S::Kubernetes::Resource.define_object("EphemeralContainer",
  ...
  properties: [
    ...
    {name: "security_context", kind: ::K8S::Api::Core::V1::SecurityContext, key: "securityContext", nilable: true, read_only: false, description: "SecurityContext is not allowed for ephemeral containers."},
    ...
    {name: "volume_devices", kind: ::Array(::K8S::Api::Core::V1::VolumeDevice), key: "volumeDevices", nilable: true, read_only: false, description: "volumeDevices is the list of block devices to be used by the container. This is a beta feature."},
