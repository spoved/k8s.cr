...
module K8S
  ...
  @[::K8S::Properties(
    ...
    security_context: {key: "securityContext", accessor: "security_context", kind: "::K8S::Api::Core::V1::SecurityContext", nilable: true, default: nil, read_only: false, description: "SecurityContext is not allowed for ephemeral containers.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    volume_devices: {key: "volumeDevices", accessor: "volume_devices", kind: "::Array(::K8S::Api::Core::V1::VolumeDevice)", nilable: true, default: nil, read_only: false, description: "volumeDevices is the list of block devices to be used by the container. This is a beta feature.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Core::V1::EphemeralContainer < ::K8S::GenericObject
    ...
    k8s_object_accessor("securityContext", security_context : ::K8S::Api::Core::V1::SecurityContext, true, false, "SecurityContext is not allowed for ephemeral containers.")
    ...
    k8s_object_accessor("volumeDevices", volume_devices : ::Array(::K8S::Api::Core::V1::VolumeDevice), true, false, "volumeDevices is the list of block devices to be used by the container. This is a beta feature.")
