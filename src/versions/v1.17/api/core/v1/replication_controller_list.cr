...
module K8S
  ...
  class Api::Core::V1::ReplicationControllerList < ::K8S::Kubernetes::ResourceList(Api::Core::V1::ReplicationController)
    ...
    def initialize(*, @items : Array(Api::Core::V1::ReplicationController), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
