...
module K8S
  ...
  class Api::Core::V1::ReplicationControllerSpec < ::K8S::GenericObject
    ...
    def initialize(*, min_ready_seconds : Int32? = nil, replicas : Int32? = nil, selector : ::Hash(String, String)? = nil, template : ::K8S::Api::Core::V1::PodTemplateSpec? = nil)
      super()
