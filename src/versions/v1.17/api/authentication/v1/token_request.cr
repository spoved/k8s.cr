...
module K8S
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Authentication::V1::TokenRequestSpec", nilable: false, default: nil, read_only: false, description: nil},
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Authentication::V1::TokenRequestStatus", nilable: true, default: nil, read_only: false, description: nil},
  )]
