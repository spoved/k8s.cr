...
module K8S
  ...
  module Types::Api::Events::V1beta1::Event
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | Int32 | ::Time | ::K8S::Api::Core::V1::EventSource | ::K8S::Api::Core::V1::ObjectReference | ::K8S::Api::Events::V1beta1::EventSeries | Nil
  ...
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "Event", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))"},
    ...
    action: {key: "action", accessor: "action", kind: "String", nilable: true, default: nil, read_only: false, description: "What action was [taken/failed regarding to the regarding object.](taken/failed regarding to the regarding object.)"},
    deprecated_count: {key: "deprecatedCount", accessor: "deprecated_count", kind: "Int32", nilable: true, default: nil, read_only: false, description: "Deprecated field assuring backward compatibility with core.v1 Event type"},
    deprecated_first_timestamp: {key: "deprecatedFirstTimestamp", accessor: "deprecated_first_timestamp", kind: "::Time", nilable: true, default: nil, read_only: false, description: "Deprecated field assuring backward compatibility with core.v1 Event type"},
    deprecated_last_timestamp: {key: "deprecatedLastTimestamp", accessor: "deprecated_last_timestamp", kind: "::Time", nilable: true, default: nil, read_only: false, description: "Deprecated field assuring backward compatibility with core.v1 Event type"},
    deprecated_source: {key: "deprecatedSource", accessor: "deprecated_source", kind: "::K8S::Api::Core::V1::EventSource", nilable: true, default: nil, read_only: false, description: "Deprecated field assuring backward compatibility with core.v1 Event type"},
    event_time: {key: "eventTime", accessor: "event_time", kind: "::Time", nilable: true, default: nil, read_only: false, description: "Required. Time when this Event was first observed."},
    note: {key: "note", accessor: "note", kind: "String", nilable: true, default: nil, read_only: false, description: "Optional. A human-readable description of the status of this operation. Maximal length of the note is 1kB, but libraries should be prepared to handle values up to 64kB."},
    reason: {key: "reason", accessor: "reason", kind: "String", nilable: true, default: nil, read_only: false, description: "Why the action was taken."},
    ...
    related: {key: "related", accessor: "related", kind: "::K8S::Api::Core::V1::ObjectReference", nilable: true, default: nil, read_only: false, description: "Optional secondary object for more complex actions. E.g. when regarding object triggers a creation or deletion of related object."},
    reporting_controller: {key: "reportingController", accessor: "reporting_controller", kind: "String", nilable: true, default: nil, read_only: false, description: "Name of the controller that emitted this Event, e.g. [`kubernetes.io/kubelet`.](`kubernetes.io/kubelet`.)"},
    reporting_instance: {key: "reportingInstance", accessor: "reporting_instance", kind: "String", nilable: true, default: nil, read_only: false, description: "ID of the controller instance, e.g. `kubelet-xyzf`."},
    series: {key: "series", accessor: "series", kind: "::K8S::Api::Events::V1beta1::EventSeries", nilable: true, default: nil, read_only: false, description: "Data about the Event series this event represents or nil if it's a singleton Event."},
    type: {key: "type", accessor: "type", kind: "String", nilable: true, default: nil, read_only: false, description: "Type of this event (Normal, Warning), new types could be added in the future."},
  )]
  class Api::Events::V1beta1::Event < ::K8S::Types::Api::Events::V1beta1::Event::Instance
