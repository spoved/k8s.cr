...
module K8S
  ...
  module Types::Api::Authorization::V1beta1::SubjectAccessReviewSpec
    alias ValueType = ::Hash(String, ::Array(String)) | ::Array(String) | ::K8S::Api::Authorization::V1beta1::NonResourceAttributes | ::K8S::Api::Authorization::V1beta1::ResourceAttributes | String | Nil
  ...
  @[::K8S::Properties(
    ...
    group: {key: "group", accessor: "group", kind: "::Array(String)", nilable: true, default: nil, read_only: false, description: "Groups is the groups you're testing for."},
    non_resource_attributes: {key: "nonResourceAttributes", accessor: "non_resource_attributes", kind: "::K8S::Api::Authorization::V1beta1::NonResourceAttributes", nilable: true, default: nil, read_only: false, description: "NonResourceAttributes describes information for a non-resource access request"},
    resource_attributes: {key: "resourceAttributes", accessor: "resource_attributes", kind: "::K8S::Api::Authorization::V1beta1::ResourceAttributes", nilable: true, default: nil, read_only: false, description: "ResourceAuthorizationAttributes describes information for a resource access request"},
    ...
    user: {key: "user", accessor: "user", kind: "String", nilable: true, default: nil, read_only: false, description: "User is the user you're testing for. If you specify \"User\" but not \"Group\", then is it interpreted as \"What if User were not a member of any groups"},
  )]
  class Api::Authorization::V1beta1::SubjectAccessReviewSpec < ::K8S::Types::Api::Authorization::V1beta1::SubjectAccessReviewSpec::Instance
