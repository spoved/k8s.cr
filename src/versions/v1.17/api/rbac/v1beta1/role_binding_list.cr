...
module K8S
  ...
  module Types::Api::Rbac::V1beta1::RoleBindingList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Rbac::V1beta1::RoleBinding) | Nil
  ...
  class Api::Rbac::V1beta1::RoleBindingList < ::K8S::Types::Api::Rbac::V1beta1::RoleBindingList::Instance
    include ::K8S::Types::Api::Rbac::V1beta1::RoleBindingList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Rbac::V1beta1::RoleBinding)
    ...
    # Items is a list of RoleBindings
    def items : Array(::K8S::Api::Rbac::V1beta1::RoleBinding)
      self.["items"].as(Array(::K8S::Api::Rbac::V1beta1::RoleBinding))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Rbac::V1beta1::RoleBinding)
      self.["items"].as(Array(::K8S::Api::Rbac::V1beta1::RoleBinding)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Rbac::V1beta1::RoleBinding))
      self.["items"] = value
    end
