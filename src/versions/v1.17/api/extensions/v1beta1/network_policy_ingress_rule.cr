...
module K8S
  ...
  class Api::Extensions::V1beta1::NetworkPolicyIngressRule < ::K8S::GenericObject
    ...
    k8s_object_accessor("from", from : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPeer), true, false, "List of sources which should be able to access the pods selected for this rule. Items in this list are combined using a logical OR operation. If this field is empty or missing, this rule matches all sources (traffic not restricted by source). If this field is present and contains at least one item, this rule allows traffic only if the traffic matches at least one item in the from list.")
    k8s_object_accessor("ports", ports : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPort), true, false, "List of ports which should be made accessible on the pods selected for this rule. Each item in this list is combined using a logical OR. If this field is empty or missing, this rule matches all ports (traffic not restricted by port). If this field is present and contains at least one item, then this rule allows traffic only if the traffic matches at least one port in the list.")

    def initialize(*, from : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPeer)? = nil, ports : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPort)? = nil)
      super()
      self.["from"] = from
      self.["ports"] = ports
    end
