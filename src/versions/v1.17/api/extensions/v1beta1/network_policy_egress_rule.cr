...
module K8S
  ...
  module Types::Api::Extensions::V1beta1::NetworkPolicyEgressRule
    alias ValueType = ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPort) | ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPeer) | Nil
  ...
  class Api::Extensions::V1beta1::NetworkPolicyEgressRule < ::K8S::Types::Api::Extensions::V1beta1::NetworkPolicyEgressRule::Instance
    ...
    # List of destinations for outgoing traffic of pods selected for this rule. Items in this list are combined using a logical OR operation. If this field is empty or missing, this rule matches all destinations (traffic not restricted by destination). If this field is present and contains at least one item, this rule allows traffic only if the traffic matches at least one item in the to list.
    def to : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPeer)?
      self.["to"].as(::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPeer)?)
    end

    # :ditto:
    def to! : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPeer)
      self.["to"].as(::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPeer)?).not_nil!
    end
    ...
    # :ditto:
    def to=(value : ::Array(::K8S::Api::Extensions::V1beta1::NetworkPolicyPeer)?)
      self.["to"] = value
    end
