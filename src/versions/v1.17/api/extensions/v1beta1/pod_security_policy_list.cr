...
module K8S
  ...
  module Types::Api::Extensions::V1beta1::PodSecurityPolicyList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Extensions::V1beta1::PodSecurityPolicy) | Nil
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Extensions::V1beta1::PodSecurityPolicy)", nilable: false, default: nil, read_only: false, description: "items is a list of schema objects."},
  )]
  class Api::Extensions::V1beta1::PodSecurityPolicyList < ::K8S::Types::Api::Extensions::V1beta1::PodSecurityPolicyList::Instance
    include ::K8S::Types::Api::Extensions::V1beta1::PodSecurityPolicyList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Extensions::V1beta1::PodSecurityPolicy)
    ...
    # items is a list of schema objects.
    def items : Array(::K8S::Api::Extensions::V1beta1::PodSecurityPolicy)
      self.["items"].as(Array(::K8S::Api::Extensions::V1beta1::PodSecurityPolicy))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Extensions::V1beta1::PodSecurityPolicy)
      self.["items"].as(Array(::K8S::Api::Extensions::V1beta1::PodSecurityPolicy)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Extensions::V1beta1::PodSecurityPolicy))
      self.["items"] = value
    end
