...
module K8S
  ...
  class Api::Extensions::V1beta1::RuntimeClassStrategyOptions < ::K8S::GenericObject
    include ::K8S::Types::Api::Extensions::V1beta1::RuntimeClassStrategyOptions
    k8s_object_accessor("allowedRuntimeClassNames", allowed_runtime_class_names : ::Array(String), false, false, "allowedRuntimeClassNames is a whitelist of RuntimeClass names that may be specified on a pod. A value of \"*\" means that any RuntimeClass name is allowed, and must be the only item in the list. An empty list requires the RuntimeClassName field to be unset.")
