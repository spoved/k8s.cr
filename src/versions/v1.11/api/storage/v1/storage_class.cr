...
module K8S
  ...
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "StorageClass", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))"},
    ...
    allow_volume_expansion: {key: "allowVolumeExpansion", accessor: "allow_volume_expansion", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "AllowVolumeExpansion shows whether the storage class allow volume expand"},
    ...
    parameters: {key: "parameters", accessor: "parameters", kind: "::Hash(String, String)", nilable: true, default: nil, read_only: false, description: "Parameters holds the parameters for the provisioner that should create volumes of this storage class."},
    ...
    reclaim_policy: {key: "reclaimPolicy", accessor: "reclaim_policy", kind: "String", nilable: true, default: nil, read_only: false, description: "Dynamically provisioned PersistentVolumes of this storage class are created with this reclaimPolicy. Defaults to Delete."},
