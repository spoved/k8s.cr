...
module K8S
  ...
  class Api::Storage::V1::StorageClassList < ::K8S::Kubernetes::ResourceList(Api::Storage::V1::StorageClass)
    ...
    def initialize(*, @items : Array(Api::Storage::V1::StorageClass), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
