...
module K8S
  ...
  class Api::Storage::V1alpha1::VolumeAttachment < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("spec", spec : ::K8S::Api::Storage::V1alpha1::VolumeAttachmentSpec, false, false, "Specification of the desired [attach/detach volume behavior. Populated by the Kubernetes system.](attach/detach volume behavior. Populated by the Kubernetes system.)")
    k8s_object_accessor("status", status : ::K8S::Api::Storage::V1alpha1::VolumeAttachmentStatus, true, false, "Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.")

    def initialize(*, api_version : String? = "storage/v1alpha1", kind : String? = "VolumeAttachment", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, spec : ::K8S::Api::Storage::V1alpha1::VolumeAttachmentSpec? = nil, status : ::K8S::Api::Storage::V1alpha1::VolumeAttachmentStatus? = nil)
      super()
