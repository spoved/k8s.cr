...
module K8S
  ...
  @[::K8S::Properties(
    ...
    rules: {key: "rules", accessor: "rules", kind: "::Array(::K8S::Api::Rbac::V1::PolicyRule)", nilable: false, default: nil, read_only: false, description: "Rules holds all the PolicyRules for this Role"},
  )]
