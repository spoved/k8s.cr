...
module K8S::Types::Api::Apps::V1::ControllerRevisionList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./controller_revision"

module K8S
  # Namespace holding the types for `Api::Apps::V1::ControllerRevisionList`.
  module Types::Api::Apps::V1::ControllerRevisionList
    ...
    abstract def items : Array(::K8S::Api::Apps::V1::ControllerRevision)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Apps::V1::ControllerRevision)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Apps::V1::ControllerRevision)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Apps::V1::ControllerRevision))
  end
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apps::V1::ControllerRevision)", nilable: false, default: nil, read_only: false, description: "Items is the list of ControllerRevisions", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Apps::V1::ControllerRevisionList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1::ControllerRevision)
    include ::K8S::Types::Api::Apps::V1::ControllerRevisionList
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Apps::V1::ControllerRevision), false, false, "Items is the list of ControllerRevisions")

    def initialize(*, api_version : String? = "apps/v1", kind : String? = "ControllerRevisionList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Apps::V1::ControllerRevision)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Apps::V1::ControllerRevision)},
    ])
  end
end
