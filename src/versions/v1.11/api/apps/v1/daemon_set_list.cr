...
module K8S
  ...
  class Api::Apps::V1::DaemonSetList < ::K8S::Kubernetes::ResourceList(Api::Apps::V1::DaemonSet)
    ...
    def initialize(*, @items : Array(Api::Apps::V1::DaemonSet), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
