...
module K8S::Types::Api::Apps::V1beta2::DeploymentList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./deployment"

module K8S
  # Namespace holding the types for `Api::Apps::V1beta2::DeploymentList`.
  module Types::Api::Apps::V1beta2::DeploymentList
    ...
    abstract def items : Array(::K8S::Api::Apps::V1beta2::Deployment)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Apps::V1beta2::Deployment)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Apps::V1beta2::Deployment)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Apps::V1beta2::Deployment))
  end
  ...
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "DeploymentList", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Apps::V1beta2::DeploymentList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1beta2::Deployment)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Apps::V1beta2::Deployment), false, false, "Items is the list of Deployments.")

    def initialize(*, api_version : String? = "apps/v1beta2", kind : String? = "DeploymentList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Apps::V1beta2::Deployment)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "kind", accessor: "kind", nilable: false, read_only: true, default: "DeploymentList", kind: String},
      {key: "metadata", accessor: "metadata", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::ListMeta},
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Apps::V1beta2::Deployment)},
    ])
  end
end
