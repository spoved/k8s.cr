...
module K8S
  ...
  class Api::Extensions::V1beta1::PodSecurityPolicySpec
    ...
    def initialize(*, @fs_group : Api::Extensions::V1beta1::FSGroupStrategyOptions, @run_as_user : Api::Extensions::V1beta1::RunAsUserStrategyOptions, @se_linux : Api::Extensions::V1beta1::SELinuxStrategyOptions, @supplemental_groups : Api::Extensions::V1beta1::SupplementalGroupsStrategyOptions, @allow_privilege_escalation : Bool | Nil = nil, @allowed_capabilities : Array(String) | Nil = nil, @allowed_flex_volumes : Array(Api::Extensions::V1beta1::AllowedFlexVolume) | Nil = nil, @allowed_host_paths : Array(Api::Extensions::V1beta1::AllowedHostPath) | Nil = nil, @allowed_unsafe_sysctls : Array(String) | Nil = nil, @default_add_capabilities : Array(String) | Nil = nil, @default_allow_privilege_escalation : Bool | Nil = nil, @forbidden_sysctls : Array(String) | Nil = nil, @host_ipc : Bool | Nil = nil, @host_network : Bool | Nil = nil, @host_pid : Bool | Nil = nil, @host_ports : Array(Api::Extensions::V1beta1::HostPortRange) | Nil = nil, @privileged : Bool | Nil = nil, @read_only_root_filesystem : Bool | Nil = nil, @required_drop_capabilities : Array(String) | Nil = nil, @volumes : Array(String) | Nil = nil)
    end
  end
end
