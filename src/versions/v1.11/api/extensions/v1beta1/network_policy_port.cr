...
module K8S
  ...
  class Api::Extensions::V1beta1::NetworkPolicyPort < ::K8S::GenericObject
    ...
    k8s_object_accessor("protocol", protocol : String, true, false, "Optional.  The protocol (TCP or UDP) which traffic must match. If not specified, this field defaults to TCP.")
