...
module K8S
  ...
  class Api::Extensions::V1beta1::NetworkPolicyList < ::K8S::Kubernetes::ResourceList(Api::Extensions::V1beta1::NetworkPolicy)
    ...
    def initialize(*, @items : Array(Api::Extensions::V1beta1::NetworkPolicy), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
