...
module K8S
  ...
  class Api::Extensions::V1beta1::IngressList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Extensions::V1beta1::Ingress)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Extensions::V1beta1::Ingress), false, false, "Items is the list of Ingress.")

    def initialize(*, api_version : String? = "extensions/v1beta1", kind : String? = "IngressList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Extensions::V1beta1::Ingress)? = nil)
      super()
