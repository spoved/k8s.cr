...
module K8S
  ...
  class Api::Core::V1::SecurityContext < ::K8S::GenericObject
    ...
    def initialize(*, allow_privilege_escalation : ::Bool? = nil, capabilities : ::K8S::Api::Core::V1::Capabilities? = nil, privileged : ::Bool? = nil, read_only_root_filesystem : ::Bool? = nil, run_as_group : Int32? = nil, run_as_non_root : ::Bool? = nil, run_as_user : Int32? = nil, se_linux_options : ::K8S::Api::Core::V1::SELinuxOptions? = nil)
      super()
