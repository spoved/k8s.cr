...
::K8S::Kubernetes::Resource.define_object("NodeStatus",
  ...
  properties: [
    ...
    {name: "addresses", kind: ::Array(::K8S::Api::Core::V1::NodeAddress), key: "addresses", nilable: true, read_only: false, description: "List of addresses reachable to the node. Queried from cloud provider, if available. More info: [https://kubernetes.io/docs/concepts/nodes/node/#addresses](https://kubernetes.io/docs/concepts/nodes/node/#addresses)"},
