...
module K8S
  ...
  @[::K8S::Properties(
    ...
    protocol: {key: "protocol", accessor: "protocol", kind: "String", nilable: true, default: nil, read_only: false, description: "Protocol for port. Must be UDP or TCP. Defaults to \"TCP\"."},
  )]
