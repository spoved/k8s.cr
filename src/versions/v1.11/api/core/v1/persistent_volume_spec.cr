...
::K8S::Kubernetes::Resource.define_object("PersistentVolumeSpec",
  ...
  properties: [
    ...
    {name: "cinder", kind: ::K8S::Api::Core::V1::CinderPersistentVolumeSource, key: "cinder", nilable: true, read_only: false, description: "Cinder represents a cinder volume attached and mounted on kubelets host machine More info: [https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md](https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md)"},
    ...
    {name: "csi", kind: ::K8S::Api::Core::V1::CSIPersistentVolumeSource, key: "csi", nilable: true, read_only: false, description: "CSI represents storage that handled by an external CSI driver (Beta feature)."},
    ...
    {name: "glusterfs", kind: ::K8S::Api::Core::V1::GlusterfsVolumeSource, key: "glusterfs", nilable: true, read_only: false, description: "Glusterfs represents a Glusterfs volume that is attached to a host and exposed to the pod. Provisioned by an admin. More info: [https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md](https://releases.k8s.io/HEAD/examples/volumes/glusterfs/README.md)"},
    ...
    {name: "storageos", kind: ::K8S::Api::Core::V1::StorageOSPersistentVolumeSource, key: "storageos", nilable: true, read_only: false, description: "StorageOS represents a StorageOS volume that is attached to the kubelet's host machine and mounted into the pod More info: [https://releases.k8s.io/HEAD/examples/volumes/storageos/README.md](https://releases.k8s.io/HEAD/examples/volumes/storageos/README.md)"},
    {name: "volume_mode", kind: String, key: "volumeMode", nilable: true, read_only: false, description: "volumeMode defines if a volume is intended to be used with a formatted filesystem or to remain in raw block state. Value of Filesystem is implied when not included in spec. This is an alpha feature and may change in the future."},
