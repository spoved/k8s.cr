...
module K8S
  ...
  class Api::Core::V1::ComponentStatus < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("conditions", conditions : ::Array(::K8S::Api::Core::V1::ComponentCondition), true, false, "List of component conditions observed")

    def initialize(*, api_version : String? = "v1", kind : String? = "ComponentStatus", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, conditions : ::Array(::K8S::Api::Core::V1::ComponentCondition)? = nil)
      super()
