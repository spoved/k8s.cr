...
::K8S::Kubernetes::Resource.define_object("EnvVarSource",
  ...
  properties: [
    ...
    {name: "field_ref", kind: ::K8S::Api::Core::V1::ObjectFieldSelector, key: "fieldRef", nilable: true, read_only: false, description: "Selects a field of the pod: supports metadata.name, metadata.namespace, metadata.labels, metadata.annotations, spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP."},
