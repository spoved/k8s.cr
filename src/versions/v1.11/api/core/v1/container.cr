...
module K8S
  ...
  class Api::Core::V1::Container < ::K8S::GenericObject
    ...
    k8s_object_accessor("resources", resources : ::K8S::Api::Core::V1::ResourceRequirements, true, false, "Compute Resources required by this container. Cannot be updated. More info: [https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources](https://kubernetes.io/docs/concepts/storage/persistent-volumes#resources)")
    ...
    k8s_object_accessor("volumeDevices", volume_devices : ::Array(::K8S::Api::Core::V1::VolumeDevice), true, false, "volumeDevices is the list of block devices to be used by the container. This is an alpha feature and may change in the future.")
