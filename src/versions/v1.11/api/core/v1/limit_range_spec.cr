...
module K8S
  ...
  module Types::Api::Core::V1::LimitRangeSpec
    alias ValueType = ::Array(::K8S::Api::Core::V1::LimitRangeItem) | Nil
  ...
  @[::K8S::Properties(
    limits: {key: "limits", accessor: "limits", kind: "::Array(::K8S::Api::Core::V1::LimitRangeItem)", nilable: false, default: nil, read_only: false, description: "Limits is the list of LimitRangeItem objects that are enforced."},
  )]
  class Api::Core::V1::LimitRangeSpec < ::K8S::Types::Api::Core::V1::LimitRangeSpec::Instance
