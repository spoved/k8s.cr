...
module K8S
  ...
  @[::K8S::Properties(
    ...
    protocol: {key: "protocol", accessor: "protocol", kind: "String", nilable: true, default: nil, read_only: false, description: "The IP protocol for this port. Supports \"TCP\" and \"UDP\". Default is TCP."},
