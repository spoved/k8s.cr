...
module K8S
  ...
  class Api::Core::V1::ServicePort < ::K8S::GenericObject
    ...
    k8s_object_accessor("name", name : String, true, false, "The name of this port within the service. This must be a DNS_LABEL. All ports within a ServiceSpec must have unique names. This maps to the 'Name' field in EndpointPort objects. Optional if only one ServicePort is defined on this service.")
    ...
    k8s_object_accessor("protocol", protocol : String, true, false, "The IP protocol for this port. Supports \"TCP\" and \"UDP\". Default is TCP.")
    ...
    def initialize(*, name : String? = nil, node_port : Int32? = nil, port : Int32? = nil, protocol : String? = nil, target_port : ::Int32 | ::String? = nil)
      super()
      self.["name"] = name
