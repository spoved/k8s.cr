...
module K8S
  ...
  @[::K8S::Properties(
    ...
    protocol: {key: "protocol", accessor: "protocol", kind: "String", nilable: true, default: nil, read_only: false, description: "The IP protocol for this port. Must be UDP or TCP. Default is TCP.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Core::V1::EndpointPort < ::K8S::GenericObject
    include ::K8S::Types::Api::Core::V1::EndpointPort
    k8s_object_accessor("name", name : String, true, false, "The name of this port (corresponds to ServicePort.Name). Must be a DNS_LABEL. Optional only if one port is defined.")
    k8s_object_accessor("port", port : Int32, false, false, "The port number of the endpoint.")
    k8s_object_accessor("protocol", protocol : String, true, false, "The IP protocol for this port. Must be UDP or TCP. Default is TCP.")
