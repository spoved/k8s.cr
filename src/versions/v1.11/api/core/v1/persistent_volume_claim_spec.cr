...
module K8S
  ...
  class Api::Core::V1::PersistentVolumeClaimSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("volumeMode", volume_mode : String, true, false, "volumeMode defines what type of volume is required by the claim. Value of Filesystem is implied when not included in claim spec. This is an alpha feature and may change in the future.")
    ...
    def initialize(*, access_modes : ::Array(String)? = nil, resources : ::K8S::Api::Core::V1::ResourceRequirements? = nil, selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector? = nil, storage_class_name : String? = nil, volume_mode : String? = nil, volume_name : String? = nil)
      super()
