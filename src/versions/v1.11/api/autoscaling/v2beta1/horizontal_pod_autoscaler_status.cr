...
module K8S
  ...
  class Api::Autoscaling::V2beta1::HorizontalPodAutoscalerStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("currentMetrics", current_metrics : ::Array(::K8S::Api::Autoscaling::V2beta1::MetricStatus), false, false, "currentMetrics is the last read state of the metrics used by this autoscaler.")
