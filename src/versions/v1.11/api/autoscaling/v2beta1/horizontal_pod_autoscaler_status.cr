...
::K8S::Kubernetes::Resource.define_object("HorizontalPodAutoscalerStatus",
  ...
  properties: [
    ...
    {name: "current_metrics", kind: ::Array(::K8S::Api::Autoscaling::V2beta1::MetricStatus), key: "currentMetrics", nilable: false, read_only: false, description: "currentMetrics is the last read state of the metrics used by this autoscaler."},
