...
::K8S::Kubernetes::Resource.define_object("WebhookClientConfig",
  ...
  properties: [
    ...
    {name: "ca_bundle", kind: String, key: "caBundle", nilable: false, read_only: false, description: "`caBundle` is a PEM encoded CA bundle which will be used to validate the webhook's server certificate. Required."},
