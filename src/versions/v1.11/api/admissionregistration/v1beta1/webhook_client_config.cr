...
module K8S
  ...
  class Api::Admissionregistration::V1beta1::WebhookClientConfig < ::K8S::GenericObject
    ...
    k8s_object_accessor("caBundle", ca_bundle : String, false, false, "`caBundle` is a PEM encoded CA bundle which will be used to validate the webhook's server certificate. Required.")
