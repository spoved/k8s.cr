...
module K8S
  ...
  class Api::Admissionregistration::V1beta1::MutatingWebhookConfiguration < ::K8S::Kubernetes::Resource::Object
    ...
    def initialize(*, api_version : String? = "admissionregistration/v1beta1", kind : String? = "MutatingWebhookConfiguration", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, webhooks : ::Array(::K8S::Api::Admissionregistration::V1beta1::Webhook)? = nil)
      super()
