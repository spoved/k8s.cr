...
module K8S
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceValidation < ::K8S::GenericObject
    ...
    k8s_object_accessor("openAPIV3Schema", open_apiv3_schema : ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::JsonSchemaProps, true, false, "OpenAPIV3Schema is the OpenAPI v3 schema to be validated against.")

    def initialize(*, open_apiv3_schema : ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::JsonSchemaProps? = nil)
      super()
