...
module K8S
  ...
  class ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinition < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("spec", spec : ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionSpec, true, false, "Spec describes how the user wants the resources to appear")
