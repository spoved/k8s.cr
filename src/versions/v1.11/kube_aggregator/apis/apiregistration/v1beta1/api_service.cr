...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "apiregistration.k8s.io", kind: "APIService", version: "v1beta1")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/apiregistration.k8s.io/v1beta1/apiservices/{name}/status", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
