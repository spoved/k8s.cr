...
module K8S
  ...
  class Apimachinery::Apis::Meta::V1::APIResource < ::K8S::GenericObject
    ...
    def initialize(*, categories : ::Array(String)? = nil, group : String? = nil, kind : String? = nil, name : String? = nil, namespaced : ::Bool? = nil, short_names : ::Array(String)? = nil, singular_name : String? = nil, verbs : ::Array(String)? = nil, version : String? = nil)
      super()
