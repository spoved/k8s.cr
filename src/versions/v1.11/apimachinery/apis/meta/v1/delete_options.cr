...
module K8S
  ...
  module Types::Apimachinery::Apis::Meta::V1::DeleteOptions
    alias ValueType = String | Int32 | ::Bool | ::K8S::Apimachinery::Apis::Meta::V1::Preconditions | Nil
  ...
  @[::K8S::GroupVersionKind(group: "admissionregistration.k8s.io", kind: "DeleteOptions", version: "v1alpha1", full: "io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions")]
