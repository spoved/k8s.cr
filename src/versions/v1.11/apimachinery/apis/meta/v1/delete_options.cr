...
module K8S
  ...
  class Apimachinery::Apis::Meta::V1::DeleteOptions < ::K8S::GenericObject
    ...
    def initialize(*, api_version : String? = nil, grace_period_seconds : Int32? = nil, kind : String? = nil, orphan_dependents : ::Bool? = nil, preconditions : ::K8S::Apimachinery::Apis::Meta::V1::Preconditions? = nil, propagation_policy : String? = nil)
      super()
