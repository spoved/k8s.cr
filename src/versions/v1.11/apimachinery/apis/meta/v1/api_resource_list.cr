...
module K8S
  ...
  module Types::Apimachinery::Apis::Meta::V1::APIResourceList
    alias ValueType = String | ::Array(::K8S::Apimachinery::Apis::Meta::V1::APIResource) | Nil
  ...
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "APIResourceList", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))"},
    group_version: {key: "groupVersion", accessor: "group_version", kind: "String", nilable: false, default: nil, read_only: false, description: "groupVersion is the group and version this APIResourceList is for."},
    resources: {key: "resources", accessor: "resources", kind: "::Array(::K8S::Apimachinery::Apis::Meta::V1::APIResource)", nilable: false, default: nil, read_only: false, description: "resources contains the name of the resources and if they are namespaced."},
  )]
  class Apimachinery::Apis::Meta::V1::APIResourceList < ::K8S::Types::Apimachinery::Apis::Meta::V1::APIResourceList::Instance
