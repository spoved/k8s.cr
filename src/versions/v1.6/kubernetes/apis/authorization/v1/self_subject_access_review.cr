...
module K8S
  ...
  class Kubernetes::Apis::Authorization::V1::SelfSubjectAccessReview < ::K8S::Kubernetes::Resource
  ...
  module Resources::Authorization::V1
    alias SelfSubjectAccessReview = ::K8S::Kubernetes::Apis::Authorization::V1::SelfSubjectAccessReview
  end
end
