module ::K8S::Kubernetes
  ...
  abstract class Resource
    ...
    MAPPINGS = [
      ...
      {"discovery/v1alpha1", "EndpointSlice", K8S::Api::Discovery::V1alpha1::EndpointSlice},
      {"discovery/v1alpha1", "EndpointSliceList", K8S::Api::Discovery::V1alpha1::EndpointSliceList},
