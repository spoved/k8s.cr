...
module K8S
  ...
  class Api::Apps::V1beta2::StatefulSetList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1beta2::StatefulSet)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Apps::V1beta2::StatefulSet), false, false, nil)

    def initialize(*, api_version : String? = "apps/v1beta2", kind : String? = "StatefulSetList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Apps::V1beta2::StatefulSet)? = nil)
      super()
