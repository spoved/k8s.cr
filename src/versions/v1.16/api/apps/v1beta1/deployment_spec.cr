...
module K8S
  ...
  class Api::Apps::V1beta1::DeploymentSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("revisionHistoryLimit", revision_history_limit : Int32, true, false, "The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. Defaults to 2.")
    k8s_object_accessor("rollbackTo", rollback_to : ::K8S::Api::Apps::V1beta1::RollbackConfig, true, false, "DEPRECATED. The config this deployment is rolling back to. Will be cleared after rollback is done.")
    k8s_object_accessor("selector", selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector, true, false, "Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment.")
    k8s_object_accessor("strategy", strategy : ::K8S::Api::Apps::V1beta1::DeploymentStrategy, true, false, "The deployment strategy to use to replace existing pods with new ones.")
    ...
    def initialize(*, min_ready_seconds : Int32? = nil, paused : ::Bool? = nil, progress_deadline_seconds : Int32? = nil, replicas : Int32? = nil, revision_history_limit : Int32? = nil, rollback_to : ::K8S::Api::Apps::V1beta1::RollbackConfig? = nil, selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector? = nil, strategy : ::K8S::Api::Apps::V1beta1::DeploymentStrategy? = nil, template : ::K8S::Api::Core::V1::PodTemplateSpec? = nil)
      super()
