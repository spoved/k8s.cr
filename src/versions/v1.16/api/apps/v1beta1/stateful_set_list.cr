...
module K8S
  ...
  module Types::Api::Apps::V1beta1::StatefulSetList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Apps::V1beta1::StatefulSet) | Nil
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apps::V1beta1::StatefulSet)", nilable: false, default: nil, read_only: false, description: nil},
  )]
  class Api::Apps::V1beta1::StatefulSetList < ::K8S::Types::Api::Apps::V1beta1::StatefulSetList::Instance
    include ::K8S::Types::Api::Apps::V1beta1::StatefulSetList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1beta1::StatefulSet)
    ...
    #
    def items : Array(::K8S::Api::Apps::V1beta1::StatefulSet)
      self.["items"].as(Array(::K8S::Api::Apps::V1beta1::StatefulSet))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Apps::V1beta1::StatefulSet)
      self.["items"].as(Array(::K8S::Api::Apps::V1beta1::StatefulSet)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Apps::V1beta1::StatefulSet))
      self.["items"] = value
    end
