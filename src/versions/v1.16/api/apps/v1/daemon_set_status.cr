...
::K8S::Kubernetes::Resource.define_object("DaemonSetStatus",
  ...
  properties: [
    ...
    {name: "number_ready", kind: Int32, key: "numberReady", nilable: false, read_only: false, description: "The number of nodes that should be running the daemon pod and have one or more of the daemon pod running and ready."},
