...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "role_ref", type: Api::Rbac::V1beta1::RoleRef},
           ...
           {name: "subjects", type: Array(Api::Rbac::V1beta1::Subject) | Nil, default: nil},
  ...
  class Api::Rbac::V1beta1::ClusterRoleBindingList < ::K8S::Kubernetes::ResourceList(Api::Rbac::V1beta1::ClusterRoleBinding)
    ...
    def initialize(*, @items : Array(Api::Rbac::V1beta1::ClusterRoleBinding), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
