...
module K8S
  ...
  module Types::Api::Rbac::V1beta1::ClusterRoleBindingList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Rbac::V1beta1::ClusterRoleBinding) | Nil
  ...
  class Api::Rbac::V1beta1::ClusterRoleBindingList < ::K8S::Types::Api::Rbac::V1beta1::ClusterRoleBindingList::Instance
    include ::K8S::Types::Api::Rbac::V1beta1::ClusterRoleBindingList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Rbac::V1beta1::ClusterRoleBinding)
    ...
    # Items is a list of ClusterRoleBindings
    def items : Array(::K8S::Api::Rbac::V1beta1::ClusterRoleBinding)
      self.["items"].as(Array(::K8S::Api::Rbac::V1beta1::ClusterRoleBinding))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Rbac::V1beta1::ClusterRoleBinding)
      self.["items"].as(Array(::K8S::Api::Rbac::V1beta1::ClusterRoleBinding)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Rbac::V1beta1::ClusterRoleBinding))
      self.["items"] = value
    end
