...
module K8S
  ...
  class Api::Networking::V1::NetworkPolicyList < ::K8S::Kubernetes::ResourceList(Api::Networking::V1::NetworkPolicy)
    ...
    def initialize(*, @items : Array(Api::Networking::V1::NetworkPolicy), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
