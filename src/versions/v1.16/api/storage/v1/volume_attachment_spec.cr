...
module K8S
  ...
  @[::K8S::Properties(
    ...
    source: {key: "source", accessor: "source", kind: "::K8S::Api::Storage::V1::VolumeAttachmentSource", nilable: false, default: nil, read_only: false, description: "Source represents the volume that should be attached.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
