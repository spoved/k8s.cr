...
module K8S
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Storage::V1beta1::CSINodeSpec", nilable: false, default: nil, read_only: false, description: "spec is the specification of CSINode"},
  )]
