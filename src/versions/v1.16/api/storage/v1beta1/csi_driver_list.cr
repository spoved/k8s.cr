...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Storage::V1beta1::CSIDriver)", nilable: false, default: nil, read_only: false, description: "items is the list of CSIDriver"},
  )]
