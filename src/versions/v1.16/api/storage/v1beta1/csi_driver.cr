...
module K8S
  ...
  module Types::Api::Storage::V1beta1::CSIDriver
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::K8S::Api::Storage::V1beta1::CSIDriverSpec | Nil
  ...
  class Api::Storage::V1beta1::CSIDriver < ::K8S::Types::Api::Storage::V1beta1::CSIDriver::Instance
    ...
    # Specification of the CSI Driver.
    def spec : ::K8S::Api::Storage::V1beta1::CSIDriverSpec
      self.["spec"].as(::K8S::Api::Storage::V1beta1::CSIDriverSpec)
    end

    # :ditto:
    def spec! : ::K8S::Api::Storage::V1beta1::CSIDriverSpec
      self.["spec"].as(::K8S::Api::Storage::V1beta1::CSIDriverSpec).not_nil!
    end
    ...
    # :ditto:
    def spec=(value : ::K8S::Api::Storage::V1beta1::CSIDriverSpec)
      self.["spec"] = value
    end
