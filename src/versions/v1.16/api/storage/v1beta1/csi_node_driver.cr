...
module K8S
  ...
  @[::K8S::Properties(
    allocatable: {key: "allocatable", accessor: "allocatable", kind: "::K8S::Api::Storage::V1beta1::VolumeNodeResources", nilable: true, default: nil, read_only: false, description: "allocatable represents the volume resources of a node that are available for scheduling.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Storage::V1beta1::CSINodeDriver < ::K8S::GenericObject
    ...
    k8s_object_accessor("allocatable", allocatable : ::K8S::Api::Storage::V1beta1::VolumeNodeResources, true, false, "allocatable represents the volume resources of a node that are available for scheduling.")
    ...
    def initialize(*, allocatable : ::K8S::Api::Storage::V1beta1::VolumeNodeResources? = nil, name : String? = nil, node_id : String? = nil, topology_keys : ::Array(String)? = nil)
      super()
