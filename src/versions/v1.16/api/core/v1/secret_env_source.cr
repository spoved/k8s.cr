...
::K8S::Kubernetes::Resource.define_object("SecretEnvSource",
  ...
  properties: [
    ...
    {name: "optional", kind: ::Bool, key: "optional", nilable: true, read_only: false, description: "Specify whether the Secret must be defined"},
