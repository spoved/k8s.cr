...
module K8S
  ...
  @[::K8S::Properties(
    ...
    sub_path_expr: {key: "subPathExpr", accessor: "sub_path_expr", kind: "String", nilable: true, default: nil, read_only: false, description: "Expanded path within the volume from which the container's volume should be mounted. Behaves similarly to SubPath but environment variable references $(VAR_NAME) are expanded using the container's environment. Defaults to \"\" (volume's root). SubPathExpr and SubPath are mutually exclusive. This field is beta in 1.15.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Core::V1::VolumeMount < ::K8S::GenericObject
    ...
    k8s_object_accessor("subPathExpr", sub_path_expr : String, true, false, "Expanded path within the volume from which the container's volume should be mounted. Behaves similarly to SubPath but environment variable references $(VAR_NAME) are expanded using the container's environment. Defaults to \"\" (volume's root). SubPathExpr and SubPath are mutually exclusive. This field is beta in 1.15.")

    def initialize(*, mount_path : String? = nil, mount_propagation : String? = nil, name : String? = nil, read_only : ::Bool? = nil, sub_path : String? = nil, sub_path_expr : String? = nil)
      super()
