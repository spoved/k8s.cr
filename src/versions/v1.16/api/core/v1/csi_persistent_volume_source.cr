...
module K8S
  ...
  @[::K8S::Properties(
    ...
    driver: {key: "driver", accessor: "driver", kind: "String", nilable: false, default: nil, read_only: false, description: "Driver is the name of the driver to use for this volume. Required."},
    fs_type: {key: "fsType", accessor: "fs_type", kind: "String", nilable: true, default: nil, read_only: false, description: "Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\"."},
    ...
    read_only: {key: "readOnly", accessor: "read_only", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "Optional: The value to pass to ControllerPublishVolumeRequest. Defaults to false [(read/write).]((read/write).)"},
    volume_attributes: {key: "volumeAttributes", accessor: "volume_attributes", kind: "::Hash(String, String)", nilable: true, default: nil, read_only: false, description: "Attributes of the volume to publish."},
    volume_handle: {key: "volumeHandle", accessor: "volume_handle", kind: "String", nilable: false, default: nil, read_only: false, description: "VolumeHandle is the unique volume name returned by the CSI volume plugin’s CreateVolume to refer to the volume on all subsequent calls. Required."},
  )]
  class Api::Core::V1::CSIPersistentVolumeSource < ::K8S::Types::Api::Core::V1::CSIPersistentVolumeSource::Instance
    ...
    # ControllerExpandSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI ControllerExpandVolume call. This is an alpha field and requires enabling ExpandCSIVolumes feature gate. This field is optional, and may be empty if no secret is required. If the secret object contains more than one secret, all secrets are passed.
    def controller_expand_secret_ref : ::K8S::Api::Core::V1::SecretReference?
      self.["controllerExpandSecretRef"].as(::K8S::Api::Core::V1::SecretReference?)
    end

    # :ditto:
    def controller_expand_secret_ref! : ::K8S::Api::Core::V1::SecretReference
      self.["controllerExpandSecretRef"].as(::K8S::Api::Core::V1::SecretReference?).not_nil!
    end
    ...
    # :ditto:
    def controller_expand_secret_ref=(value : ::K8S::Api::Core::V1::SecretReference?)
      self.["controllerExpandSecretRef"] = value
    end
