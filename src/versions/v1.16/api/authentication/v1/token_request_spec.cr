...
module K8S
  ...
  class Api::Authentication::V1::TokenRequestSpec < ::K8S::GenericObject
    include ::K8S::Types::Api::Authentication::V1::TokenRequestSpec
    k8s_object_accessor("audiences", audiences : ::Array(String), false, false, "Audiences are the intendend audiences of the token. A recipient of a token must identitfy themself with an identifier in the list of audiences of the token, and otherwise should reject the token. A token issued for multiple audiences may be used to authenticate against any of the audiences listed but implies a high degree of trust between the target audiences.")
    k8s_object_accessor("boundObjectRef", bound_object_ref : ::K8S::Api::Authentication::V1::BoundObjectReference, true, false, "BoundObjectRef is a reference to an object that the token will be bound to. The token will only be valid for as long as the bound object exists. NOTE: The API server's TokenReview endpoint will validate the BoundObjectRef, but other audiences may not. Keep ExpirationSeconds small if you want prompt revocation.")
    k8s_object_accessor("expirationSeconds", expiration_seconds : Int32, true, false, "ExpirationSeconds is the requested duration of validity of the request. The token issuer may return a token with a different validity duration so a client needs to check the 'expiration' field in a response.")

    def initialize(*, audiences : ::Array(String)? = nil, bound_object_ref : ::K8S::Api::Authentication::V1::BoundObjectReference? = nil, expiration_seconds : Int32? = nil)
      super()
