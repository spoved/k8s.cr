...
module K8S
  ...
  @[::K8S::Properties(
    ...
    address_type: {key: "addressType", accessor: "address_type", kind: "String", nilable: true, default: nil, read_only: false, description: "addressType specifies the type of address carried by this EndpointSlice. All addresses in this slice must be the same type. Default is IP", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    endpoints: {key: "endpoints", accessor: "endpoints", kind: "::Array(::K8S::Api::Discovery::V1alpha1::Endpoint)", nilable: true, default: nil, read_only: false, description: "endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: "atomic", x_kubernetes_map_type: nil},
  ...
  class Api::Discovery::V1alpha1::EndpointSlice < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("addressType", address_type : String, true, false, "addressType specifies the type of address carried by this EndpointSlice. All addresses in this slice must be the same type. Default is IP")
    k8s_object_accessor("endpoints", endpoints : ::Array(::K8S::Api::Discovery::V1alpha1::Endpoint), true, false, "endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints.")
    k8s_object_accessor("ports", ports : ::Array(::K8S::Api::Discovery::V1alpha1::EndpointPort), true, false, "ports specifies the list of network ports exposed by each endpoint in this slice. Each port must have a unique name. When ports is empty, it indicates that there are no defined ports. When a port is defined with a nil port value, it indicates \"all ports\". Each slice may include a maximum of 100 ports.")

    def initialize(*, api_version : String? = "discovery/v1alpha1", kind : String? = "EndpointSlice", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, address_type : String? = nil, endpoints : ::Array(::K8S::Api::Discovery::V1alpha1::Endpoint)? = nil, ports : ::Array(::K8S::Api::Discovery::V1alpha1::EndpointPort)? = nil)
      super()
