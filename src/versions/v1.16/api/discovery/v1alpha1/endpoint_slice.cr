...
module K8S
  ...
  @[::K8S::Properties(
    ...
    endpoints: {type: Array(Api::Discovery::V1alpha1::Endpoint), nilable: true, key: "endpoints", getter: false, setter: false},
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/discovery.k8s.io/v1alpha1/namespaces/{namespace}/endpointslices/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil},
           {name: "field_manager", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Discovery::V1alpha1::EndpointSlice < ::K8S::Kubernetes::Resource
    ...
    @[::JSON::Field(key: "addressType", emit_null: false)]
    @[::YAML::Field(key: "addressType", emit_null: false)]
    ...
    property endpoints : Array(Api::Discovery::V1alpha1::Endpoint) | Nil
    ...
    def initialize(*, @address_type : String | Nil = nil, @endpoints : Array(Api::Discovery::V1alpha1::Endpoint) | Nil = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @ports : Array(Api::Discovery::V1alpha1::EndpointPort) | Nil = nil)
    end
  end
