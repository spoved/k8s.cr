...
module K8S::Types::Api::Discovery::V1alpha1::Endpoint; end

require "./endpoint_conditions"
require "../../core/v1/object_reference"

module K8S
  # Namespace holding the types for `Api::Discovery::V1alpha1::Endpoint`.
  module Types::Api::Discovery::V1alpha1::Endpoint
    alias ValueType = ::Set(String) | ::K8S::Api::Discovery::V1alpha1::EndpointConditions | String | ::K8S::Api::Core::V1::ObjectReference | ::Hash(String, String) | Nil
    ...
    abstract def conditions : ::K8S::Api::Discovery::V1alpha1::EndpointConditions?
    # :ditto:
    abstract def conditions! : ::K8S::Api::Discovery::V1alpha1::EndpointConditions
    # :ditto:
    abstract def conditions? : ::K8S::Api::Discovery::V1alpha1::EndpointConditions?
    # :ditto:
    abstract def conditions=(value : ::K8S::Api::Discovery::V1alpha1::EndpointConditions?)
  ...
  @[::K8S::Properties(
    ...
    conditions: {key: "conditions", accessor: "conditions", kind: "::K8S::Api::Discovery::V1alpha1::EndpointConditions", nilable: true, default: nil, read_only: false, description: "conditions contains information about the current status of the endpoint.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Discovery::V1alpha1::Endpoint < ::K8S::Types::Api::Discovery::V1alpha1::Endpoint::Instance
    ...
    # conditions contains information about the current status of the endpoint.
    def conditions : ::K8S::Api::Discovery::V1alpha1::EndpointConditions?
      self.["conditions"].as(::K8S::Api::Discovery::V1alpha1::EndpointConditions?)
    end

    # :ditto:
    def conditions! : ::K8S::Api::Discovery::V1alpha1::EndpointConditions
      self.["conditions"].as(::K8S::Api::Discovery::V1alpha1::EndpointConditions?).not_nil!
    end
    ...
    # :ditto:
    def conditions=(value : ::K8S::Api::Discovery::V1alpha1::EndpointConditions?)
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        ...
        { key: "conditions", accessor: "conditions", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Discovery::V1alpha1::EndpointConditions },
