...
module K8S
  ...
  class Api::Discovery::V1alpha1::Endpoint
    ...
    def initialize(*, @addresses : Array(String), @conditions : Api::Discovery::V1alpha1::EndpointConditions | Nil = nil, @hostname : String | Nil = nil, @target_ref : Api::Core::V1::ObjectReference | Nil = nil, @topology : Hash(String, String) | Nil = nil)
    end
  end
end
