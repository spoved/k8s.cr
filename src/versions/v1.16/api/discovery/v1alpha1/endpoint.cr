...
::K8S::Kubernetes::Resource.define_object("Endpoint",
  ...
  properties: [
    ...
    {name: "conditions", kind: ::K8S::Api::Discovery::V1alpha1::EndpointConditions, key: "conditions", nilable: true, read_only: false, description: "conditions contains information about the current status of the endpoint."},
