...
module K8S
  ...
  class Api::Discovery::V1alpha1::Endpoint < ::K8S::GenericObject
    ...
    k8s_object_accessor("conditions", conditions : ::K8S::Api::Discovery::V1alpha1::EndpointConditions, true, false, "conditions contains information about the current status of the endpoint.")
    ...
    def initialize(*, addresses : ::Set(String)? = nil, conditions : ::K8S::Api::Discovery::V1alpha1::EndpointConditions? = nil, hostname : String? = nil, target_ref : ::K8S::Api::Core::V1::ObjectReference? = nil, topology : ::Hash(String, String)? = nil)
      super()
