...
module K8S
  ...
  module Types::Api::Discovery::V1alpha1::Endpoint
    alias ValueType = ::Array(String) | ::K8S::Api::Discovery::V1alpha1::EndpointConditions | String | ::K8S::Api::Core::V1::ObjectReference | ::Hash(String, String) | Nil
  ...
  @[::K8S::Properties(
    ...
    conditions: {key: "conditions", accessor: "conditions", kind: "::K8S::Api::Discovery::V1alpha1::EndpointConditions", nilable: true, default: nil, read_only: false, description: "conditions contains information about the current status of the endpoint."},
