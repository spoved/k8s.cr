...
module K8S
  ...
  module Types::Api::Autoscaling::V1::HorizontalPodAutoscalerList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler) | Nil
  ...
  class Api::Autoscaling::V1::HorizontalPodAutoscalerList < ::K8S::Types::Api::Autoscaling::V1::HorizontalPodAutoscalerList::Instance
    include ::K8S::Types::Api::Autoscaling::V1::HorizontalPodAutoscalerList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)
    ...
    # list of horizontal pod autoscaler objects.
    def items : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)
      self.["items"].as(Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)
      self.["items"].as(Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler))
      self.["items"] = value
    end
