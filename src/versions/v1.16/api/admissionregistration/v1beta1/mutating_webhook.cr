...
module K8S::Types::Api::Admissionregistration::V1beta1::MutatingWebhook; end
...
module K8S
  # Namespace holding the types for `Api::Admissionregistration::V1beta1::MutatingWebhook`.
  module Types::Api::Admissionregistration::V1beta1::MutatingWebhook
  ...
  class Api::Admissionregistration::V1beta1::MutatingWebhook < ::K8S::Types::Api::Admissionregistration::V1beta1::MutatingWebhook::Instance
