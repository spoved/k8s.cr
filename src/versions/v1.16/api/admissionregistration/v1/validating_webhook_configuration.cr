...
module K8S
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil},
           {name: "field_manager", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Admissionregistration::V1::ValidatingWebhookConfiguration < ::K8S::Kubernetes::Resource
    ...
    def initialize(*, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @webhooks : Array(Api::Admissionregistration::V1::ValidatingWebhook) | Nil = nil)
    end
  end
