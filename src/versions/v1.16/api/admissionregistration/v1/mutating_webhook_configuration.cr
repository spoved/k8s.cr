...
module K8S::Types::Api::Admissionregistration::V1::MutatingWebhookConfiguration; end

require "../../../apimachinery/apis/meta/v1/object_meta"
require "./mutating_webhook"

module K8S
  # Namespace holding the types for `Api::Admissionregistration::V1::MutatingWebhookConfiguration`.
  module Types::Api::Admissionregistration::V1::MutatingWebhookConfiguration
    ...
    abstract def webhooks : ::Array(::K8S::Api::Admissionregistration::V1::MutatingWebhook)?
    # :ditto:
    abstract def webhooks! : ::Array(::K8S::Api::Admissionregistration::V1::MutatingWebhook)
    # :ditto:
    abstract def webhooks? : ::Array(::K8S::Api::Admissionregistration::V1::MutatingWebhook)?
    # :ditto:
    abstract def webhooks=(value : ::Array(::K8S::Api::Admissionregistration::V1::MutatingWebhook))
  end

  # MutatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and may change the object.
  @[::K8S::GroupVersionKind(group: "admissionregistration.k8s.io", kind: "MutatingWebhookConfiguration", version: "v1", full: "io.k8s.api.admissionregistration.v1.MutatingWebhookConfiguration")]
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "MutatingWebhookConfiguration", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Admissionregistration::V1::MutatingWebhookConfiguration < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("webhooks", webhooks : ::Array(::K8S::Api::Admissionregistration::V1::MutatingWebhook), true, false, "Webhooks is a list of webhooks and the affected resources and operations.")

    def initialize(*, api_version : String? = "admissionregistration/v1", kind : String? = "MutatingWebhookConfiguration", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, webhooks : ::Array(::K8S::Api::Admissionregistration::V1::MutatingWebhook)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "kind", accessor: "kind", nilable: false, read_only: true, default: "MutatingWebhookConfiguration", kind: String},
      {key: "metadata", accessor: "metadata", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta},
      {key: "webhooks", accessor: "webhooks", nilable: true, read_only: false, default: nil, kind: ::Array(::K8S::Api::Admissionregistration::V1::MutatingWebhook)},
    ])
  end
