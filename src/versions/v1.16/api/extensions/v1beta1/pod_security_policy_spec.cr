...
module K8S
  ...
  @[::K8S::Properties(
    ...
    allowed_host_paths: {key: "allowedHostPaths", accessor: "allowed_host_paths", kind: "::Array(::K8S::Api::Extensions::V1beta1::AllowedHostPath)", nilable: true, default: nil, read_only: false, description: "allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used."},
    ...
    fs_group: {key: "fsGroup", accessor: "fs_group", kind: "::K8S::Api::Extensions::V1beta1::FSGroupStrategyOptions", nilable: false, default: nil, read_only: false, description: "fsGroup is the strategy that will dictate what fs group is used by the SecurityContext."},
    ...
    host_ports: {key: "hostPorts", accessor: "host_ports", kind: "::Array(::K8S::Api::Extensions::V1beta1::HostPortRange)", nilable: true, default: nil, read_only: false, description: "hostPorts determines which host port ranges are allowed to be exposed."},
    ...
    run_as_group: {key: "runAsGroup", accessor: "run_as_group", kind: "::K8S::Api::Extensions::V1beta1::RunAsGroupStrategyOptions", nilable: true, default: nil, read_only: false, description: "RunAsGroup is the strategy that will dictate the allowable RunAsGroup values that may be set. If this field is omitted, the pod's RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled."},
    run_as_user: {key: "runAsUser", accessor: "run_as_user", kind: "::K8S::Api::Extensions::V1beta1::RunAsUserStrategyOptions", nilable: false, default: nil, read_only: false, description: "runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set."},
    runtime_class: {key: "runtimeClass", accessor: "runtime_class", kind: "::K8S::Api::Extensions::V1beta1::RuntimeClassStrategyOptions", nilable: true, default: nil, read_only: false, description: "runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled."},
    se_linux: {key: "seLinux", accessor: "se_linux", kind: "::K8S::Api::Extensions::V1beta1::SELinuxStrategyOptions", nilable: false, default: nil, read_only: false, description: "seLinux is the strategy that will dictate the allowable labels that may be set."},
    supplemental_groups: {key: "supplementalGroups", accessor: "supplemental_groups", kind: "::K8S::Api::Extensions::V1beta1::SupplementalGroupsStrategyOptions", nilable: false, default: nil, read_only: false, description: "supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext."},
