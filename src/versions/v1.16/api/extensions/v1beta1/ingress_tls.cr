...
module K8S
  ...
  class Api::Extensions::V1beta1::IngressTLS < ::K8S::GenericObject
    ...
    k8s_object_accessor("secretName", secret_name : String, true, false, "SecretName is the name of the secret used to terminate SSL traffic on 443. Field is left optional to allow SSL routing based on SNI hostname alone. If the SNI host in a listener conflicts with the \"Host\" header field used by an IngressRule, the SNI host is used for termination and value of the Host header is used for routing.")
