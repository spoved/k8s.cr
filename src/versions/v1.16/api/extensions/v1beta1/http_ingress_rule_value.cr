...
module K8S
  ...
  class Api::Extensions::V1beta1::HTTPIngressRuleValue < ::K8S::GenericObject
    ...
    k8s_object_accessor("paths", paths : ::Array(::K8S::Api::Extensions::V1beta1::HTTPIngressPath), false, false, "A collection of paths that map requests to backends.")

    def initialize(*, paths : ::Array(::K8S::Api::Extensions::V1beta1::HTTPIngressPath)? = nil)
      super()
      self.["paths"] = paths
    end
