...
::K8S::Kubernetes::Resource.define_resource("node.k8s.io", "v1beta1", "RuntimeClass",
  ...
  versions: [{group: "node.k8s.io", kind: "RuntimeClass", version: "v1beta1"}],
)
