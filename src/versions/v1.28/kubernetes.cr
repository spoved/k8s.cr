module ::K8S::Kubernetes
  VERSION       = SemanticVersion.parse("1.28.0")
  VERSION_MINOR =  1
  VERSION_MAJOR = 28
  ...
  abstract struct Resource
    MAPPINGS = [
      ...
      {"admissionregistration/v1alpha1", "ValidatingAdmissionPolicy", K8S::Api::Admissionregistration::V1alpha1::ValidatingAdmissionPolicy},
      {"admissionregistration/v1alpha1", "ValidatingAdmissionPolicyBinding", K8S::Api::Admissionregistration::V1alpha1::ValidatingAdmissionPolicyBinding},
      {"admissionregistration/v1alpha1", "ValidatingAdmissionPolicyBindingList", K8S::Api::Admissionregistration::V1alpha1::ValidatingAdmissionPolicyBindingList},
      {"admissionregistration/v1alpha1", "ValidatingAdmissionPolicyList", K8S::Api::Admissionregistration::V1alpha1::ValidatingAdmissionPolicyList},
      {"admissionregistration/v1beta1", "ValidatingAdmissionPolicy", K8S::Api::Admissionregistration::V1beta1::ValidatingAdmissionPolicy},
      {"admissionregistration/v1beta1", "ValidatingAdmissionPolicyBinding", K8S::Api::Admissionregistration::V1beta1::ValidatingAdmissionPolicyBinding},
      {"admissionregistration/v1beta1", "ValidatingAdmissionPolicyBindingList", K8S::Api::Admissionregistration::V1beta1::ValidatingAdmissionPolicyBindingList},
      {"admissionregistration/v1beta1", "ValidatingAdmissionPolicyList", K8S::Api::Admissionregistration::V1beta1::ValidatingAdmissionPolicyList},
      ...
      {"authentication/v1", "SelfSubjectReview", K8S::Api::Authentication::V1::SelfSubjectReview},
      ...
      {"authentication/v1alpha1", "SelfSubjectReview", K8S::Api::Authentication::V1alpha1::SelfSubjectReview},
      {"authentication/v1beta1", "SelfSubjectReview", K8S::Api::Authentication::V1beta1::SelfSubjectReview},
      ...
      {"autoscaling/v2", "HorizontalPodAutoscaler", K8S::Api::Autoscaling::V2::HorizontalPodAutoscaler},
      {"autoscaling/v2", "HorizontalPodAutoscalerList", K8S::Api::Autoscaling::V2::HorizontalPodAutoscalerList},
      ...
      {"certificates/v1alpha1", "ClusterTrustBundle", K8S::Api::Certificates::V1alpha1::ClusterTrustBundle},
      {"certificates/v1alpha1", "ClusterTrustBundleList", K8S::Api::Certificates::V1alpha1::ClusterTrustBundleList},
      ...
      {"flowcontrol/v1beta2", "FlowSchema", K8S::Api::Flowcontrol::V1beta2::FlowSchema},
      {"flowcontrol/v1beta2", "FlowSchemaList", K8S::Api::Flowcontrol::V1beta2::FlowSchemaList},
      {"flowcontrol/v1beta2", "PriorityLevelConfiguration", K8S::Api::Flowcontrol::V1beta2::PriorityLevelConfiguration},
      {"flowcontrol/v1beta2", "PriorityLevelConfigurationList", K8S::Api::Flowcontrol::V1beta2::PriorityLevelConfigurationList},
      {"flowcontrol/v1beta3", "FlowSchema", K8S::Api::Flowcontrol::V1beta3::FlowSchema},
      {"flowcontrol/v1beta3", "FlowSchemaList", K8S::Api::Flowcontrol::V1beta3::FlowSchemaList},
      {"flowcontrol/v1beta3", "PriorityLevelConfiguration", K8S::Api::Flowcontrol::V1beta3::PriorityLevelConfiguration},
      {"flowcontrol/v1beta3", "PriorityLevelConfigurationList", K8S::Api::Flowcontrol::V1beta3::PriorityLevelConfigurationList},
      ...
      {"networking/v1alpha1", "ClusterCIDR", K8S::Api::Networking::V1alpha1::ClusterCIDR},
      {"networking/v1alpha1", "ClusterCIDRList", K8S::Api::Networking::V1alpha1::ClusterCIDRList},
      {"networking/v1alpha1", "IPAddress", K8S::Api::Networking::V1alpha1::IPAddress},
      {"networking/v1alpha1", "IPAddressList", K8S::Api::Networking::V1alpha1::IPAddressList},
      ...
      {"resource/v1alpha2", "PodSchedulingContext", K8S::Api::Resource::V1alpha2::PodSchedulingContext},
      {"resource/v1alpha2", "PodSchedulingContextList", K8S::Api::Resource::V1alpha2::PodSchedulingContextList},
      {"resource/v1alpha2", "ResourceClaim", K8S::Api::Resource::V1alpha2::ResourceClaim},
      {"resource/v1alpha2", "ResourceClaimList", K8S::Api::Resource::V1alpha2::ResourceClaimList},
      {"resource/v1alpha2", "ResourceClaimTemplate", K8S::Api::Resource::V1alpha2::ResourceClaimTemplate},
      {"resource/v1alpha2", "ResourceClaimTemplateList", K8S::Api::Resource::V1alpha2::ResourceClaimTemplateList},
      {"resource/v1alpha2", "ResourceClass", K8S::Api::Resource::V1alpha2::ResourceClass},
      {"resource/v1alpha2", "ResourceClassList", K8S::Api::Resource::V1alpha2::ResourceClassList},
      ...
      {"storage/v1", "CSIStorageCapacity", K8S::Api::Storage::V1::CSIStorageCapacity},
      {"storage/v1", "CSIStorageCapacityList", K8S::Api::Storage::V1::CSIStorageCapacityList},
