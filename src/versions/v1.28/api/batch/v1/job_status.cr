...
::K8S::Kubernetes::Resource.define_object("JobStatus",
  ...
  properties: [
    ...
    {name: "terminating", kind: Int32, key: "terminating", nilable: true, read_only: false, description: "The number of pods which are terminating (in phase Pending or Running and have a deletionTimestamp).\n\nThis field is alpha-level. The job controller populates the field when the feature gate JobPodReplacementPolicy is enabled (disabled by default)."},
