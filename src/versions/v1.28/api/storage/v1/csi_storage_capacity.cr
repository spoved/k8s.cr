...
::K8S::Kubernetes::Resource.define_resource("storage.k8s.io", "v1", "CSIStorageCapacity",
  ...
  properties: [
    ...
    {name: "storage_class_name", kind: String, key: "storageClassName", nilable: false, read_only: false, description: "storageClassName represents the name of the StorageClass that the reported capacity applies to. It must meet the same requirements as the name of a StorageClass object (non-empty, DNS subdomain). If that object no longer exists, the CSIStorageCapacity object is obsolete and should be removed by its creator. This field is immutable."},
  ...
  versions: [{group: "storage.k8s.io", kind: "CSIStorageCapacity", version: "v1"}],
)
