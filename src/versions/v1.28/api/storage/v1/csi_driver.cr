...
::K8S::Kubernetes::Resource.define_resource("storage.k8s.io", "v1", "CSIDriver",
  ...
  properties: [
    ...
    {name: "spec", kind: ::K8S::Api::Storage::V1::CSIDriverSpec, key: "spec", nilable: false, read_only: false, description: "spec represents the specification of the CSI Driver."},
