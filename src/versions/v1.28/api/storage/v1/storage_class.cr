...
::K8S::Kubernetes::Resource.define_resource("storage.k8s.io", "v1", "StorageClass",
  ...
  properties: [
    ...
    {name: "allowed_topologies", kind: ::Array(::K8S::Api::Core::V1::TopologySelectorTerm), key: "allowedTopologies", nilable: true, read_only: false, description: "allowedTopologies restrict the node topologies where volumes can be dynamically provisioned. Each volume plugin defines its own supported topology specifications. An empty TopologySelectorTerm list means there is no topology restriction. This field is only honored by servers that enable the VolumeScheduling feature."},
    {name: "mount_options", kind: ::Array(String), key: "mountOptions", nilable: true, read_only: false, description: "mountOptions controls the mountOptions for dynamically provisioned PersistentVolumes of this storage class. e.g. [\"ro\", \"soft\"]. Not validated - mount of the PVs will simply fail if one is invalid."},
    ...
    {name: "reclaim_policy", kind: String, key: "reclaimPolicy", nilable: true, read_only: false, description: "reclaimPolicy controls the reclaimPolicy for dynamically provisioned PersistentVolumes of this storage class. Defaults to Delete."},
