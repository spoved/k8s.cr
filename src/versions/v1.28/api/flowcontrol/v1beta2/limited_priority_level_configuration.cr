...
::K8S::Kubernetes::Resource.define_object("LimitedPriorityLevelConfiguration",
  ...
  properties: [
    ...
    {name: "limit_response", kind: ::K8S::Api::Flowcontrol::V1beta2::LimitResponse, key: "limitResponse", nilable: true, read_only: false, description: "`limitResponse` indicates what to do with requests that can not be executed right now"},
