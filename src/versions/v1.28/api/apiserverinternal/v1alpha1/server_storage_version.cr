...
::K8S::Kubernetes::Resource.define_object("ServerStorageVersion",
  ...
  properties: [
    ...
    {name: "served_versions", kind: ::Set(String), key: "servedVersions", nilable: true, read_only: false, description: "The API server can serve these versions. DecodableVersions must include all ServedVersions."},
