...
::K8S::Kubernetes::Resource.define_object("ISCSIVolumeSource",
  ...
  properties: [
    ...
    {name: "iqn", kind: String, key: "iqn", nilable: false, read_only: false, description: "iqn is the target iSCSI Qualified Name."},
    ...
    {name: "lun", kind: Int32, key: "lun", nilable: false, read_only: false, description: "lun represents iSCSI Target Lun number."},
    ...
    {name: "secret_ref", kind: ::K8S::Api::Core::V1::LocalObjectReference, key: "secretRef", nilable: true, read_only: false, description: "secretRef is the CHAP Secret for iSCSI target and initiator authentication"},
