...
::K8S::Kubernetes::Resource.define_object("ResourceClaimStatus",
  ...
  properties: [
    ...
    {name: "allocation", kind: ::K8S::Api::Resource::V1alpha2::AllocationResult, key: "allocation", nilable: true, read_only: false, description: "Allocation is set by the resource driver once a resource or set of resources has been allocated successfully. If this is not specified, the resources have not been allocated yet."},
    ...
    {name: "reserved_for", kind: ::Array(::K8S::Api::Resource::V1alpha2::ResourceClaimConsumerReference), key: "reservedFor", nilable: true, read_only: false, description: "ReservedFor indicates which entities are currently allowed to use the claim. A Pod which references a ResourceClaim which is not reserved for that Pod will not be started.\n\nThere can be at most 32 such reservations. This may get increased in the future, but not reduced."},
