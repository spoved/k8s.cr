...
::K8S::Kubernetes::Resource.define_resource("autoscaling", "v1", "HorizontalPodAutoscaler",
  ...
  properties: [
    ...
    {name: "status", kind: ::K8S::Api::Autoscaling::V1::HorizontalPodAutoscalerStatus, key: "status", nilable: true, read_only: false, description: "status is the current information about the autoscaler."},
