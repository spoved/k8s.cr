...
::K8S::Kubernetes::Resource.define_object("HorizontalPodAutoscalerSpec",
  ...
  properties: [
    ...
    {name: "max_replicas", kind: Int32, key: "maxReplicas", nilable: false, read_only: false, description: "maxReplicas is the upper limit for the number of pods that can be set by the autoscaler; cannot be smaller than MinReplicas."},
