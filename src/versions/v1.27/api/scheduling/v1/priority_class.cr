...
::K8S::Kubernetes::Resource.define_resource("scheduling.k8s.io", "v1", "PriorityClass",
  ...
  properties: [
    ...
    {name: "preemption_policy", kind: String, key: "preemptionPolicy", nilable: true, read_only: false, description: "preemptionPolicy is the Policy for preempting pods with lower priority. One of Never, PreemptLowerPriority. Defaults to PreemptLowerPriority if unset."},
    {name: "value", kind: Int32, key: "value", nilable: false, read_only: false, description: "value represents the integer value of this priority class. This is the actual priority that pods receive when they have the name of this class in their pod spec."},
