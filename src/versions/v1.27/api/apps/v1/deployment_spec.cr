...
::K8S::Kubernetes::Resource.define_object("DeploymentSpec",
  ...
  properties: [
    ...
    {name: "template", kind: ::K8S::Api::Core::V1::PodTemplateSpec, key: "template", nilable: false, read_only: false, description: "Template describes the pods that will be created. The only allowed template.spec.restartPolicy value is \"Always\"."},
