...
::K8S::Kubernetes::Resource.define_object("PolicyRule",
  ...
  properties: [
    ...
    {name: "api_groups", kind: ::Array(String), key: "apiGroups", nilable: true, read_only: false, description: "APIGroups is the name of the APIGroup that contains the resources.  If multiple API groups are specified, any action requested against one of the enumerated resources in any API group will be allowed. \"\" represents the core API group and \"*\" represents all API groups."},
