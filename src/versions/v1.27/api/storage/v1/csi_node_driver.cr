...
::K8S::Kubernetes::Resource.define_object("CSINodeDriver",
  ...
  properties: [
    ...
    {name: "allocatable", kind: ::K8S::Api::Storage::V1::VolumeNodeResources, key: "allocatable", nilable: true, read_only: false, description: "allocatable represents the volume resources of a node that are available for scheduling. This field is beta."},
    {name: "name", kind: String, key: "name", nilable: false, read_only: false, description: "name represents the name of the CSI driver that this object refers to. This MUST be the same name returned by the CSI GetPluginName() call for that driver."},
