...
require "./container_resize_policy"
...
::K8S::Kubernetes::Resource.define_object("EphemeralContainer",
  ...
  properties: [
    ...
    {name: "image", kind: String, key: "image", nilable: true, read_only: false, description: "Container image name. More info: [https://kubernetes.io/docs/concepts/containers/images](https://kubernetes.io/docs/concepts/containers/images)"},
    ...
    {name: "resize_policy", kind: ::Array(::K8S::Api::Core::V1::ContainerResizePolicy), key: "resizePolicy", nilable: true, read_only: false, description: "Resources resize policy for the container."},
    ...
    {name: "target_container_name", kind: String, key: "targetContainerName", nilable: true, read_only: false, description: "If set, the name of the container from PodSpec that this ephemeral container targets. The ephemeral container will be run in the namespaces (IPC, PID, etc) of this container. If not set then the ephemeral container uses the namespaces configured in the Pod spec.\n\nThe container runtime must implement support for this feature. If the runtime does not support namespace targeting then the result of setting this field is undefined."},
    ...
    {name: "volume_mounts", kind: ::Array(::K8S::Api::Core::V1::VolumeMount), key: "volumeMounts", nilable: true, read_only: false, description: "Pod volumes to mount into the container's filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated."},
