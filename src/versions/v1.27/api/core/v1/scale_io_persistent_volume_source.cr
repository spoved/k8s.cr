...
::K8S::Kubernetes::Resource.define_object("ScaleIOPersistentVolumeSource",
  ...
  properties: [
    ...
    {name: "ssl_enabled", kind: ::Bool, key: "sslEnabled", nilable: true, read_only: false, description: "sslEnabled is the flag to [enable/disable SSL communication with Gateway, default false](enable/disable SSL communication with Gateway, default false)"},
