...
::K8S::Kubernetes::Resource.define_object("PodStatus",
  ...
  properties: [
    ...
    {name: "container_statuses", kind: ::Array(::K8S::Api::Core::V1::ContainerStatus), key: "containerStatuses", nilable: true, read_only: false, description: "The list has one entry per container in the manifest. More info: [https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status](https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status)"},
    {name: "ephemeral_container_statuses", kind: ::Array(::K8S::Api::Core::V1::ContainerStatus), key: "ephemeralContainerStatuses", nilable: true, read_only: false, description: "Status for any ephemeral containers that have run in this pod."},
    ...
    {name: "qos_class", kind: String, key: "qosClass", nilable: true, read_only: false, description: "The Quality of Service (QOS) classification assigned to the pod based on resource requirements See PodQOSClass type for available QOS classes More info: [https://kubernetes.io/docs/concepts/workloads/pods/pod-qos/#quality-of-service-classes](https://kubernetes.io/docs/concepts/workloads/pods/pod-qos/#quality-of-service-classes)"},
    ...
    {name: "resize", kind: String, key: "resize", nilable: true, read_only: false, description: "Status of resources resize desired for pod's containers. It is empty if no resources resize is pending. Any changes to container resources will automatically set this to \"Proposed\""},
