...
::K8S::Kubernetes::Resource.define_resource("", "v1", "Status",
  ...
  versions: [{group: "", kind: "Status", version: "v1"}, {group: "resource.k8s.io", kind: "Status", version: "v1alpha2"}],
)
alias K8S::Resource::V1alpha2::Status = ::K8S::Apimachinery::Apis::Meta::V1::Status
