...
::K8S::Kubernetes::Resource.define_object("StatusDetails",
  ...
  properties: [
    ...
    {name: "uid", kind: String, key: "uid", nilable: true, read_only: false, description: "UID of the resource. (when there is a single resource which can be described). More info: [https://kubernetes.io/docs/concepts/overview/working-with-objects/names#uids](https://kubernetes.io/docs/concepts/overview/working-with-objects/names#uids)"},
