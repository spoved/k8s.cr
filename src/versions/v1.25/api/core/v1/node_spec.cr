...
::K8S::Kubernetes::Resource.define_object("NodeSpec",
  ...
  properties: [
    ...
    {name: "config_source", kind: ::K8S::Api::Core::V1::NodeConfigSource, key: "configSource", nilable: true, read_only: false, description: "Deprecated: Previously used to specify the source of the node's configuration for the DynamicKubeletConfig feature. This feature is removed from Kubelets as of 1.24 and will be fully removed in 1.26."},
