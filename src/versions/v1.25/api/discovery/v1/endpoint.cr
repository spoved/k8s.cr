...
::K8S::Kubernetes::Resource.define_object("Endpoint",
  ...
  properties: [
    ...
    {name: "node_name", kind: String, key: "nodeName", nilable: true, read_only: false, description: "nodeName represents the name of the Node hosting this endpoint. This can be used to determine endpoints local to a Node."},
