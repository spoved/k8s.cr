...
module K8S
  ...
  class Api::Rbac::V1::ClusterRoleList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Rbac::V1::ClusterRole)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Rbac::V1::ClusterRole), false, false, "Items is a list of ClusterRoles")

    def initialize(*, api_version : String? = "rbac.authorization.k8s.io/v1", kind : String? = "ClusterRoleList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Rbac::V1::ClusterRole)? = nil)
      super()
