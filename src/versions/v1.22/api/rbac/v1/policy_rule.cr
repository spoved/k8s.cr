...
::K8S::Kubernetes::Resource.define_object("PolicyRule",
  ...
  properties: [
    ...
    {name: "verbs", kind: ::Array(String), key: "verbs", nilable: false, read_only: false, description: "Verbs is a list of Verbs that apply to ALL the ResourceKinds and AttributeRestrictions contained in this rule. '*' represents all verbs."},
