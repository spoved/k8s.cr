...
module K8S
  ...
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "StorageVersion", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))"},
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Apiserverinternal::V1alpha1::StorageVersionSpec", nilable: false, default: nil, read_only: false, description: "Spec is an empty spec. It is here to comply with Kubernetes API style."},
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Apiserverinternal::V1alpha1::StorageVersionStatus", nilable: false, default: nil, read_only: false, description: "API server instances report the version they can decode and the version they encode objects to when persisting objects in the backend."},
  )]
