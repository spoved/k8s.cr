...
::K8S::Kubernetes::Resource.define_object("StorageVersionCondition",
  ...
  properties: [
    ...
    {name: "observed_generation", kind: Int32, key: "observedGeneration", nilable: true, read_only: false, description: "If set, this represents the .metadata.generation that the condition was set based upon."},
    {name: "reason", kind: String, key: "reason", nilable: false, read_only: false, description: "The reason for the condition's last transition."},
    ...
    {name: "type", kind: String, key: "type", nilable: false, read_only: false, description: "Type of the condition."},
