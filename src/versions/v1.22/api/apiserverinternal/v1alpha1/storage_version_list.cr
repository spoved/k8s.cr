...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apiserverinternal::V1alpha1::StorageVersion)", nilable: false, default: nil, read_only: false, description: "Items holds a list of StorageVersion"},
  )]
