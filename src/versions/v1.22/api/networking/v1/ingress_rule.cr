...
module K8S
  ...
  class Api::Networking::V1::IngressRule < ::K8S::GenericObject
    ...
    k8s_object_accessor("http", http : ::K8S::Api::Networking::V1::HTTPIngressRuleValue, true, false, nil)

    def initialize(*, host : String? = nil, http : ::K8S::Api::Networking::V1::HTTPIngressRuleValue? = nil)
      super()
      self.["host"] = host
      self.["http"] = http
    end
