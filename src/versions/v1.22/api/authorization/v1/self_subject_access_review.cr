...
module K8S::Types::Api::Authorization::V1::SelfSubjectAccessReview; end
...
module K8S
  ...
  module Types::Api::Authorization::V1::SelfSubjectAccessReview
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::K8S::Api::Authorization::V1::SelfSubjectAccessReviewSpec | ::K8S::Api::Authorization::V1::SubjectAccessReviewStatus | Nil
    ...
    abstract def spec? : ::K8S::Api::Authorization::V1::SelfSubjectAccessReviewSpec?
    # :ditto:
    abstract def spec=(value : ::K8S::Api::Authorization::V1::SelfSubjectAccessReviewSpec)
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Authorization::V1::SelfSubjectAccessReviewSpec", nilable: false, default: nil, read_only: false, description: "Spec holds information about the request being evaluated.  user and groups must be empty", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Authorization::V1::SelfSubjectAccessReview < ::K8S::Types::Api::Authorization::V1::SelfSubjectAccessReview::Instance
