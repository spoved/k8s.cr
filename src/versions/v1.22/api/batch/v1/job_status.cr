...
module K8S
  ...
  class Api::Batch::V1::JobStatus < ::K8S::GenericObject
    ...
    def initialize(*, active : Int32? = nil, completed_indexes : String? = nil, completion_time : ::Time? = nil, conditions : ::Array(::K8S::Api::Batch::V1::JobCondition)? = nil, failed : Int32? = nil, start_time : ::Time? = nil, succeeded : Int32? = nil, uncounted_terminated_pods : ::K8S::Api::Batch::V1::UncountedTerminatedPods? = nil)
      super()
      self.["active"] = active
