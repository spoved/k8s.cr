...
module K8S
  ...
  @[::K8S::Properties(
    ...
    hints: {key: "hints", accessor: "hints", kind: "::K8S::Api::Discovery::V1beta1::EndpointHints", nilable: true, default: nil, read_only: false, description: "hints contains information associated with how an endpoint should be consumed.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Discovery::V1beta1::Endpoint < ::K8S::GenericObject
    ...
    k8s_object_accessor("hints", hints : ::K8S::Api::Discovery::V1beta1::EndpointHints, true, false, "hints contains information associated with how an endpoint should be consumed.")
    ...
    def initialize(*, addresses : ::Set(String)? = nil, conditions : ::K8S::Api::Discovery::V1beta1::EndpointConditions? = nil, hints : ::K8S::Api::Discovery::V1beta1::EndpointHints? = nil, hostname : String? = nil, node_name : String? = nil, target_ref : ::K8S::Api::Core::V1::ObjectReference? = nil, topology : ::Hash(String, String)? = nil)
      super()
