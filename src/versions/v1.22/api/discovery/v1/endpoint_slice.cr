...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "discovery.k8s.io", kind: "EndpointSlice", version: "v1")]
  ...
  class Api::Discovery::V1::EndpointSlice < ::K8S::Kubernetes::Resource
    ...
    ::YAML.mapping({
      ...
      endpoints:    {type: Array(Api::Discovery::V1::Endpoint), nilable: false, key: "endpoints", getter: false, setter: false},
