...
module K8S
  ...
  @[::K8S::Properties(
    ...
    lifecycle: {key: "lifecycle", accessor: "lifecycle", kind: "::K8S::Api::Core::V1::Lifecycle", nilable: true, default: nil, read_only: false, description: "Actions that the management system should take in response to container lifecycle events. Cannot be updated."},
    liveness_probe: {key: "livenessProbe", accessor: "liveness_probe", kind: "::K8S::Api::Core::V1::Probe", nilable: true, default: nil, read_only: false, description: "Periodic probe of container liveness. Container will be restarted if the probe fails. Cannot be updated. More info: [https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes](https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes)"},
    name: {key: "name", accessor: "name", kind: "String", nilable: false, default: nil, read_only: false, description: "Name of the container specified as a DNS_LABEL. Each container in a pod must have a unique name (DNS_LABEL). Cannot be updated."},
    ...
    readiness_probe: {key: "readinessProbe", accessor: "readiness_probe", kind: "::K8S::Api::Core::V1::Probe", nilable: true, default: nil, read_only: false, description: "Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: [https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes](https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes)"},
