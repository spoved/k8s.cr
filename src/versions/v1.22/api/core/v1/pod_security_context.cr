...
::K8S::Kubernetes::Resource.define_object("PodSecurityContext",
  ...
  properties: [
    ...
    {name: "fs_group_change_policy", kind: String, key: "fsGroupChangePolicy", nilable: true, read_only: false, description: "fsGroupChangePolicy defines behavior of changing ownership and permission of the volume before being exposed inside Pod. This field will only apply to volume types which support fsGroup based ownership(and permissions). It will have no effect on ephemeral volume types such as: secret, configmaps and emptydir. Valid values are \"OnRootMismatch\" and \"Always\". If not specified, \"Always\" is used."},
    ...
    {name: "seccomp_profile", kind: ::K8S::Api::Core::V1::SeccompProfile, key: "seccompProfile", nilable: true, read_only: false, description: "The seccomp options to use by the containers in this pod."},
