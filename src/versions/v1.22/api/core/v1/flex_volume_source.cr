...
module K8S
  ...
  module Types::Api::Core::V1::FlexVolumeSource
    alias ValueType = String | ::Hash(String, String) | ::Bool | ::K8S::Api::Core::V1::LocalObjectReference | Nil
  ...
  class Api::Core::V1::FlexVolumeSource < ::K8S::Types::Api::Core::V1::FlexVolumeSource::Instance
