...
module K8S
  ...
  class Api::Core::V1::FlexVolumeSource < ::K8S::GenericObject
    ...
    def initialize(*, driver : String? = nil, fs_type : String? = nil, options : ::Hash(String, String)? = nil, read_only : ::Bool? = nil, secret_ref : ::K8S::Api::Core::V1::LocalObjectReference? = nil)
      super()
      self.["driver"] = driver
      self.["fsType"] = fs_type
