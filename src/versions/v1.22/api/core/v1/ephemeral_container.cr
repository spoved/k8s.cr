...
module K8S
  ...
  class Api::Core::V1::EphemeralContainer
    ...
    @[::JSON::Field(key: "targetContainerName", emit_null: false)]
    @[::YAML::Field(key: "targetContainerName", emit_null: false)]
