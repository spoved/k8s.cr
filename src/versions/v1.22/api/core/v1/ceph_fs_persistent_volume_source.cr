...
module K8S
  ...
  class Api::Core::V1::CephFSPersistentVolumeSource < ::K8S::GenericObject
    include ::K8S::Types::Api::Core::V1::CephFSPersistentVolumeSource
    k8s_object_accessor("monitors", monitors : ::Array(String), false, false, "Required: Monitors is a collection of Ceph monitors More info: [https://examples.k8s.io/volumes/cephfs/README.md#how-to-use-it](https://examples.k8s.io/volumes/cephfs/README.md#how-to-use-it)")
    ...
    k8s_object_accessor("user", user : String, true, false, "Optional: User is the rados user name, default is admin More info: [https://examples.k8s.io/volumes/cephfs/README.md#how-to-use-it](https://examples.k8s.io/volumes/cephfs/README.md#how-to-use-it)")

    def initialize(*, monitors : ::Array(String)? = nil, path : String? = nil, read_only : ::Bool? = nil, secret_file : String? = nil, secret_ref : ::K8S::Api::Core::V1::SecretReference? = nil, user : String? = nil)
      super()
