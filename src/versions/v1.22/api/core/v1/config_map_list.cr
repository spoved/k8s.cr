...
module K8S
  ...
  class Api::Core::V1::ConfigMapList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Core::V1::ConfigMap)
    ...
    k8s_object_accessor("kind", kind : String = "ConfigMapList", false, true, "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))")
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Core::V1::ConfigMap), false, false, "Items is the list of ConfigMaps.")

    def initialize(*, api_version : String? = "v1", kind : String? = "ConfigMapList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Core::V1::ConfigMap)? = nil)
      super()
