...
module K8S
  ...
  module Types::Api::Core::V1::PodTemplate
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::K8S::Api::Core::V1::PodTemplateSpec | Nil
  ...
  class Api::Core::V1::PodTemplate < ::K8S::Types::Api::Core::V1::PodTemplate::Instance
