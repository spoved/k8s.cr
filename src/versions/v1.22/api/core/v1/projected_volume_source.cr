...
module K8S
  ...
  @[::K8S::Properties(
    ...
    sources: {key: "sources", accessor: "sources", kind: "::Array(::K8S::Api::Core::V1::VolumeProjection)", nilable: true, default: nil, read_only: false, description: "list of volume projections"},
  )]
