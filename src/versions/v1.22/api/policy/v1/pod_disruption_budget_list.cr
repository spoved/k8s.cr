...
module K8S
  ...
  module Types::Api::Policy::V1::PodDisruptionBudgetList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Policy::V1::PodDisruptionBudget) | Nil
  ...
  class Api::Policy::V1::PodDisruptionBudgetList < ::K8S::Types::Api::Policy::V1::PodDisruptionBudgetList::Instance
    include ::K8S::Types::Api::Policy::V1::PodDisruptionBudgetList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Policy::V1::PodDisruptionBudget)
    ...
    # Items is a list of PodDisruptionBudgets
    def items : Array(::K8S::Api::Policy::V1::PodDisruptionBudget)
      self.["items"].as(Array(::K8S::Api::Policy::V1::PodDisruptionBudget))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Policy::V1::PodDisruptionBudget)
      self.["items"].as(Array(::K8S::Api::Policy::V1::PodDisruptionBudget)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Policy::V1::PodDisruptionBudget))
      self.["items"] = value
    end
