...
module K8S
  ...
  class Api::Policy::V1beta1::PodSecurityPolicyList < ::K8S::Kubernetes::ResourceList(Api::Policy::V1beta1::PodSecurityPolicy)
    ...
    def initialize(*, @items : Array(Api::Policy::V1beta1::PodSecurityPolicy), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
