...
module K8S
  ...
  @[::K8S::Properties(
    ranges: {key: "ranges", accessor: "ranges", kind: "::Array(::K8S::Api::Policy::V1beta1::IDRange)", nilable: true, default: nil, read_only: false, description: "ranges are the allowed ranges of uids that may be used. If you would like to force a single uid then supply a single range with the same start and end. Required for MustRunAs."},
  ...
  class Api::Policy::V1beta1::RunAsUserStrategyOptions < ::K8S::Types::Api::Policy::V1beta1::RunAsUserStrategyOptions::Instance
