...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Policy::V1beta1::PodDisruptionBudget)", nilable: false, default: nil, read_only: false, description: "items list individual PodDisruptionBudget objects", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Policy::V1beta1::PodDisruptionBudgetList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Policy::V1beta1::PodDisruptionBudget)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Policy::V1beta1::PodDisruptionBudget), false, false, "items list individual PodDisruptionBudget objects")

    def initialize(*, api_version : String? = "policy/v1beta1", kind : String? = "PodDisruptionBudgetList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Policy::V1beta1::PodDisruptionBudget)? = nil)
      super()
