...
module K8S
  ...
  @[::K8S::Properties(
    ...
    capacity: {type: Int32 | String, nilable: true, key: "capacity", getter: false, setter: false},
    kind: {type: String, nilable: true, key: "kind", getter: false, setter: false},
    maximum_volume_size: {type: Int32 | String, nilable: true, key: "maximumVolumeSize", getter: false, setter: false},
  ...
  class Api::Storage::V1alpha1::CSIStorageCapacity < ::K8S::Kubernetes::Resource
