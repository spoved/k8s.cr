...
module K8S
  ...
  class Api::Apps::V1::DaemonSetStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("numberReady", number_ready : Int32, false, false, "The number of nodes that should be running the daemon pod and have one or more of the daemon pod running and ready.")
