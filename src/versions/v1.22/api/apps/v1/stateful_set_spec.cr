...
module K8S
  ...
  class Api::Apps::V1::StatefulSetSpec < ::K8S::GenericObject
    ...
    def initialize(*, min_ready_seconds : Int32? = nil, pod_management_policy : String? = nil, replicas : Int32? = nil, revision_history_limit : Int32? = nil, selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector? = nil, service_name : String? = nil, template : ::K8S::Api::Core::V1::PodTemplateSpec? = nil, update_strategy : ::K8S::Api::Apps::V1::StatefulSetUpdateStrategy? = nil, volume_claim_templates : ::Array(::K8S::Api::Core::V1::PersistentVolumeClaim)? = nil)
      super()
