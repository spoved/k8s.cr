...
module K8S
  ...
  class Api::Apps::V1::StatefulSetStatus
    ...
    def initialize(*, @replicas : Int32, @available_replicas : Int32 | Nil = nil, @collision_count : Int32 | Nil = nil, @conditions : Array(Api::Apps::V1::StatefulSetCondition) | Nil = nil, @current_replicas : Int32 | Nil = nil, @current_revision : String | Nil = nil, @observed_generation : Int32 | Nil = nil, @ready_replicas : Int32 | Nil = nil, @update_revision : String | Nil = nil, @updated_replicas : Int32 | Nil = nil)
    end
  end
end
