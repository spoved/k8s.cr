...
::K8S::Kubernetes::Resource.define_object("StatefulSetStatus",
  ...
  properties: [
    ...
    {name: "ready_replicas", kind: Int32, key: "readyReplicas", nilable: true, read_only: false, description: "readyReplicas is the number of Pods created by the StatefulSet controller that have a Ready Condition."},
