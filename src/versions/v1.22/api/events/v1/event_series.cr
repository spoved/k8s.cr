...
module K8S
  ...
  class Api::Events::V1::EventSeries < ::K8S::GenericObject
    include ::K8S::Types::Api::Events::V1::EventSeries
    k8s_object_accessor("count", count : Int32, false, false, "count is the number of occurrences in this series up to the last heartbeat time.")
    k8s_object_accessor("lastObservedTime", last_observed_time : ::Time, false, false, "lastObservedTime is the time when last Event from the series was seen before last heartbeat.")
