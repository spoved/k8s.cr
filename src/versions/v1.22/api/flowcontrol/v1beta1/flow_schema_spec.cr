...
module K8S
  ...
  module Types::Api::Flowcontrol::V1beta1::FlowSchemaSpec
    alias ValueType = ::K8S::Api::Flowcontrol::V1beta1::FlowDistinguisherMethod | Int32 | ::K8S::Api::Flowcontrol::V1beta1::PriorityLevelConfigurationReference | ::Array(::K8S::Api::Flowcontrol::V1beta1::PolicyRulesWithSubjects) | Nil
  ...
  @[::K8S::Properties(
    distinguisher_method: {key: "distinguisherMethod", accessor: "distinguisher_method", kind: "::K8S::Api::Flowcontrol::V1beta1::FlowDistinguisherMethod", nilable: true, default: nil, read_only: false, description: "`distinguisherMethod` defines how to compute the flow distinguisher for requests that match this schema. `nil` specifies that the distinguisher is disabled and thus will always be the empty string."},
  ...
  class Api::Flowcontrol::V1beta1::FlowSchemaSpec < ::K8S::Types::Api::Flowcontrol::V1beta1::FlowSchemaSpec::Instance
    include ::K8S::Types::Api::Flowcontrol::V1beta1::FlowSchemaSpec
    include ::K8S::Kubernetes::Object

    # `distinguisherMethod` defines how to compute the flow distinguisher for requests that match this schema. `nil` specifies that the distinguisher is disabled and thus will always be the empty string.
    def distinguisher_method : ::K8S::Api::Flowcontrol::V1beta1::FlowDistinguisherMethod?
      self.["distinguisherMethod"].as(::K8S::Api::Flowcontrol::V1beta1::FlowDistinguisherMethod?)
    end

    # :ditto:
    def distinguisher_method! : ::K8S::Api::Flowcontrol::V1beta1::FlowDistinguisherMethod
      self.["distinguisherMethod"].as(::K8S::Api::Flowcontrol::V1beta1::FlowDistinguisherMethod?).not_nil!
    end
    ...
    # :ditto:
    def distinguisher_method=(value : ::K8S::Api::Flowcontrol::V1beta1::FlowDistinguisherMethod?)
    ...
    # `priorityLevelConfiguration` should reference a PriorityLevelConfiguration in the cluster. If the reference cannot be resolved, the FlowSchema will be ignored and marked as invalid in its status. Required.
    def priority_level_configuration : ::K8S::Api::Flowcontrol::V1beta1::PriorityLevelConfigurationReference
      self.["priorityLevelConfiguration"].as(::K8S::Api::Flowcontrol::V1beta1::PriorityLevelConfigurationReference)
    end

    # :ditto:
    def priority_level_configuration! : ::K8S::Api::Flowcontrol::V1beta1::PriorityLevelConfigurationReference
      self.["priorityLevelConfiguration"].as(::K8S::Api::Flowcontrol::V1beta1::PriorityLevelConfigurationReference).not_nil!
    end
    ...
    # :ditto:
    def priority_level_configuration=(value : ::K8S::Api::Flowcontrol::V1beta1::PriorityLevelConfigurationReference)
      self.["priorityLevelConfiguration"] = value
    end

    # `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
    def rules : ::Array(::K8S::Api::Flowcontrol::V1beta1::PolicyRulesWithSubjects)?
      self.["rules"].as(::Array(::K8S::Api::Flowcontrol::V1beta1::PolicyRulesWithSubjects)?)
    end

    # :ditto:
    def rules! : ::Array(::K8S::Api::Flowcontrol::V1beta1::PolicyRulesWithSubjects)
      self.["rules"].as(::Array(::K8S::Api::Flowcontrol::V1beta1::PolicyRulesWithSubjects)?).not_nil!
    end
    ...
    # :ditto:
    def rules=(value : ::Array(::K8S::Api::Flowcontrol::V1beta1::PolicyRulesWithSubjects)?)
      self.["rules"] = value
    end
