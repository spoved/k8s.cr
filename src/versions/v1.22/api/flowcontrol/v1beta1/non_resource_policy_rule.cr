...
module K8S
  ...
  class Api::Flowcontrol::V1beta1::NonResourcePolicyRule < ::K8S::GenericObject
    include ::K8S::Types::Api::Flowcontrol::V1beta1::NonResourcePolicyRule
    k8s_object_accessor("nonResourceURLs", non_resource_urls : ::Set(String), false, false, "`nonResourceURLs` is a set of url prefixes that a user should have access to and may not be empty. For example:\n  - [\"/healthz\" is legal](\"/healthz\" is legal)\n  - [\"/hea*\" is illegal](\"/hea*\" is illegal)\n  - [\"/hea\" is legal but matches nothing](\"/hea\" is legal but matches nothing)\n  - [\"/hea/*\" also matches nothing](\"/hea/*\" also matches nothing)\n  - [\"/healthz/*\" matches all per-component health checks.](\"/healthz/*\" matches all per-component health checks.)\n\"*\" matches all non-resource urls. if it is present, it must be the only entry. Required.")
    k8s_object_accessor("verbs", verbs : ::Set(String), false, false, "`verbs` is a list of matching verbs and may not be empty. \"*\" matches all verbs. If it is present, it must be the only entry. Required.")

    def initialize(*, non_resource_urls : ::Set(String)? = nil, verbs : ::Set(String)? = nil)
      super()
