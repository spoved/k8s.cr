...
module K8S::Types::Api::Flowcontrol::V1beta1::QueuingConfiguration; end

module K8S
  # Namespace holding the types for `Api::Flowcontrol::V1beta1::QueuingConfiguration`.
  module Types::Api::Flowcontrol::V1beta1::QueuingConfiguration
  ...
  class Api::Flowcontrol::V1beta1::QueuingConfiguration < ::K8S::GenericObject
    include ::K8S::Types::Api::Flowcontrol::V1beta1::QueuingConfiguration
    k8s_object_accessor("handSize", hand_size : Int32, true, false, "`handSize` is a small positive number that configures the shuffle sharding of requests into queues.  When enqueuing a request at this priority level the request's flow identifier (a string pair) is hashed and the hash value is used to shuffle the list of queues and deal a hand of the size specified here.  The request is put into one of the shortest queues in that hand. `handSize` must be no larger than `queues`, and should be significantly smaller (so that a few heavy flows do not saturate most of the queues).  See the user-facing documentation for more extensive guidance on setting this field.  This field has a default value of 8.")
    k8s_object_accessor("queueLengthLimit", queue_length_limit : Int32, true, false, "`queueLengthLimit` is the maximum number of requests allowed to be waiting in a given queue of this priority level at a time; excess requests are rejected.  This value must be positive.  If not specified, it will be defaulted to 50.")
    k8s_object_accessor("queues", queues : Int32, true, false, "`queues` is the number of queues for this priority level. The queues exist independently at each apiserver. The value must be positive.  Setting it to 1 effectively precludes shufflesharding and thus makes the distinguisher method of associated flow schemas irrelevant.  This field has a default value of 64.")

    def initialize(*, hand_size : Int32? = nil, queue_length_limit : Int32? = nil, queues : Int32? = nil)
      super()
      self.["handSize"] = hand_size
      self.["queueLengthLimit"] = queue_length_limit
      self.["queues"] = queues
    end
