...
module K8S::Types::Api::Autoscaling::V1::HorizontalPodAutoscalerList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./horizontal_pod_autoscaler"

module K8S
  # Namespace holding the types for `Api::Autoscaling::V1::HorizontalPodAutoscalerList`.
  module Types::Api::Autoscaling::V1::HorizontalPodAutoscalerList
    ...
    abstract def items : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler))
  end
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)", nilable: false, default: nil, read_only: false, description: "list of horizontal pod autoscaler objects.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Autoscaling::V1::HorizontalPodAutoscalerList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)
    include ::K8S::Types::Api::Autoscaling::V1::HorizontalPodAutoscalerList
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler), false, false, "list of horizontal pod autoscaler objects.")

    def initialize(*, api_version : String? = "autoscaling/v1", kind : String? = "HorizontalPodAutoscalerList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Autoscaling::V1::HorizontalPodAutoscaler)},
    ])
  end
end
