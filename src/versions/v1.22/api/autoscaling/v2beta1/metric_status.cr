...
module K8S
  ...
  module Types::Api::Autoscaling::V2beta1::MetricStatus
    alias ValueType = ::K8S::Api::Autoscaling::V2beta1::ContainerResourceMetricStatus | ::K8S::Api::Autoscaling::V2beta1::ExternalMetricStatus | ::K8S::Api::Autoscaling::V2beta1::ObjectMetricStatus | ::K8S::Api::Autoscaling::V2beta1::PodsMetricStatus | ::K8S::Api::Autoscaling::V2beta1::ResourceMetricStatus | String | Nil
  ...
  @[::K8S::Properties(
    container_resource: {key: "containerResource", accessor: "container_resource", kind: "::K8S::Api::Autoscaling::V2beta1::ContainerResourceMetricStatus", nilable: true, default: nil, read_only: false, description: "container resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source."},
    ...
    object: {key: "object", accessor: "object", kind: "::K8S::Api::Autoscaling::V2beta1::ObjectMetricStatus", nilable: true, default: nil, read_only: false, description: "object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object)."},
    ...
    resource: {key: "resource", accessor: "resource", kind: "::K8S::Api::Autoscaling::V2beta1::ResourceMetricStatus", nilable: true, default: nil, read_only: false, description: "resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source."},
  ...
  class Api::Autoscaling::V2beta1::MetricStatus < ::K8S::Types::Api::Autoscaling::V2beta1::MetricStatus::Instance
    ...
    # container resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source.
    def container_resource : ::K8S::Api::Autoscaling::V2beta1::ContainerResourceMetricStatus?
      self.["containerResource"].as(::K8S::Api::Autoscaling::V2beta1::ContainerResourceMetricStatus?)
    end

    # :ditto:
    def container_resource! : ::K8S::Api::Autoscaling::V2beta1::ContainerResourceMetricStatus
      self.["containerResource"].as(::K8S::Api::Autoscaling::V2beta1::ContainerResourceMetricStatus?).not_nil!
    end
    ...
    # :ditto:
    def container_resource=(value : ::K8S::Api::Autoscaling::V2beta1::ContainerResourceMetricStatus?)
