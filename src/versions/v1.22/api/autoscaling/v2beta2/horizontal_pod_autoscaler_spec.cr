...
module K8S
  ...
  class Api::Autoscaling::V2beta2::HorizontalPodAutoscalerSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("behavior", behavior : ::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior, true, false, "behavior configures the scaling behavior of the target in both Up and Down directions (scaleUp and scaleDown fields respectively). If not set, the default HPAScalingRules for scale up and scale down are used.")
    ...
    k8s_object_accessor("metrics", metrics : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec), true, false, "metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used).  The desired replica count is calculated multiplying the ratio between the target value and the current value by the current number of pods.  Ergo, metrics used must decrease as the pod count is increased, and vice-versa.  See the individual metric source types for more information about how each type of metric must respond. If not set, the default metric will be set to 80% average CPU utilization.")
    ...
    k8s_object_accessor("scaleTargetRef", scale_target_ref : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference, false, false, "scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.")

    def initialize(*, behavior : ::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior? = nil, max_replicas : Int32? = nil, metrics : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)? = nil, min_replicas : Int32? = nil, scale_target_ref : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference? = nil)
      super()
