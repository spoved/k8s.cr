module ::K8S::Kubernetes
  ...
  abstract class Resource
    ...
    MAPPINGS = [
      ...
      {"apiserverinternal/v1alpha1", "StorageVersion", Resources::Apiserverinternal::V1alpha1::StorageVersion},
      ...
      {"batch/v1", "CronJob", Resources::Batch::V1::CronJob},
      {"batch/v1", "Job", Resources::Batch::V1::Job},
      {"batch/v1beta1", "CronJob", Resources::Batch::V1beta1::CronJob},
      {"certificates/v1", "CertificateSigningRequest", Resources::Certificates::V1::CertificateSigningRequest},
      ...
      {"v1", "EphemeralContainers", Resources::V1::EphemeralContainers},
      ...
      {"discovery/v1", "EndpointSlice", Resources::Discovery::V1::EndpointSlice},
      {"discovery/v1beta1", "EndpointSlice", Resources::Discovery::V1beta1::EndpointSlice},
      {"events/v1", "Event", Resources::Events::V1::Event},
      {"events/v1beta1", "Event", Resources::Events::V1beta1::Event},
      {"extensions/v1beta1", "Ingress", Resources::Extensions::V1beta1::Ingress},
      {"flowcontrol/v1beta1", "FlowSchema", Resources::Flowcontrol::V1beta1::FlowSchema},
      {"flowcontrol/v1beta1", "PriorityLevelConfiguration", Resources::Flowcontrol::V1beta1::PriorityLevelConfiguration},
      {"networking/v1", "Ingress", Resources::Networking::V1::Ingress},
      {"networking/v1", "IngressClass", Resources::Networking::V1::IngressClass},
      ...
      {"networking/v1beta1", "IngressClass", Resources::Networking::V1beta1::IngressClass},
      {"node/v1", "RuntimeClass", Resources::Node::V1::RuntimeClass},
      ...
      {"policy/v1", "PodDisruptionBudget", Resources::Policy::V1::PodDisruptionBudget},
      ...
      {"storage/v1", "CSIDriver", Resources::Storage::V1::CSIDriver},
      ...
      {"storage/v1alpha1", "CSIStorageCapacity", Resources::Storage::V1alpha1::CSIStorageCapacity},
      ...
      {"storage/v1beta1", "CSIStorageCapacity", Resources::Storage::V1beta1::CSIStorageCapacity},
