...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "admission.k8s.io", kind: "WatchEvent", version: "v1")]
  @[::K8S::GroupVersionKind(group: "admission.k8s.io", kind: "WatchEvent", version: "v1beta1")]
  @[::K8S::GroupVersionKind(group: "admissionregistration.k8s.io", kind: "WatchEvent", version: "v1")]
  @[::K8S::GroupVersionKind(group: "admissionregistration.k8s.io", kind: "WatchEvent", version: "v1beta1")]
  @[::K8S::GroupVersionKind(group: "apiextensions.k8s.io", kind: "WatchEvent", version: "v1")]
  ...
  @[::K8S::GroupVersionKind(group: "autoscaling", kind: "WatchEvent", version: "v2beta2")]
  ...
  @[::K8S::GroupVersionKind(group: "certificates.k8s.io", kind: "WatchEvent", version: "v1")]
  @[::K8S::GroupVersionKind(group: "certificates.k8s.io", kind: "WatchEvent", version: "v1beta1")]
  @[::K8S::GroupVersionKind(group: "coordination.k8s.io", kind: "WatchEvent", version: "v1")]
  @[::K8S::GroupVersionKind(group: "coordination.k8s.io", kind: "WatchEvent", version: "v1beta1")]
  @[::K8S::GroupVersionKind(group: "discovery.k8s.io", kind: "WatchEvent", version: "v1")]
  @[::K8S::GroupVersionKind(group: "discovery.k8s.io", kind: "WatchEvent", version: "v1beta1")]
  @[::K8S::GroupVersionKind(group: "events.k8s.io", kind: "WatchEvent", version: "v1")]
  ...
  @[::K8S::GroupVersionKind(group: "flowcontrol.apiserver.k8s.io", kind: "WatchEvent", version: "v1alpha1")]
  @[::K8S::GroupVersionKind(group: "flowcontrol.apiserver.k8s.io", kind: "WatchEvent", version: "v1beta1")]
  @[::K8S::GroupVersionKind(group: "imagepolicy.k8s.io", kind: "WatchEvent", version: "v1alpha1")]
  @[::K8S::GroupVersionKind(group: "internal.apiserver.k8s.io", kind: "WatchEvent", version: "v1alpha1")]
  @[::K8S::GroupVersionKind(group: "networking.k8s.io", kind: "WatchEvent", version: "v1")]
  @[::K8S::GroupVersionKind(group: "networking.k8s.io", kind: "WatchEvent", version: "v1beta1")]
  @[::K8S::GroupVersionKind(group: "node.k8s.io", kind: "WatchEvent", version: "v1")]
  @[::K8S::GroupVersionKind(group: "node.k8s.io", kind: "WatchEvent", version: "v1alpha1")]
  @[::K8S::GroupVersionKind(group: "node.k8s.io", kind: "WatchEvent", version: "v1beta1")]
  @[::K8S::GroupVersionKind(group: "policy", kind: "WatchEvent", version: "v1")]
  ...
  @[::K8S::GroupVersionKind(group: "scheduling.k8s.io", kind: "WatchEvent", version: "v1")]
