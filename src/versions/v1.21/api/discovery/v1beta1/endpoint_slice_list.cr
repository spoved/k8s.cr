...
module K8S
  ...
  module Types::Api::Discovery::V1beta1::EndpointSliceList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Discovery::V1beta1::EndpointSlice) | Nil
  ...
  class Api::Discovery::V1beta1::EndpointSliceList < ::K8S::Types::Api::Discovery::V1beta1::EndpointSliceList::Instance
    include ::K8S::Types::Api::Discovery::V1beta1::EndpointSliceList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Discovery::V1beta1::EndpointSlice)
    ...
    # List of endpoint slices
    def items : Array(::K8S::Api::Discovery::V1beta1::EndpointSlice)
      self.["items"].as(Array(::K8S::Api::Discovery::V1beta1::EndpointSlice))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Discovery::V1beta1::EndpointSlice)
      self.["items"].as(Array(::K8S::Api::Discovery::V1beta1::EndpointSlice)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Discovery::V1beta1::EndpointSlice))
      self.["items"] = value
    end
