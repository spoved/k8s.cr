...
module K8S
  ...
  module Types::Api::Discovery::V1beta1::Endpoint
    alias ValueType = ::Set(String) | ::K8S::Api::Discovery::V1beta1::EndpointConditions | ::K8S::Api::Discovery::V1beta1::EndpointHints | String | ::K8S::Api::Core::V1::ObjectReference | ::Hash(String, String) | Nil
