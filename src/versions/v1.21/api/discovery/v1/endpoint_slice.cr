...
module K8S
  ...
  @[::K8S::Properties(
    ...
    endpoints: {key: "endpoints", accessor: "endpoints", kind: "::Array(::K8S::Api::Discovery::V1::Endpoint)", nilable: true, default: nil, read_only: false, description: "endpoints is a list of unique endpoints in this slice. Each slice may include a maximum of 1000 endpoints."},
