...
module K8S
  ...
  @[::K8S::Properties(
    ...
    spec: {type: Api::Batch::V1::CronJobSpec, nilable: true, key: "spec", getter: false, setter: false},
    status: {type: Api::Batch::V1::CronJobStatus, nilable: true, key: "status", getter: false, setter: false},
  )]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil},
           {name: "field_manager", type: String | Nil, default: nil}]
  )]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/batch/v1/namespaces/{namespace}/cronjobs/{name}/status", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil},
           {name: "field_manager", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Batch::V1::CronJob < ::K8S::Kubernetes::Resource
