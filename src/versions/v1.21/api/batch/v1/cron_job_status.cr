...
::K8S::Kubernetes::Resource.define_object("CronJobStatus",
  ...
  properties: [
    ...
    {name: "last_successful_time", kind: ::Time, key: "lastSuccessfulTime", nilable: true, read_only: false, description: "Information when was the last time the job successfully completed."},
