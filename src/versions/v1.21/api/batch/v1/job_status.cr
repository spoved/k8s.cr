...
module K8S
  ...
  class Api::Batch::V1::JobStatus
    ...
    def initialize(*, @active : Int32 | Nil = nil, @completed_indexes : String | Nil = nil, @completion_time : Time | Nil = nil, @conditions : Array(Api::Batch::V1::JobCondition) | Nil = nil, @failed : Int32 | Nil = nil, @start_time : Time | Nil = nil, @succeeded : Int32 | Nil = nil)
    end
  end
end
