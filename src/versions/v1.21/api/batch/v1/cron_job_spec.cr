...
module K8S
  ...
  @[::K8S::Properties(
    ...
    failed_jobs_history_limit: {key: "failedJobsHistoryLimit", accessor: "failed_jobs_history_limit", kind: "Int32", nilable: true, default: nil, read_only: false, description: "The number of failed finished jobs to retain. Value must be non-negative integer. Defaults to 1."},
    job_template: {key: "jobTemplate", accessor: "job_template", kind: "::K8S::Api::Batch::V1::JobTemplateSpec", nilable: false, default: nil, read_only: false, description: "Specifies the job that will be created when executing a CronJob."},
    ...
    successful_jobs_history_limit: {key: "successfulJobsHistoryLimit", accessor: "successful_jobs_history_limit", kind: "Int32", nilable: true, default: nil, read_only: false, description: "The number of successful finished jobs to retain. Value must be non-negative integer. Defaults to 3."},
