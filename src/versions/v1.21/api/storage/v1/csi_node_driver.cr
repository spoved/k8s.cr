...
module K8S
  ...
  @[::K8S::Properties(
    allocatable: {key: "allocatable", accessor: "allocatable", kind: "::K8S::Api::Storage::V1::VolumeNodeResources", nilable: true, default: nil, read_only: false, description: "allocatable represents the volume resources of a node that are available for scheduling. This field is beta."},
