...
module K8S
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Storage::V1::CSINodeSpec", nilable: false, default: nil, read_only: false, description: "spec is the specification of CSINode", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Storage::V1::CSINode < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("spec", spec : ::K8S::Api::Storage::V1::CSINodeSpec, false, false, "spec is the specification of CSINode")

    def initialize(*, api_version : String? = "storage/v1", kind : String? = "CSINode", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, spec : ::K8S::Api::Storage::V1::CSINodeSpec? = nil)
      super()
