...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Storage::V1::CSIDriver)", nilable: false, default: nil, read_only: false, description: "items is the list of CSIDriver", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Storage::V1::CSIDriverList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Storage::V1::CSIDriver)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Storage::V1::CSIDriver), false, false, "items is the list of CSIDriver")

    def initialize(*, api_version : String? = "storage/v1", kind : String? = "CSIDriverList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Storage::V1::CSIDriver)? = nil)
      super()
