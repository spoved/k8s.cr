...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "storage.k8s.io", kind: "CSIStorageCapacity", version: "v1beta1")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/storage.k8s.io/v1beta1/namespaces/{namespace}/csistoragecapacities/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil},
           {name: "field_manager", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Storage::V1beta1::CSIStorageCapacity < ::K8S::Kubernetes::Resource
  ...
  module Resources::Storage::V1beta1
    alias CSIStorageCapacity = ::K8S::Api::Storage::V1beta1::CSIStorageCapacity
  end
end
