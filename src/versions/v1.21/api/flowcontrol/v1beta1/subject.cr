...
module K8S
  ...
  @[::K8S::Properties(
    group: {key: "group", accessor: "group", kind: "::K8S::Api::Flowcontrol::V1beta1::GroupSubject", nilable: true, default: nil, read_only: false, description: nil},
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: nil, read_only: false, description: "Required"},
    service_account: {key: "serviceAccount", accessor: "service_account", kind: "::K8S::Api::Flowcontrol::V1beta1::ServiceAccountSubject", nilable: true, default: nil, read_only: false, description: nil},
    user: {key: "user", accessor: "user", kind: "::K8S::Api::Flowcontrol::V1beta1::UserSubject", nilable: true, default: nil, read_only: false, description: nil},
  )]
