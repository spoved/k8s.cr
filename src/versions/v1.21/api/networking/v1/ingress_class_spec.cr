...
module K8S
  ...
  @[::K8S::Properties(
    ...
    parameters: {key: "parameters", accessor: "parameters", kind: "::K8S::Api::Networking::V1::IngressClassParametersReference", nilable: true, default: nil, read_only: false, description: "Parameters is a link to a custom resource containing additional configuration for the controller. This is optional if the controller does not require extra parameters.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Networking::V1::IngressClassSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("parameters", parameters : ::K8S::Api::Networking::V1::IngressClassParametersReference, true, false, "Parameters is a link to a custom resource containing additional configuration for the controller. This is optional if the controller does not require extra parameters.")

    def initialize(*, controller : String? = nil, parameters : ::K8S::Api::Networking::V1::IngressClassParametersReference? = nil)
      super()
