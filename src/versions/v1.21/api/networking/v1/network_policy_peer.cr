...
module K8S
  ...
  module Types::Api::Networking::V1::NetworkPolicyPeer
    alias ValueType = ::K8S::Api::Networking::V1::IPBlock | ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector | Nil
  ...
  @[::K8S::Properties(
    ip_block: {key: "ipBlock", accessor: "ip_block", kind: "::K8S::Api::Networking::V1::IPBlock", nilable: true, default: nil, read_only: false, description: "IPBlock defines policy on a particular IPBlock. If this field is set then neither of the other fields can be."},
  ...
  class Api::Networking::V1::NetworkPolicyPeer < ::K8S::Types::Api::Networking::V1::NetworkPolicyPeer::Instance
