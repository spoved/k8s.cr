...
module K8S
  ...
  @[::K8S::Properties(
    ...
    exit_code: {key: "exitCode", accessor: "exit_code", kind: "Int32", nilable: false, default: nil, read_only: false, description: "Exit status from the last termination of the container"},
    finished_at: {key: "finishedAt", accessor: "finished_at", kind: "::Time", nilable: true, default: nil, read_only: false, description: "Time at which the container last terminated"},
    message: {key: "message", accessor: "message", kind: "String", nilable: true, default: nil, read_only: false, description: "Message regarding the last termination of the container"},
    reason: {key: "reason", accessor: "reason", kind: "String", nilable: true, default: nil, read_only: false, description: "(brief) reason from the last termination of the container"},
    signal: {key: "signal", accessor: "signal", kind: "Int32", nilable: true, default: nil, read_only: false, description: "Signal from the last termination of the container"},
    started_at: {key: "startedAt", accessor: "started_at", kind: "::Time", nilable: true, default: nil, read_only: false, description: "Time at which previous execution of the container started"},
  )]
