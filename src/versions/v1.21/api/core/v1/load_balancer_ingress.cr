...
module K8S
  ...
  @[::K8S::Properties(
    ...
    ports: {key: "ports", accessor: "ports", kind: "::Array(::K8S::Api::Core::V1::PortStatus)", nilable: true, default: nil, read_only: false, description: "Ports is a list of records of service ports If used, every port defined in the service should have an entry in it"},
  )]
