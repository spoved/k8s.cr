...
module K8S
  ...
  @[::K8S::Properties(
    ...
    internal_traffic_policy: {type: String, nilable: true, key: "internalTrafficPolicy", getter: false, setter: false},
    ...
    load_balancer_class: {type: String, nilable: true, key: "loadBalancerClass", getter: false, setter: false},
  ...
  class Api::Core::V1::ServiceSpec
    ...
    @[::JSON::Field(key: "allocateLoadBalancerNodePorts", emit_null: false)]
    @[::YAML::Field(key: "allocateLoadBalancerNodePorts", emit_null: false)]
    ...
    @[::JSON::Field(key: "clusterIPs", emit_null: false)]
    @[::YAML::Field(key: "clusterIPs", emit_null: false)]
    ...
    @[::JSON::Field(key: "internalTrafficPolicy", emit_null: false)]
    @[::YAML::Field(key: "internalTrafficPolicy", emit_null: false)]
    ...
    @[::JSON::Field(key: "ipFamilies", emit_null: false)]
    @[::YAML::Field(key: "ipFamilies", emit_null: false)]
    ...
    @[::JSON::Field(key: "ipFamilyPolicy", emit_null: false)]
    @[::YAML::Field(key: "ipFamilyPolicy", emit_null: false)]
    ...
    @[::JSON::Field(key: "loadBalancerClass", emit_null: false)]
    @[::YAML::Field(key: "loadBalancerClass", emit_null: false)]
    ...
    def initialize(*, @allocate_load_balancer_node_ports : Bool | Nil = nil, @cluster_ip : String | Nil = nil, @cluster_ips : Array(String) | Nil = nil, @external_ips : Array(String) | Nil = nil, @external_name : String | Nil = nil, @external_traffic_policy : String | Nil = nil, @health_check_node_port : Int32 | Nil = nil, @internal_traffic_policy : String | Nil = nil, @ip_families : Array(String) | Nil = nil, @ip_family_policy : String | Nil = nil, @load_balancer_class : String | Nil = nil, @load_balancer_ip : String | Nil = nil, @load_balancer_source_ranges : Array(String) | Nil = nil, @ports : Array(Api::Core::V1::ServicePort) | Nil = nil, @publish_not_ready_addresses : Bool | Nil = nil, @selector : Hash(String, String) | Nil = nil, @session_affinity : String | Nil = nil, @session_affinity_config : Api::Core::V1::SessionAffinityConfig | Nil = nil, @topology_keys : Array(String) | Nil = nil, @type : String | Nil = nil)
    end
  end
end
