...
::K8S::Kubernetes::Resource.define_object("SecurityContext",
  ...
  properties: [
    ...
    {name: "seccomp_profile", kind: ::K8S::Api::Core::V1::SeccompProfile, key: "seccompProfile", nilable: true, read_only: false, description: "The seccomp options to use by this container. If seccomp options are provided at both the pod & container level, the container options override the pod options."},
