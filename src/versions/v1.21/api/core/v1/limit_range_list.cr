...
module K8S
  ...
  class Api::Core::V1::LimitRangeList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Core::V1::LimitRange)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Core::V1::LimitRange), false, false, "Items is a list of LimitRange objects. More info: [https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/](https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/)")
