...
module K8S
  ...
  class Api::Scheduling::V1beta1::PriorityClassList < ::K8S::Kubernetes::ResourceList(Api::Scheduling::V1beta1::PriorityClass)
    ...
    def initialize(*, @items : Array(Api::Scheduling::V1beta1::PriorityClass), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
