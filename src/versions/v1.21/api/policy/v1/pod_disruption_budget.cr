...
module K8S
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Policy::V1::PodDisruptionBudgetSpec", nilable: true, default: nil, read_only: false, description: "Specification of the desired behavior of the PodDisruptionBudget."},
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Policy::V1::PodDisruptionBudgetStatus", nilable: true, default: nil, read_only: false, description: "Most recently observed status of the PodDisruptionBudget."},
  )]
