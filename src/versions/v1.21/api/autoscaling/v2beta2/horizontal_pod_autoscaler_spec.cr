...
::K8S::Kubernetes::Resource.define_object("HorizontalPodAutoscalerSpec",
  ...
  properties: [
    ...
    {name: "scale_target_ref", kind: ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference, key: "scaleTargetRef", nilable: false, read_only: false, description: "scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count."},
