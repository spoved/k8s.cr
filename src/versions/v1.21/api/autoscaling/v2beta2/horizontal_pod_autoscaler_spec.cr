...
module K8S::Types::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerSpec; end
...
module K8S
  ...
  module Types::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerSpec
    ...
    abstract def behavior? : ::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior?
    # :ditto:
    abstract def behavior=(value : ::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior?)
    ...
    abstract def metrics : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)?
    # :ditto:
    abstract def metrics! : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)
    # :ditto:
    abstract def metrics? : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)?
    # :ditto:
    abstract def metrics=(value : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)?)
    ...
    abstract def scale_target_ref : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference
    # :ditto:
    abstract def scale_target_ref! : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference
    # :ditto:
    abstract def scale_target_ref? : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference?
    # :ditto:
    abstract def scale_target_ref=(value : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference)
  end

  # HorizontalPodAutoscalerSpec describes the desired functionality of the HorizontalPodAutoscaler.
  @[::K8S::Properties(
    behavior: {key: "behavior", accessor: "behavior", kind: "::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior", nilable: true, default: nil, read_only: false, description: "behavior configures the scaling behavior of the target in both Up and Down directions (scaleUp and scaleDown fields respectively). If not set, the default HPAScalingRules for scale up and scale down are used."},
    ...
    metrics: {key: "metrics", accessor: "metrics", kind: "::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)", nilable: true, default: nil, read_only: false, description: "metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used).  The desired replica count is calculated multiplying the ratio between the target value and the current value by the current number of pods.  Ergo, metrics used must decrease as the pod count is increased, and vice-versa.  See the individual metric source types for more information about how each type of metric must respond. If not set, the default metric will be set to 80% average CPU utilization."},
    ...
    scale_target_ref: {key: "scaleTargetRef", accessor: "scale_target_ref", kind: "::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference", nilable: false, default: nil, read_only: false, description: "scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count."},
  )]
  class Api::Autoscaling::V2beta2::HorizontalPodAutoscalerSpec < ::K8S::Types::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerSpec::Instance
    ...
    def behavior : ::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior?
      self.["behavior"].as(::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior?)
    end

    # :ditto:
    def behavior! : ::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior
      self.["behavior"].as(::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior?).not_nil!
    end
    ...
    # :ditto:
    def behavior=(value : ::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior?)
      self.["behavior"] = value
    end
    ...
    # metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used).  The desired replica count is calculated multiplying the ratio between the target value and the current value by the current number of pods.  Ergo, metrics used must decrease as the pod count is increased, and vice-versa.  See the individual metric source types for more information about how each type of metric must respond. If not set, the default metric will be set to 80% average CPU utilization.
    def metrics : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)?
      self.["metrics"].as(::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)?)
    end

    # :ditto:
    def metrics! : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)
      self.["metrics"].as(::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)?).not_nil!
    end
    ...
    # :ditto:
    def metrics=(value : ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec)?)
      self.["metrics"] = value
    end
    ...
    # scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.
    def scale_target_ref : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference
      self.["scaleTargetRef"].as(::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference)
    end

    # :ditto:
    def scale_target_ref! : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference
      self.["scaleTargetRef"].as(::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference).not_nil!
    end
    ...
    # :ditto:
    def scale_target_ref=(value : ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference)
      self.["scaleTargetRef"] = value
    end

    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        { key: "behavior", accessor: "behavior", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Autoscaling::V2beta2::HorizontalPodAutoscalerBehavior },
        { key: "maxReplicas", accessor: "max_replicas", nilable: false, read_only: false, default: nil, kind: Int32 },
        { key: "metrics", accessor: "metrics", nilable: true, read_only: false, default: nil, kind: ::Array(::K8S::Api::Autoscaling::V2beta2::MetricSpec) },
        { key: "minReplicas", accessor: "min_replicas", nilable: true, read_only: false, default: nil, kind: Int32 },
        { key: "scaleTargetRef", accessor: "scale_target_ref", nilable: false, read_only: false, default: nil, kind: ::K8S::Api::Autoscaling::V2beta2::CrossVersionObjectReference },
      ])
end
  end
end
