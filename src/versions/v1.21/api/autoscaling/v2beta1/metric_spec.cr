...
::K8S::Kubernetes::Resource.define_object("MetricSpec",
  ...
  properties: [
    ...
    {name: "container_resource", kind: ::K8S::Api::Autoscaling::V2beta1::ContainerResourceMetricSource, key: "containerResource", nilable: true, read_only: false, description: "container resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing a single container in each pod of the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the \"pods\" source. This is an alpha feature and can be enabled by the HPAContainerMetrics feature flag."},
