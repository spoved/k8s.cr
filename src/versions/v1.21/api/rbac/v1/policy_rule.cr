...
::K8S::Kubernetes::Resource.define_object("PolicyRule",
  ...
  properties: [
    ...
    {name: "resources", kind: ::Array(String), key: "resources", nilable: true, read_only: false, description: "Resources is a list of resources this rule applies to.  ResourceAll represents all resources."},
    {name: "verbs", kind: ::Array(String), key: "verbs", nilable: false, read_only: false, description: "Verbs is a list of Verbs that apply to ALL the ResourceKinds and AttributeRestrictions contained in this rule.  VerbAll represents all kinds."},
