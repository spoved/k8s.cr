...
module K8S
  ...
  class Api::Admissionregistration::V1::MutatingWebhookConfigurationList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Admissionregistration::V1::MutatingWebhookConfiguration)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Admissionregistration::V1::MutatingWebhookConfiguration), false, false, "List of MutatingWebhookConfiguration.")

    def initialize(*, api_version : String? = "admissionregistration/v1", kind : String? = "MutatingWebhookConfigurationList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Admissionregistration::V1::MutatingWebhookConfiguration)? = nil)
      super()
