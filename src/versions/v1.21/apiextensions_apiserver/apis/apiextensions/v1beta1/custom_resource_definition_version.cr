...
module K8S
  alias ApiextensionsApiserver::Apis::Apiextensions::V1beta1::CustomResourceDefinitionVersion = ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceDefinitionVersion
end
