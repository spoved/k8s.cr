...
module K8S
  ...
  class Api::Admissionregistration::V1alpha1::ExternalAdmissionHookConfigurationList < ::K8S::Kubernetes::ResourceList(Api::Admissionregistration::V1alpha1::ExternalAdmissionHookConfiguration)
