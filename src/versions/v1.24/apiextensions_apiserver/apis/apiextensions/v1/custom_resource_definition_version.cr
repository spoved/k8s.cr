...
::K8S::Kubernetes::Resource.define_object("CustomResourceDefinitionVersion",
  ...
  properties: [
    ...
    {name: "deprecated", kind: ::Bool, key: "deprecated", nilable: true, read_only: false, description: "deprecated indicates this version of the custom resource API is deprecated. When set to true, API requests to this version receive a warning header in the server response. Defaults to false."},
    {name: "deprecation_warning", kind: String, key: "deprecationWarning", nilable: true, read_only: false, description: "deprecationWarning overrides the default warning returned to API clients. May only be set when `deprecated` is true. The default warning indicates this version is deprecated and recommends use of the newest served version of equal or greater stability, if one exists."},
