...
::K8S::Kubernetes::Resource.define_object("NodeSystemInfo",
  ...
  properties: [
    ...
    {name: "container_runtime_version", kind: String, key: "containerRuntimeVersion", nilable: false, read_only: false, description: "ContainerRuntime Version reported by the node through runtime remote API (e.g. containerd://1.4.2)."},
