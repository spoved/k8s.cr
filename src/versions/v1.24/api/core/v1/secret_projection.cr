...
::K8S::Kubernetes::Resource.define_object("SecretProjection",
  ...
  properties: [
    ...
    {name: "optional", kind: ::Bool, key: "optional", nilable: true, read_only: false, description: "optional field specify whether the Secret or its key must be defined"},
