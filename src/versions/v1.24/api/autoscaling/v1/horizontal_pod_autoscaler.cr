...
::K8S::Kubernetes::Resource.define_resource("autoscaling", "v1", "HorizontalPodAutoscaler",
  ...
  properties: [
    ...
    {name: "spec", kind: ::K8S::Api::Autoscaling::V1::HorizontalPodAutoscalerSpec, key: "spec", nilable: true, read_only: false, description: "behaviour of autoscaler. More info: [https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status.)"},
