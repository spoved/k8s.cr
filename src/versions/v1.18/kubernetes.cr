module ::K8S::Kubernetes
  ...
  abstract class Resource
    ...
    MAPPINGS = [
      ...
      {"auditregistration/v1alpha1", "AuditSink", Api::Auditregistration::V1alpha1::AuditSink},
      {"auditregistration/v1alpha1", "AuditSinkList", Api::Auditregistration::V1alpha1::AuditSinkList},
