...
::K8S::Kubernetes::Resource.define_resource("networking.k8s.io", "v1beta1", "IngressClass",
  ...
  versions: [{group: "networking.k8s.io", kind: "IngressClass", version: "v1beta1"}],
)
