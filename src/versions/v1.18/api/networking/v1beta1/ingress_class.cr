...
module K8S
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/networking.k8s.io/v1beta1/ingressclasses/{name}", toplevel: true,
  ...
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/networking.k8s.io/v1beta1/ingressclasses/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil},
           {name: "field_manager", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Networking::V1beta1::IngressClass < ::K8S::Kubernetes::Resource
