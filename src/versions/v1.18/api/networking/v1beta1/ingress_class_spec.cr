...
module K8S
  # Namespace holding the types for `Api::Networking::V1beta1::IngressClassSpec`.
  module Types::Api::Networking::V1beta1::IngressClassSpec
    alias ValueType = String | ::K8S::Api::Core::V1::TypedLocalObjectReference | Nil
  ...
  @[::K8S::Properties(
    ...
    parameters: {key: "parameters", accessor: "parameters", kind: "::K8S::Api::Core::V1::TypedLocalObjectReference", nilable: true, default: nil, read_only: false, description: "Parameters is a link to a custom resource containing additional configuration for the controller. This is optional if the controller does not require extra parameters."},
  )]
  class Api::Networking::V1beta1::IngressClassSpec < ::K8S::Types::Api::Networking::V1beta1::IngressClassSpec::Instance
    include ::K8S::Types::Api::Networking::V1beta1::IngressClassSpec
