...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "value", type: Int32},
           ...
           {name: "preemption_policy", type: String | Nil, default: nil},
  ...
  class Api::Scheduling::V1alpha1::PriorityClassList < ::K8S::Kubernetes::ResourceList(Api::Scheduling::V1alpha1::PriorityClass)
    ...
    def initialize(*, @items : Array(Api::Scheduling::V1alpha1::PriorityClass), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
