...
::K8S::Kubernetes::Resource.define_resource("scheduling.k8s.io", "v1", "PriorityClass",
  ...
  properties: [
    ...
    {name: "preemption_policy", kind: String, key: "preemptionPolicy", nilable: true, read_only: false, description: "PreemptionPolicy is the Policy for preempting pods with lower priority. One of Never, PreemptLowerPriority. Defaults to PreemptLowerPriority if unset. This field is alpha-level and is only honored by servers that enable the NonPreemptingPriority feature."},
