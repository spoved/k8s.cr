...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "rbac.authorization.k8s.io", kind: "Role", version: "v1alpha1")]
  ...
  @[::K8S::Action(name: "get", verb: "get",
    path: "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}", toplevel: true,
    args: [{name: "name", type: String},
           {name: "context", type: String | Nil, default: nil},
           {name: "namespace", type: String, default: "default"}]
  )]
  @[::K8S::Action(name: "put", verb: "put",
    path: "/apis/rbac.authorization.k8s.io/v1alpha1/namespaces/{namespace}/roles/{name}", toplevel: false,
    args: [{name: "context", type: String | Nil, default: nil},
           {name: "dry_run", type: String | Nil, default: nil},
           {name: "field_manager", type: String | Nil, default: nil}]
  )]
  ...
  class Api::Rbac::V1alpha1::Role < ::K8S::Kubernetes::Resource
  ...
  module Resources::Rbac::V1alpha1
    alias Role = ::K8S::Api::Rbac::V1alpha1::Role
  end
end
