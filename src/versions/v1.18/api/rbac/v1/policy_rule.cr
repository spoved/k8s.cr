...
module K8S
  ...
  class Api::Rbac::V1::PolicyRule < ::K8S::GenericObject
    ...
    k8s_object_accessor("resources", resources : ::Array(String), true, false, "Resources is a list of resources this rule applies to.  ResourceAll represents all resources.")
    k8s_object_accessor("verbs", verbs : ::Array(String), false, false, "Verbs is a list of Verbs that apply to ALL the ResourceKinds and AttributeRestrictions contained in this rule.  VerbAll represents all kinds.")
