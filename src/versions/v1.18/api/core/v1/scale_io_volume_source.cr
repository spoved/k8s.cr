...
::K8S::Kubernetes::Resource.define_object("ScaleIOVolumeSource",
  ...
  properties: [
    ...
    {name: "fs_type", kind: String, key: "fsType", nilable: true, read_only: false, description: "Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. \"ext4\", \"xfs\", \"ntfs\". Default is \"xfs\"."},
    ...
    {name: "storage_mode", kind: String, key: "storageMode", nilable: true, read_only: false, description: "Indicates whether the storage for a volume should be ThickProvisioned or ThinProvisioned. Default is ThinProvisioned."},
