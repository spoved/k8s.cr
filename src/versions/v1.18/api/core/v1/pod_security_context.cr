...
module K8S
  ...
  class Api::Core::V1::PodSecurityContext
    ...
    def initialize(*, @fs_group : Int32 | Nil = nil, @fs_group_change_policy : String | Nil = nil, @run_as_group : Int32 | Nil = nil, @run_as_non_root : Bool | Nil = nil, @run_as_user : Int32 | Nil = nil, @se_linux_options : Api::Core::V1::SELinuxOptions | Nil = nil, @supplemental_groups : Array(Int32) | Nil = nil, @sysctls : Array(Api::Core::V1::Sysctl) | Nil = nil, @windows_options : Api::Core::V1::WindowsSecurityContextOptions | Nil = nil)
    end
  end
end
