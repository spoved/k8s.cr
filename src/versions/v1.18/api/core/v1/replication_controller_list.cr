...
module K8S
  ...
  module Types::Api::Core::V1::ReplicationControllerList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Core::V1::ReplicationController) | Nil
  ...
  class Api::Core::V1::ReplicationControllerList < ::K8S::Types::Api::Core::V1::ReplicationControllerList::Instance
    include ::K8S::Types::Api::Core::V1::ReplicationControllerList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Core::V1::ReplicationController)
    ...
    # List of replication controllers. More info: [[https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller](https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller)](https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller](https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller))
    def items : Array(::K8S::Api::Core::V1::ReplicationController)
      self.["items"].as(Array(::K8S::Api::Core::V1::ReplicationController))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Core::V1::ReplicationController)
      self.["items"].as(Array(::K8S::Api::Core::V1::ReplicationController)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Core::V1::ReplicationController))
      self.["items"] = value
    end
