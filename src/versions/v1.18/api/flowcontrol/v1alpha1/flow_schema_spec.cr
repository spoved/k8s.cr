...
module K8S
  ...
  module Types::Api::Flowcontrol::V1alpha1::FlowSchemaSpec
    alias ValueType = ::K8S::Api::Flowcontrol::V1alpha1::FlowDistinguisherMethod | Int32 | ::K8S::Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationReference | ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects) | Nil
  ...
  @[::K8S::Properties(
    distinguisher_method: {key: "distinguisherMethod", accessor: "distinguisher_method", kind: "::K8S::Api::Flowcontrol::V1alpha1::FlowDistinguisherMethod", nilable: true, default: nil, read_only: false, description: "`distinguisherMethod` defines how to compute the flow distinguisher for requests that match this schema. `nil` specifies that the distinguisher is disabled and thus will always be the empty string."},
  ...
  class Api::Flowcontrol::V1alpha1::FlowSchemaSpec < ::K8S::Types::Api::Flowcontrol::V1alpha1::FlowSchemaSpec::Instance
    ...
    # `rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.
    def rules : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)?
      self.["rules"].as(::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)?)
    end

    # :ditto:
    def rules! : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)
      self.["rules"].as(::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)?).not_nil!
    end
    ...
    # :ditto:
    def rules=(value : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)?)
      self.["rules"] = value
    end
