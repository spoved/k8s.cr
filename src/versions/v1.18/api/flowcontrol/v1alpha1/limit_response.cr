...
::K8S::Kubernetes::Resource.define_object("LimitResponse",
  ...
  properties: [
    ...
    {name: "queuing", kind: ::K8S::Api::Flowcontrol::V1alpha1::QueuingConfiguration, key: "queuing", nilable: true, read_only: false, description: "`queuing` holds the configuration parameters for queuing. This field may be non-empty only if `type` is `\"Queue\"`."},
