...
module K8S
  ...
  class Api::Events::V1beta1::EventSeries
    ...
    @[::JSON::Field(key: "lastObservedTime", emit_null: true, converter: K8S::TimeFormat.new)]
    @[::YAML::Field(key: "lastObservedTime", emit_null: true, converter: K8S::TimeFormat.new)]
