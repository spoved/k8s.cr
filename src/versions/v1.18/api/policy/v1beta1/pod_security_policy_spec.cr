...
module K8S
  ...
  module Types::Api::Policy::V1beta1::PodSecurityPolicySpec
    alias ValueType = ::Bool | ::Array(::K8S::Api::Policy::V1beta1::AllowedCSIDriver) | ::Array(String) | ::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume) | ::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath) | ::K8S::Api::Policy::V1beta1::FSGroupStrategyOptions | ::Array(::K8S::Api::Policy::V1beta1::HostPortRange) | ::K8S::Api::Policy::V1beta1::RunAsGroupStrategyOptions | ::K8S::Api::Policy::V1beta1::RunAsUserStrategyOptions | ::K8S::Api::Policy::V1beta1::RuntimeClassStrategyOptions | ::K8S::Api::Policy::V1beta1::SELinuxStrategyOptions | ::K8S::Api::Policy::V1beta1::SupplementalGroupsStrategyOptions | Nil
  ...
  @[::K8S::Properties(
    allow_privilege_escalation: {key: "allowPrivilegeEscalation", accessor: "allow_privilege_escalation", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "allowPrivilegeEscalation determines if a pod can request to allow privilege escalation. If unspecified, defaults to true."},
    allowed_csi_drivers: {key: "allowedCSIDrivers", accessor: "allowed_csi_drivers", kind: "::Array(::K8S::Api::Policy::V1beta1::AllowedCSIDriver)", nilable: true, default: nil, read_only: false, description: "AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes. This is an alpha field, and is only honored if the API server enables the CSIInlineVolume feature gate."},
    ...
    allowed_flex_volumes: {key: "allowedFlexVolumes", accessor: "allowed_flex_volumes", kind: "::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume)", nilable: true, default: nil, read_only: false, description: "allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the \"volumes\" field."},
    allowed_host_paths: {key: "allowedHostPaths", accessor: "allowed_host_paths", kind: "::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath)", nilable: true, default: nil, read_only: false, description: "allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used."},
    ...
    fs_group: {key: "fsGroup", accessor: "fs_group", kind: "::K8S::Api::Policy::V1beta1::FSGroupStrategyOptions", nilable: false, default: nil, read_only: false, description: "fsGroup is the strategy that will dictate what fs group is used by the SecurityContext."},
    host_ipc: {key: "hostIPC", accessor: "host_ipc", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "hostIPC determines if the policy allows the use of HostIPC in the pod spec."},
    host_network: {key: "hostNetwork", accessor: "host_network", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "hostNetwork determines if the policy allows the use of HostNetwork in the pod spec."},
    host_pid: {key: "hostPID", accessor: "host_pid", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "hostPID determines if the policy allows the use of HostPID in the pod spec."},
    host_ports: {key: "hostPorts", accessor: "host_ports", kind: "::Array(::K8S::Api::Policy::V1beta1::HostPortRange)", nilable: true, default: nil, read_only: false, description: "hostPorts determines which host port ranges are allowed to be exposed."},
    privileged: {key: "privileged", accessor: "privileged", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "privileged determines if a pod can request to be run as privileged."},
    ...
    required_drop_capabilities: {key: "requiredDropCapabilities", accessor: "required_drop_capabilities", kind: "::Array(String)", nilable: true, default: nil, read_only: false, description: "requiredDropCapabilities are the capabilities that will be dropped from the container.  These are required to be dropped and cannot be added."},
    run_as_group: {key: "runAsGroup", accessor: "run_as_group", kind: "::K8S::Api::Policy::V1beta1::RunAsGroupStrategyOptions", nilable: true, default: nil, read_only: false, description: "RunAsGroup is the strategy that will dictate the allowable RunAsGroup values that may be set. If this field is omitted, the pod's RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled."},
    run_as_user: {key: "runAsUser", accessor: "run_as_user", kind: "::K8S::Api::Policy::V1beta1::RunAsUserStrategyOptions", nilable: false, default: nil, read_only: false, description: "runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set."},
    runtime_class: {key: "runtimeClass", accessor: "runtime_class", kind: "::K8S::Api::Policy::V1beta1::RuntimeClassStrategyOptions", nilable: true, default: nil, read_only: false, description: "runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled."},
    se_linux: {key: "seLinux", accessor: "se_linux", kind: "::K8S::Api::Policy::V1beta1::SELinuxStrategyOptions", nilable: false, default: nil, read_only: false, description: "seLinux is the strategy that will dictate the allowable labels that may be set."},
    supplemental_groups: {key: "supplementalGroups", accessor: "supplemental_groups", kind: "::K8S::Api::Policy::V1beta1::SupplementalGroupsStrategyOptions", nilable: false, default: nil, read_only: false, description: "supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext."},
    volumes: {key: "volumes", accessor: "volumes", kind: "::Array(String)", nilable: true, default: nil, read_only: false, description: "volumes is a white list of allowed volume plugins. Empty indicates that no volumes may be used. To allow all volumes you may use '*'."},
  )]
  class Api::Policy::V1beta1::PodSecurityPolicySpec < ::K8S::Types::Api::Policy::V1beta1::PodSecurityPolicySpec::Instance
    ...
    # AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec. An empty value indicates that any CSI driver can be used for inline ephemeral volumes. This is an alpha field, and is only honored if the API server enables the CSIInlineVolume feature gate.
    def allowed_csi_drivers : ::Array(::K8S::Api::Policy::V1beta1::AllowedCSIDriver)?
      self.["allowedCSIDrivers"].as(::Array(::K8S::Api::Policy::V1beta1::AllowedCSIDriver)?)
    end

    # :ditto:
    def allowed_csi_drivers! : ::Array(::K8S::Api::Policy::V1beta1::AllowedCSIDriver)
      self.["allowedCSIDrivers"].as(::Array(::K8S::Api::Policy::V1beta1::AllowedCSIDriver)?).not_nil!
    end
    ...
    # :ditto:
    def allowed_csi_drivers=(value : ::Array(::K8S::Api::Policy::V1beta1::AllowedCSIDriver)?)
    ...
    # allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the "volumes" field.
    def allowed_flex_volumes : ::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume)?
      self.["allowedFlexVolumes"].as(::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume)?)
    end

    # :ditto:
    def allowed_flex_volumes! : ::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume)
      self.["allowedFlexVolumes"].as(::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume)?).not_nil!
    end
    ...
    # :ditto:
    def allowed_flex_volumes=(value : ::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume)?)
      self.["allowedFlexVolumes"] = value
    end

    # allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.
    def allowed_host_paths : ::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath)?
      self.["allowedHostPaths"].as(::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath)?)
    end

    # :ditto:
    def allowed_host_paths! : ::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath)
      self.["allowedHostPaths"].as(::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath)?).not_nil!
    end
    ...
    # :ditto:
    def allowed_host_paths=(value : ::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath)?)
    ...
    # fsGroup is the strategy that will dictate what fs group is used by the SecurityContext.
    def fs_group : ::K8S::Api::Policy::V1beta1::FSGroupStrategyOptions
      self.["fsGroup"].as(::K8S::Api::Policy::V1beta1::FSGroupStrategyOptions)
    end

    # :ditto:
    def fs_group! : ::K8S::Api::Policy::V1beta1::FSGroupStrategyOptions
      self.["fsGroup"].as(::K8S::Api::Policy::V1beta1::FSGroupStrategyOptions).not_nil!
    end
    ...
    # :ditto:
    def fs_group=(value : ::K8S::Api::Policy::V1beta1::FSGroupStrategyOptions)
      self.["fsGroup"] = value
    end
    ...
    # hostPorts determines which host port ranges are allowed to be exposed.
    def host_ports : ::Array(::K8S::Api::Policy::V1beta1::HostPortRange)?
      self.["hostPorts"].as(::Array(::K8S::Api::Policy::V1beta1::HostPortRange)?)
    end

    # :ditto:
    def host_ports! : ::Array(::K8S::Api::Policy::V1beta1::HostPortRange)
      self.["hostPorts"].as(::Array(::K8S::Api::Policy::V1beta1::HostPortRange)?).not_nil!
    end
    ...
    # :ditto:
    def host_ports=(value : ::Array(::K8S::Api::Policy::V1beta1::HostPortRange)?)
    ...
    # RunAsGroup is the strategy that will dictate the allowable RunAsGroup values that may be set. If this field is omitted, the pod's RunAsGroup can take any value. This field requires the RunAsGroup feature gate to be enabled.
    def run_as_group : ::K8S::Api::Policy::V1beta1::RunAsGroupStrategyOptions?
      self.["runAsGroup"].as(::K8S::Api::Policy::V1beta1::RunAsGroupStrategyOptions?)
    end

    # :ditto:
    def run_as_group! : ::K8S::Api::Policy::V1beta1::RunAsGroupStrategyOptions
      self.["runAsGroup"].as(::K8S::Api::Policy::V1beta1::RunAsGroupStrategyOptions?).not_nil!
    end
    ...
    # :ditto:
    def run_as_group=(value : ::K8S::Api::Policy::V1beta1::RunAsGroupStrategyOptions?)
      self.["runAsGroup"] = value
    end

    # runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
    def run_as_user : ::K8S::Api::Policy::V1beta1::RunAsUserStrategyOptions
      self.["runAsUser"].as(::K8S::Api::Policy::V1beta1::RunAsUserStrategyOptions)
    end

    # :ditto:
    def run_as_user! : ::K8S::Api::Policy::V1beta1::RunAsUserStrategyOptions
      self.["runAsUser"].as(::K8S::Api::Policy::V1beta1::RunAsUserStrategyOptions).not_nil!
    end
    ...
    # :ditto:
    def run_as_user=(value : ::K8S::Api::Policy::V1beta1::RunAsUserStrategyOptions)
      self.["runAsUser"] = value
    end

    # runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod. If this field is omitted, the pod's runtimeClassName field is unrestricted. Enforcement of this field depends on the RuntimeClass feature gate being enabled.
    def runtime_class : ::K8S::Api::Policy::V1beta1::RuntimeClassStrategyOptions?
      self.["runtimeClass"].as(::K8S::Api::Policy::V1beta1::RuntimeClassStrategyOptions?)
    end

    # :ditto:
    def runtime_class! : ::K8S::Api::Policy::V1beta1::RuntimeClassStrategyOptions
      self.["runtimeClass"].as(::K8S::Api::Policy::V1beta1::RuntimeClassStrategyOptions?).not_nil!
    end
    ...
    # :ditto:
    def runtime_class=(value : ::K8S::Api::Policy::V1beta1::RuntimeClassStrategyOptions?)
      self.["runtimeClass"] = value
    end

    # seLinux is the strategy that will dictate the allowable labels that may be set.
    def se_linux : ::K8S::Api::Policy::V1beta1::SELinuxStrategyOptions
      self.["seLinux"].as(::K8S::Api::Policy::V1beta1::SELinuxStrategyOptions)
    end

    # :ditto:
    def se_linux! : ::K8S::Api::Policy::V1beta1::SELinuxStrategyOptions
      self.["seLinux"].as(::K8S::Api::Policy::V1beta1::SELinuxStrategyOptions).not_nil!
    end
    ...
    # :ditto:
    def se_linux=(value : ::K8S::Api::Policy::V1beta1::SELinuxStrategyOptions)
      self.["seLinux"] = value
    end

    # supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
    def supplemental_groups : ::K8S::Api::Policy::V1beta1::SupplementalGroupsStrategyOptions
      self.["supplementalGroups"].as(::K8S::Api::Policy::V1beta1::SupplementalGroupsStrategyOptions)
    end

    # :ditto:
    def supplemental_groups! : ::K8S::Api::Policy::V1beta1::SupplementalGroupsStrategyOptions
      self.["supplementalGroups"].as(::K8S::Api::Policy::V1beta1::SupplementalGroupsStrategyOptions).not_nil!
    end
    ...
    # :ditto:
    def supplemental_groups=(value : ::K8S::Api::Policy::V1beta1::SupplementalGroupsStrategyOptions)
