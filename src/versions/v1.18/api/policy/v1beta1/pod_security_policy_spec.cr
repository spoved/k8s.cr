...
module K8S
  ...
  class Api::Policy::V1beta1::PodSecurityPolicySpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("allowedFlexVolumes", allowed_flex_volumes : ::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume), true, false, "allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the \"volumes\" field.")
    k8s_object_accessor("allowedHostPaths", allowed_host_paths : ::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath), true, false, "allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used.")
