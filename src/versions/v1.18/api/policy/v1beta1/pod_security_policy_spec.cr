...
::K8S::Kubernetes::Resource.define_object("PodSecurityPolicySpec",
  ...
  properties: [
    ...
    {name: "allowed_flex_volumes", kind: ::Array(::K8S::Api::Policy::V1beta1::AllowedFlexVolume), key: "allowedFlexVolumes", nilable: true, read_only: false, description: "allowedFlexVolumes is a whitelist of allowed Flexvolumes.  Empty or nil indicates that all Flexvolumes may be used.  This parameter is effective only when the usage of the Flexvolumes is allowed in the \"volumes\" field."},
    {name: "allowed_host_paths", kind: ::Array(::K8S::Api::Policy::V1beta1::AllowedHostPath), key: "allowedHostPaths", nilable: true, read_only: false, description: "allowedHostPaths is a white list of allowed host paths. Empty indicates that all host paths may be used."},
