...
module K8S
  ...
  class Api::Discovery::V1beta1::EndpointSlice < ::K8S::Kubernetes::Resource
    ...
    def initialize(*, @address_type : String, @endpoints : Array(Api::Discovery::V1beta1::Endpoint) | Nil = nil, @metadata : Apimachinery::Apis::Meta::V1::ObjectMeta | Nil = nil, @ports : Array(Api::Discovery::V1beta1::EndpointPort) | Nil = nil)
    end
  end
