...
module K8S
  ...
  @[::K8S::Properties(
    ...
    type: {key: "type", accessor: "type", kind: "String", nilable: false, default: nil, read_only: false, description: "Type of statefulset condition."},
  )]
  class Api::Apps::V1::StatefulSetCondition < ::K8S::Types::Api::Apps::V1::StatefulSetCondition::Instance
