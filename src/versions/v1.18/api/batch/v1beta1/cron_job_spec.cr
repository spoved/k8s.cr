...
::K8S::Kubernetes::Resource.define_object("CronJobSpec",
  ...
  properties: [
    ...
    {name: "failed_jobs_history_limit", kind: Int32, key: "failedJobsHistoryLimit", nilable: true, read_only: false, description: "The number of failed finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified. Defaults to 1."},
    {name: "job_template", kind: ::K8S::Api::Batch::V1beta1::JobTemplateSpec, key: "jobTemplate", nilable: false, read_only: false, description: "Specifies the job that will be created when executing a CronJob."},
    ...
    {name: "successful_jobs_history_limit", kind: Int32, key: "successfulJobsHistoryLimit", nilable: true, read_only: false, description: "The number of successful finished jobs to retain. This is a pointer to distinguish between explicit zero and not specified. Defaults to 3."},
