...
module K8S
  ...
  class Api::Extensions::V1beta1::IngressSpec < ::K8S::GenericObject
    ...
    def initialize(*, backend : ::K8S::Api::Extensions::V1beta1::IngressBackend? = nil, ingress_class_name : String? = nil, rules : ::Array(::K8S::Api::Extensions::V1beta1::IngressRule)? = nil, tls : ::Array(::K8S::Api::Extensions::V1beta1::IngressTLS)? = nil)
      super()
