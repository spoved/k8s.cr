...
module K8S
  ...
  class Api::Core::V1::ISCSIPersistentVolumeSource < ::K8S::GenericObject
    ...
    k8s_object_accessor("secretRef", secret_ref : ::K8S::Api::Core::V1::SecretReference, true, false, "CHAP Secret for iSCSI target and initiator authentication")
    ...
    def initialize(*, chap_auth_discovery : ::Bool? = nil, chap_auth_session : ::Bool? = nil, fs_type : String? = nil, initiator_name : String? = nil, iqn : String? = nil, iscsi_interface : String? = nil, lun : Int32? = nil, portals : ::Array(String)? = nil, read_only : ::Bool? = nil, secret_ref : ::K8S::Api::Core::V1::SecretReference? = nil, target_portal : String? = nil)
      super()
