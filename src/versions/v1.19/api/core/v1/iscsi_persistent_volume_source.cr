...
::K8S::Kubernetes::Resource.define_object("ISCSIPersistentVolumeSource",
  ...
  properties: [
    ...
    {name: "secret_ref", kind: ::K8S::Api::Core::V1::SecretReference, key: "secretRef", nilable: true, read_only: false, description: "CHAP Secret for iSCSI target and initiator authentication"},
