...
module K8S
  ...
  module Types::Api::Core::V1::LimitRangeList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Core::V1::LimitRange) | Nil
  ...
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "LimitRangeList", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))"},
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Core::V1::LimitRange)", nilable: false, default: nil, read_only: false, description: "Items is a list of LimitRange objects. More info: [https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/](https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/)"},
  )]
  class Api::Core::V1::LimitRangeList < ::K8S::Types::Api::Core::V1::LimitRangeList::Instance
    include ::K8S::Types::Api::Core::V1::LimitRangeList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Core::V1::LimitRange)
    ...
    # Items is a list of LimitRange objects. More info: [[https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/](https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/)](https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/](https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/))
    def items : Array(::K8S::Api::Core::V1::LimitRange)
      self.["items"].as(Array(::K8S::Api::Core::V1::LimitRange))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Core::V1::LimitRange)
      self.["items"].as(Array(::K8S::Api::Core::V1::LimitRange)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Core::V1::LimitRange))
      self.["items"] = value
    end
