...
module K8S::Types::Api::Node::V1beta1::RuntimeClass; end
...
module K8S
  # Namespace holding the types for `Api::Node::V1beta1::RuntimeClass`.
  module Types::Api::Node::V1beta1::RuntimeClass
    ...
    abstract def overhead : ::K8S::Api::Node::V1beta1::Overhead?
    # :ditto:
    abstract def overhead! : ::K8S::Api::Node::V1beta1::Overhead
    # :ditto:
    abstract def overhead? : ::K8S::Api::Node::V1beta1::Overhead?
    # :ditto:
    abstract def overhead=(value : ::K8S::Api::Node::V1beta1::Overhead)
    # Scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.
    abstract def scheduling : ::K8S::Api::Node::V1beta1::Scheduling?
    # :ditto:
    abstract def scheduling! : ::K8S::Api::Node::V1beta1::Scheduling
    # :ditto:
    abstract def scheduling? : ::K8S::Api::Node::V1beta1::Scheduling?
    # :ditto:
    abstract def scheduling=(value : ::K8S::Api::Node::V1beta1::Scheduling)
  end
  ...
  @[::K8S::GroupVersionKind(group: "node.k8s.io", kind: "RuntimeClass", version: "v1beta1", full: "io.k8s.api.node.v1beta1.RuntimeClass")]
  @[::K8S::Properties(
    api_version: {key: "apiVersion", accessor: "api_version", kind: "String", nilable: false, default: "node/v1beta1", read_only: true, description: "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources))", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    overhead: {key: "overhead", accessor: "overhead", kind: "::K8S::Api::Node::V1beta1::Overhead", nilable: true, default: nil, read_only: false, description: "Overhead represents the resource overhead associated with running a pod for a given RuntimeClass. For more details, see [https://git.k8s.io/enhancements/keps/sig-node/20190226-pod-overhead.md This field is alpha-level as of Kubernetes v1.15, and is only honored by servers that enable the PodOverhead feature.](https://git.k8s.io/enhancements/keps/sig-node/20190226-pod-overhead.md This field is alpha-level as of Kubernetes v1.15, and is only honored by servers that enable the PodOverhead feature.)", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    scheduling: {key: "scheduling", accessor: "scheduling", kind: "::K8S::Api::Node::V1beta1::Scheduling", nilable: true, default: nil, read_only: false, description: "Scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Node::V1beta1::RuntimeClass < ::K8S::Kubernetes::Resource::Object
    include ::K8S::Types::Api::Node::V1beta1::RuntimeClass
    k8s_object_accessor("apiVersion", api_version : String = "node/v1beta1", false, true, "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources))")
    k8s_object_accessor("kind", kind : String = "RuntimeClass", false, true, "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))")
    ...
    k8s_object_accessor("handler", handler : String, false, false, "Handler specifies the underlying runtime and configuration that the CRI implementation will use to handle pods of this class. The possible values are specific to the node & CRI configuration.  It is assumed that all handlers are available on every node, and handlers of the same name are equivalent on every node. For example, a handler called \"runc\" might specify that the runc OCI runtime (using native Linux containers) will be used to run the containers in a pod. The Handler must conform to the DNS Label (RFC 1123) requirements, and is immutable.")
    k8s_object_accessor("overhead", overhead : ::K8S::Api::Node::V1beta1::Overhead, true, false, "Overhead represents the resource overhead associated with running a pod for a given RuntimeClass. For more details, see [https://git.k8s.io/enhancements/keps/sig-node/20190226-pod-overhead.md This field is alpha-level as of Kubernetes v1.15, and is only honored by servers that enable the PodOverhead feature.](https://git.k8s.io/enhancements/keps/sig-node/20190226-pod-overhead.md This field is alpha-level as of Kubernetes v1.15, and is only honored by servers that enable the PodOverhead feature.)")
    k8s_object_accessor("scheduling", scheduling : ::K8S::Api::Node::V1beta1::Scheduling, true, false, "Scheduling holds the scheduling constraints to ensure that pods running with this RuntimeClass are scheduled to nodes that support it. If scheduling is nil, this RuntimeClass is assumed to be supported by all nodes.")

    def initialize(*, api_version : String? = "node/v1beta1", kind : String? = "RuntimeClass", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, handler : String? = nil, overhead : ::K8S::Api::Node::V1beta1::Overhead? = nil, scheduling : ::K8S::Api::Node::V1beta1::Scheduling? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      {key: "apiVersion", accessor: "api_version", nilable: false, read_only: true, default: "node/v1beta1", kind: String},
      ...
      {key: "overhead", accessor: "overhead", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Node::V1beta1::Overhead},
      {key: "scheduling", accessor: "scheduling", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Node::V1beta1::Scheduling},
    ])
  end

  module Resources::Node::V1beta1
    alias RuntimeClass = ::K8S::Api::Node::V1beta1::RuntimeClass
  end
end
