...
module K8S
  # Namespace holding the types for `Api::Node::V1alpha1::Scheduling`.
  module Types::Api::Node::V1alpha1::Scheduling
  ...
  class Api::Node::V1alpha1::Scheduling < ::K8S::Types::Api::Node::V1alpha1::Scheduling::Instance
