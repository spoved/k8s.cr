...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "webhooks", type: Array(Api::Admissionregistration::V1beta1::ValidatingWebhook) | Nil, default: nil},
  ...
  class Api::Admissionregistration::V1beta1::ValidatingWebhookConfigurationList < ::K8S::Kubernetes::ResourceList(Api::Admissionregistration::V1beta1::ValidatingWebhookConfiguration)
    ...
    def initialize(*, @items : Array(Api::Admissionregistration::V1beta1::ValidatingWebhookConfiguration), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
