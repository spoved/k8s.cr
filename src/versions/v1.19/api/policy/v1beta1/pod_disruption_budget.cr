...
module K8S
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Policy::V1beta1::PodDisruptionBudgetSpec", nilable: true, default: nil, read_only: false, description: "Specification of the desired behavior of the PodDisruptionBudget.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Policy::V1beta1::PodDisruptionBudgetStatus", nilable: true, default: nil, read_only: false, description: "Most recently observed status of the PodDisruptionBudget.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Policy::V1beta1::PodDisruptionBudget < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("spec", spec : ::K8S::Api::Policy::V1beta1::PodDisruptionBudgetSpec, true, false, "Specification of the desired behavior of the PodDisruptionBudget.")
    k8s_object_accessor("status", status : ::K8S::Api::Policy::V1beta1::PodDisruptionBudgetStatus, true, false, "Most recently observed status of the PodDisruptionBudget.")

    def initialize(*, api_version : String? = "policy/v1beta1", kind : String? = "PodDisruptionBudget", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, spec : ::K8S::Api::Policy::V1beta1::PodDisruptionBudgetSpec? = nil, status : ::K8S::Api::Policy::V1beta1::PodDisruptionBudgetStatus? = nil)
      super()
