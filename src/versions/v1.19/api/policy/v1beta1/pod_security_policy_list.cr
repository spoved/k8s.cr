...
module K8S::Types::Api::Policy::V1beta1::PodSecurityPolicyList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./pod_security_policy"

module K8S
  # Namespace holding the types for `Api::Policy::V1beta1::PodSecurityPolicyList`.
  module Types::Api::Policy::V1beta1::PodSecurityPolicyList
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ListMeta | Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy) | Nil
    ...
    abstract def items : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)
    # :ditto:
    abstract def items! : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy))
  end

  # PodSecurityPolicyList is a list of PodSecurityPolicy objects.
  @[::K8S::GroupVersionKind(group: "policy", kind: "PodSecurityPolicyList", version: "v1beta1", full: "io.k8s.api.policy.v1beta1.PodSecurityPolicyList")]
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)", nilable: false, default: nil, read_only: false, description: "items is a list of schema objects."},
  )]
  class Api::Policy::V1beta1::PodSecurityPolicyList < ::K8S::Types::Api::Policy::V1beta1::PodSecurityPolicyList::Instance
    include ::K8S::Types::Api::Policy::V1beta1::PodSecurityPolicyList
    include ::K8S::Kubernetes::Resource::List(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)
    ...
    # items is a list of schema objects.
    def items : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)
      self.["items"].as(Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy))
    end

    # :ditto:
    def items! : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)
      self.["items"].as(Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)).not_nil!
    end
    ...
    # :ditto:
    def items=(value : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy))
      self.["items"] = value
    end
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        ...
        { key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy) },
      ])
end
  end
end
