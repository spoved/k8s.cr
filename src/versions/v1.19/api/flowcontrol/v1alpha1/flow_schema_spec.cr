...
module K8S
  ...
  module Types::Api::Flowcontrol::V1alpha1::FlowSchemaSpec
    ...
    abstract def rules : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)?
    # :ditto:
    abstract def rules! : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)
    # :ditto:
    abstract def rules? : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)?
    # :ditto:
    abstract def rules=(value : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects))
  end
  ...
  class Api::Flowcontrol::V1alpha1::FlowSchemaSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("distinguisherMethod", distinguisher_method : ::K8S::Api::Flowcontrol::V1alpha1::FlowDistinguisherMethod, true, false, "`distinguisherMethod` defines how to compute the flow distinguisher for requests that match this schema. `nil` specifies that the distinguisher is disabled and thus will always be the empty string.")
    ...
    k8s_object_accessor("priorityLevelConfiguration", priority_level_configuration : ::K8S::Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationReference, false, false, "`priorityLevelConfiguration` should reference a PriorityLevelConfiguration in the cluster. If the reference cannot be resolved, the FlowSchema will be ignored and marked as invalid in its status. Required.")
    k8s_object_accessor("rules", rules : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects), true, false, "`rules` describes which requests will match this flow schema. This FlowSchema matches a request if and only if at least one member of rules matches the request. if it is an empty slice, there will be no requests matching the FlowSchema.")

    def initialize(*, distinguisher_method : ::K8S::Api::Flowcontrol::V1alpha1::FlowDistinguisherMethod? = nil, matching_precedence : Int32? = nil, priority_level_configuration : ::K8S::Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationReference? = nil, rules : ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "rules", accessor: "rules", nilable: true, read_only: false, default: nil, kind: ::Array(::K8S::Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects)},
    ])
  end
end
