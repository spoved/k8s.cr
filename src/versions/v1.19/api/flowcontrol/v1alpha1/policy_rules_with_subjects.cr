...
::K8S::Kubernetes::Resource.define_object("PolicyRulesWithSubjects",
  ...
  properties: [
    ...
    {name: "non_resource_rules", kind: ::Array(::K8S::Api::Flowcontrol::V1alpha1::NonResourcePolicyRule), key: "nonResourceRules", nilable: true, read_only: false, description: "`nonResourceRules` is a list of NonResourcePolicyRules that identify matching requests according to their verb and the target non-resource URL."},
