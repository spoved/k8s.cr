...
module K8S
  ...
  class Api::Flowcontrol::V1alpha1::PolicyRulesWithSubjects
    ...
    @[::YAML::Field(key: "nonResourceRules", emit_null: false)]
    ...
    @[::JSON::Field(key: "resourceRules", emit_null: false)]
    @[::YAML::Field(key: "resourceRules", emit_null: false)]
    ...
    @[::JSON::Field(key: "subjects", emit_null: true)]
    @[::YAML::Field(key: "subjects", emit_null: true)]
    property subjects : Array(Api::Flowcontrol::V1alpha1::Subject)

    def initialize(*, @subjects : Array(Api::Flowcontrol::V1alpha1::Subject), @non_resource_rules : Array(Api::Flowcontrol::V1alpha1::NonResourcePolicyRule) | Nil = nil, @resource_rules : Array(Api::Flowcontrol::V1alpha1::ResourcePolicyRule) | Nil = nil)
    end
  end
end
