...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Rbac::V1beta1::ClusterRoleBinding)", nilable: false, default: nil, read_only: false, description: "Items is a list of ClusterRoleBindings"},
  )]
