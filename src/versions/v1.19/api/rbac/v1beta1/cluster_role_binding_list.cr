...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "rbac.authorization.k8s.io", kind: "ClusterRoleBindingList", version: "v1beta1")]
  ...
  class Api::Rbac::V1beta1::ClusterRoleBindingList < ::K8S::Kubernetes::Resource
