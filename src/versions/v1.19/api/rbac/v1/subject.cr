...
module K8S
  ...
  class Api::Rbac::V1::Subject < ::K8S::GenericObject
    include ::K8S::Types::Api::Rbac::V1::Subject
    k8s_object_accessor("apiGroup", api_group : String, true, false, "APIGroup holds the API group of the referenced subject. Defaults to \"\" for ServiceAccount subjects. Defaults to \"rbac.authorization.k8s.io\" for User and Group subjects.")
