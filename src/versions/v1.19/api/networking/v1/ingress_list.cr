...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Networking::V1::Ingress)", nilable: false, default: nil, read_only: false, description: "Items is the list of Ingress.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Networking::V1::IngressList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Networking::V1::Ingress)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Networking::V1::Ingress), false, false, "Items is the list of Ingress.")

    def initialize(*, api_version : String? = "networking/v1", kind : String? = "IngressList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Networking::V1::Ingress)? = nil)
      super()
