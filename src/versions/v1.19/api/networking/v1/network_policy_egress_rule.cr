...
module K8S
  ...
  class Api::Networking::V1::NetworkPolicyEgressRule < ::K8S::GenericObject
    ...
    k8s_object_accessor("ports", ports : ::Array(::K8S::Api::Networking::V1::NetworkPolicyPort), true, false, "List of destination ports for outgoing traffic. Each item in this list is combined using a logical OR. If this field is empty or missing, this rule matches all ports (traffic not restricted by port). If this field is present and contains at least one item, then this rule allows traffic only if the traffic matches at least one port in the list.")
    k8s_object_accessor("to", to : ::Array(::K8S::Api::Networking::V1::NetworkPolicyPeer), true, false, "List of destinations for outgoing traffic of pods selected for this rule. Items in this list are combined using a logical OR operation. If this field is empty or missing, this rule matches all destinations (traffic not restricted by destination). If this field is present and contains at least one item, this rule allows traffic only if the traffic matches at least one item in the to list.")

    def initialize(*, ports : ::Array(::K8S::Api::Networking::V1::NetworkPolicyPort)? = nil, to : ::Array(::K8S::Api::Networking::V1::NetworkPolicyPeer)? = nil)
      super()
      self.["ports"] = ports
      self.["to"] = to
    end
