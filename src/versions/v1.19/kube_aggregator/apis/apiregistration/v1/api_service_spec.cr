...
module K8S
  ...
  @[::K8S::Properties(
    ca_bundle: {key: "caBundle", accessor: "ca_bundle", kind: "String", nilable: true, default: nil, read_only: false, description: "CABundle is a PEM encoded CA bundle which will be used to validate an API server's serving certificate. If unspecified, system trust roots on the apiserver are used."},
    group: {key: "group", accessor: "group", kind: "String", nilable: true, default: nil, read_only: false, description: "Group is the API group name this server hosts"},
    ...
    insecure_skip_tls_verify: {key: "insecureSkipTLSVerify", accessor: "insecure_skip_tls_verify", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "InsecureSkipTLSVerify disables TLS certificate verification when communicating with this server. This is strongly discouraged.  You should use the CABundle instead."},
    service: {key: "service", accessor: "service", kind: "::K8S::KubeAggregator::Apis::Apiregistration::V1::ServiceReference", nilable: true, default: nil, read_only: false, description: "Service is a reference to the service for this API server.  It must communicate on port 443. If the Service is nil, that means the handling for the API groupversion is handled locally on this server. The call will simply delegate to the normal handler chain to be fulfilled."},
    version: {key: "version", accessor: "version", kind: "String", nilable: true, default: nil, read_only: false, description: "Version is the API version this server hosts.  For example, \"v1\""},
  ...
  class KubeAggregator::Apis::Apiregistration::V1::APIServiceSpec < ::K8S::Types::KubeAggregator::Apis::Apiregistration::V1::APIServiceSpec::Instance
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        ...
        { key: "service", accessor: "service", nilable: true, read_only: false, default: nil, kind: ::K8S::KubeAggregator::Apis::Apiregistration::V1::ServiceReference },
