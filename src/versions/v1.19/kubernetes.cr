module ::K8S::Kubernetes
  ...
  abstract struct Resource
    MAPPINGS = [
      ...
      {"flowcontrol/v1alpha1", "FlowSchema", K8S::Api::Flowcontrol::V1alpha1::FlowSchema},
      {"flowcontrol/v1alpha1", "FlowSchemaList", K8S::Api::Flowcontrol::V1alpha1::FlowSchemaList},
      {"flowcontrol/v1alpha1", "PriorityLevelConfiguration", K8S::Api::Flowcontrol::V1alpha1::PriorityLevelConfiguration},
      {"flowcontrol/v1alpha1", "PriorityLevelConfigurationList", K8S::Api::Flowcontrol::V1alpha1::PriorityLevelConfigurationList},
