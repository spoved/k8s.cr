...
module K8S
  ...
  module Types::ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceDefinitionVersion
    alias ValueType = ::Array(::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceColumnDefinition) | ::Bool | String | ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceValidation | ::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceSubresources | Nil
  ...
  @[::K8S::Properties(
    ...
    deprecated: {key: "deprecated", accessor: "deprecated", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "deprecated indicates this version of the custom resource API is deprecated. When set to true, API requests to this version receive a warning header in the server response. Defaults to false."},
    deprecation_warning: {key: "deprecationWarning", accessor: "deprecation_warning", kind: "String", nilable: true, default: nil, read_only: false, description: "deprecationWarning overrides the default warning returned to API clients. May only be set when `deprecated` is true. The default warning indicates this version is deprecated and recommends use of the newest served version of equal or greater stability, if one exists."},
