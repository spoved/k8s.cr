...
module K8S
  ...
  @[::K8S::Properties(
    accepted_names: {key: "acceptedNames", accessor: "accepted_names", kind: "::K8S::ApiextensionsApiserver::Apis::Apiextensions::V1::CustomResourceDefinitionNames", nilable: true, default: nil, read_only: false, description: "acceptedNames are the names that are actually being used to serve discovery. They may be different than the names in spec."},
