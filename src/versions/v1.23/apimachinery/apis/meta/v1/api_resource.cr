...
module K8S
  ...
  @[::K8S::Properties(
    categories: {key: "categories", accessor: "categories", kind: "::Array(String)", nilable: true, default: nil, read_only: false, description: "categories is a list of the grouped resources this resource belongs to (e.g. 'all')"},
    group: {key: "group", accessor: "group", kind: "String", nilable: true, default: nil, read_only: false, description: "group is the preferred group of the resource.  Empty implies the group of the containing resource list. For subresources, this may have a different value, for example: Scale\"."},
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: nil, read_only: false, description: "kind is the kind for the resource (e.g. 'Foo' is the kind for a resource 'foo')"},
    name: {key: "name", accessor: "name", kind: "String", nilable: false, default: nil, read_only: false, description: "name is the plural name of the resource."},
    namespaced: {key: "namespaced", accessor: "namespaced", kind: "::Bool", nilable: false, default: nil, read_only: false, description: "namespaced indicates if a resource is namespaced or not."},
    short_names: {key: "shortNames", accessor: "short_names", kind: "::Array(String)", nilable: true, default: nil, read_only: false, description: "shortNames is a list of suggested short names of the resource."},
    ...
    storage_version_hash: {key: "storageVersionHash", accessor: "storage_version_hash", kind: "String", nilable: true, default: nil, read_only: false, description: "The hash value of the storage version, the version this resource is converted to when written to the data store. Value must be treated as opaque by clients. Only equality comparison on the value is valid. This is an alpha feature and may change or be removed in the future. The field is populated by the apiserver only if the StorageVersionHash feature gate is enabled. This field will remain optional even if it graduates."},
    verbs: {key: "verbs", accessor: "verbs", kind: "::Array(String)", nilable: false, default: nil, read_only: false, description: "verbs is a list of supported kube verbs (this includes get, list, watch, create, update, patch, delete, deletecollection, and proxy)"},
    version: {key: "version", accessor: "version", kind: "String", nilable: true, default: nil, read_only: false, description: "version is the preferred version of the resource.  Empty implies the version of the containing resource list For subresources, this may have a different value, for example: v1 (while inside a v1beta1 version of the core resource's group)\"."},
  )]
