...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "autoscaling", kind: "DeleteOptions", version: "v2", full: "io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions")]
  ...
  @[::K8S::GroupVersionKind(group: "discovery.k8s.io", kind: "DeleteOptions", version: "v1", full: "io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions")]
  ...
  @[::K8S::GroupVersionKind(group: "flowcontrol.apiserver.k8s.io", kind: "DeleteOptions", version: "v1beta1", full: "io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions")]
  @[::K8S::GroupVersionKind(group: "flowcontrol.apiserver.k8s.io", kind: "DeleteOptions", version: "v1beta2", full: "io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions")]
  ...
  @[::K8S::GroupVersionKind(group: "internal.apiserver.k8s.io", kind: "DeleteOptions", version: "v1alpha1", full: "io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions")]
  ...
  @[::K8S::GroupVersionKind(group: "node.k8s.io", kind: "DeleteOptions", version: "v1", full: "io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions")]
  ...
  @[::K8S::GroupVersionKind(group: "policy", kind: "DeleteOptions", version: "v1", full: "io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions")]
  ...
  @[::K8S::Properties(
    ...
    preconditions: {key: "preconditions", accessor: "preconditions", kind: "::K8S::Apimachinery::Apis::Meta::V1::Preconditions", nilable: true, default: nil, read_only: false, description: "Must be fulfilled before a deletion is carried out. If not possible, a 409 Conflict status will be returned."},
