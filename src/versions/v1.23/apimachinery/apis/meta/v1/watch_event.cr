...
module K8S
  ...
  @[::K8S::GroupVersionKind(group: "autoscaling", kind: "WatchEvent", version: "v2", full: "io.k8s.apimachinery.pkg.apis.meta.v1.WatchEvent")]
  ...
  @[::K8S::GroupVersionKind(group: "flowcontrol.apiserver.k8s.io", kind: "WatchEvent", version: "v1beta2", full: "io.k8s.apimachinery.pkg.apis.meta.v1.WatchEvent")]
