...
::K8S::Kubernetes::Resource.define_object("PriorityLevelConfigurationSpec",
  ...
  properties: [
    ...
    {name: "limited", kind: ::K8S::Api::Flowcontrol::V1beta1::LimitedPriorityLevelConfiguration, key: "limited", nilable: true, read_only: false, description: "`limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `\"Limited\"`."},
