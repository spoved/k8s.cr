...
module K8S
  ...
  module Types::Api::Flowcontrol::V1beta1::PriorityLevelConfigurationSpec
    alias ValueType = ::K8S::Api::Flowcontrol::V1beta1::LimitedPriorityLevelConfiguration | String | Nil
  ...
  @[::K8S::Properties(
    limited: {key: "limited", accessor: "limited", kind: "::K8S::Api::Flowcontrol::V1beta1::LimitedPriorityLevelConfiguration", nilable: true, default: nil, read_only: false, description: "`limited` specifies how requests are handled for a Limited priority level. This field must be non-empty if and only if `type` is `\"Limited\"`."},
  ...
  class Api::Flowcontrol::V1beta1::PriorityLevelConfigurationSpec < ::K8S::Types::Api::Flowcontrol::V1beta1::PriorityLevelConfigurationSpec::Instance
