...
module K8S
  ...
  @[::K8S::Properties(
    conditions: {key: "conditions", accessor: "conditions", kind: "::Array(::K8S::Api::Autoscaling::V2beta1::HorizontalPodAutoscalerCondition)", nilable: true, default: nil, read_only: false, description: "conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met."},
    current_metrics: {key: "currentMetrics", accessor: "current_metrics", kind: "::Array(::K8S::Api::Autoscaling::V2beta1::MetricStatus)", nilable: true, default: nil, read_only: false, description: "currentMetrics is the last read state of the metrics used by this autoscaler."},
