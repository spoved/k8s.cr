...
module K8S
  ...
  @[::K8S::Properties(
    ...
    reason: {key: "reason", accessor: "reason", kind: "String", nilable: true, default: nil, read_only: false, description: "reason is the reason for the condition's last transition."},
    status: {key: "status", accessor: "status", kind: "String", nilable: false, default: nil, read_only: false, description: "status is the status of the condition (True, False, Unknown)"},
    type: {key: "type", accessor: "type", kind: "String", nilable: false, default: nil, read_only: false, description: "type describes the current condition"},
  )]
  class Api::Autoscaling::V2::HorizontalPodAutoscalerCondition < ::K8S::Types::Api::Autoscaling::V2::HorizontalPodAutoscalerCondition::Instance
