...
module K8S::Types::Api::Autoscaling::V2::HorizontalPodAutoscalerCondition; end

module K8S
  # Namespace holding the types for `Api::Autoscaling::V2::HorizontalPodAutoscalerCondition`.
  module Types::Api::Autoscaling::V2::HorizontalPodAutoscalerCondition
  ...
  @[::K8S::Properties(
    ...
    message: {key: "message", accessor: "message", kind: "String", nilable: true, default: nil, read_only: false, description: "message is a human-readable explanation containing details about the transition", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    reason: {key: "reason", accessor: "reason", kind: "String", nilable: true, default: nil, read_only: false, description: "reason is the reason for the condition's last transition.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Autoscaling::V2::HorizontalPodAutoscalerCondition < ::K8S::GenericObject
    include ::K8S::Types::Api::Autoscaling::V2::HorizontalPodAutoscalerCondition
    ...
    k8s_object_accessor("message", message : String, true, false, "message is a human-readable explanation containing details about the transition")
    k8s_object_accessor("reason", reason : String, true, false, "reason is the reason for the condition's last transition.")
    k8s_object_accessor("status", status : String, false, false, "status is the status of the condition (True, False, Unknown)")
    k8s_object_accessor("type", type : String, false, false, "type describes the current condition")
