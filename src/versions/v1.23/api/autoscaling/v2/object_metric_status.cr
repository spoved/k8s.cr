...
module K8S
  ...
  class Api::Autoscaling::V2::ObjectMetricStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("describedObject", described_object : ::K8S::Api::Autoscaling::V2::CrossVersionObjectReference, false, false, "DescribedObject specifies the descriptions of a object,such as kind,name apiVersion")
    ...
    def initialize(*, current : ::K8S::Api::Autoscaling::V2::MetricValueStatus? = nil, described_object : ::K8S::Api::Autoscaling::V2::CrossVersionObjectReference? = nil, metric : ::K8S::Api::Autoscaling::V2::MetricIdentifier? = nil)
      super()
