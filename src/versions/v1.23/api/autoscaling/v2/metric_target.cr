...
module K8S::Types::Api::Autoscaling::V2::MetricTarget; end

module K8S
  # Namespace holding the types for `Api::Autoscaling::V2::MetricTarget`.
  module Types::Api::Autoscaling::V2::MetricTarget
  ...
  class Api::Autoscaling::V2::MetricTarget < ::K8S::Types::Api::Autoscaling::V2::MetricTarget::Instance
