...
module K8S
  ...
  class Api::Autoscaling::V2::HorizontalPodAutoscalerBehavior < ::K8S::GenericObject
    include ::K8S::Types::Api::Autoscaling::V2::HorizontalPodAutoscalerBehavior
    k8s_object_accessor("scaleDown", scale_down : ::K8S::Api::Autoscaling::V2::HPAScalingRules, true, false, "scaleDown is scaling policy for scaling Down. If not set, the default value is to allow to scale down to minReplicas pods, with a 300 second stabilization window (i.e., the highest recommendation for the last 300sec is used).")
    k8s_object_accessor("scaleUp", scale_up : ::K8S::Api::Autoscaling::V2::HPAScalingRules, true, false, "scaleUp is scaling policy for scaling Up. If not set, the default value is the higher of:\n  * increase no more than 4 pods per 60 seconds\n  * double the number of pods per 60 seconds\nNo stabilization is used.")

    def initialize(*, scale_down : ::K8S::Api::Autoscaling::V2::HPAScalingRules? = nil, scale_up : ::K8S::Api::Autoscaling::V2::HPAScalingRules? = nil)
      super()
