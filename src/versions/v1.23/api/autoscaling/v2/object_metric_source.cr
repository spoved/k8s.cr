...
module K8S
  ...
  class Api::Autoscaling::V2::ObjectMetricSource < ::K8S::GenericObject
    ...
    def initialize(*, described_object : ::K8S::Api::Autoscaling::V2::CrossVersionObjectReference? = nil, metric : ::K8S::Api::Autoscaling::V2::MetricIdentifier? = nil, target : ::K8S::Api::Autoscaling::V2::MetricTarget? = nil)
      super()
