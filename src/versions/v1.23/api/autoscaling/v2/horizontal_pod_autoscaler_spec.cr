...
module K8S
  ...
  class Api::Autoscaling::V2::HorizontalPodAutoscalerSpec
    ...
    def initialize(*, @max_replicas : Int32, @scale_target_ref : Api::Autoscaling::V2::CrossVersionObjectReference, @behavior : Api::Autoscaling::V2::HorizontalPodAutoscalerBehavior | Nil = nil, @metrics : Array(Api::Autoscaling::V2::MetricSpec) | Nil = nil, @min_replicas : Int32 | Nil = nil)
    end
  end
end
