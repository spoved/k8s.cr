...
module K8S::Types::Api::Autoscaling::V2::ExternalMetricStatus; end

require "./metric_value_status"
require "./metric_identifier"

module K8S
  # Namespace holding the types for `Api::Autoscaling::V2::ExternalMetricStatus`.
  module Types::Api::Autoscaling::V2::ExternalMetricStatus
    alias ValueType = ::K8S::Api::Autoscaling::V2::MetricValueStatus | ::K8S::Api::Autoscaling::V2::MetricIdentifier | Nil
  ...
  class Api::Autoscaling::V2::ExternalMetricStatus < ::K8S::Types::Api::Autoscaling::V2::ExternalMetricStatus::Instance
    include ::K8S::Types::Api::Autoscaling::V2::ExternalMetricStatus
