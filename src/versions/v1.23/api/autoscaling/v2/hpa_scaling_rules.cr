...
module K8S
  ...
  @[::K8S::Properties(
    policies: {type: Array(Api::Autoscaling::V2::HPAScalingPolicy), nilable: true, key: "policies", getter: false, setter: false},
  ...
  class Api::Autoscaling::V2::HPAScalingRules
    ...
    property policies : Array(Api::Autoscaling::V2::HPAScalingPolicy) | Nil
    ...
    def initialize(*, @policies : Array(Api::Autoscaling::V2::HPAScalingPolicy) | Nil = nil, @select_policy : String | Nil = nil, @stabilization_window_seconds : Int32 | Nil = nil)
    end
  end
end
