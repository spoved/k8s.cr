...
module K8S
  ...
  module Types::Api::Autoscaling::V2::HPAScalingRules
    alias ValueType = ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy) | String | Int32 | Nil
  ...
  class Api::Autoscaling::V2::HPAScalingRules < ::K8S::Types::Api::Autoscaling::V2::HPAScalingRules::Instance
    include ::K8S::Types::Api::Autoscaling::V2::HPAScalingRules
    include ::K8S::Kubernetes::Object

    # policies is a list of potential scaling polices which can be used during scaling. At least one policy must be specified, otherwise the HPAScalingRules will be discarded as invalid
    def policies : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)?
      self.["policies"].as(::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)?)
    end

    # :ditto:
    def policies! : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)
      self.["policies"].as(::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)?).not_nil!
    end
    ...
    # :ditto:
    def policies=(value : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)?)
      self.["policies"] = value
    end
