...
module K8S::Types::Api::Autoscaling::V2::HPAScalingRules; end

require "./hpa_scaling_policy"

module K8S
  # Namespace holding the types for `Api::Autoscaling::V2::HPAScalingRules`.
  module Types::Api::Autoscaling::V2::HPAScalingRules
    # policies is a list of potential scaling polices which can be used during scaling. At least one policy must be specified, otherwise the HPAScalingRules will be discarded as invalid
    abstract def policies : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)?
    # :ditto:
    abstract def policies! : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)
    # :ditto:
    abstract def policies? : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)?
    # :ditto:
    abstract def policies=(value : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy))
  ...
  class Api::Autoscaling::V2::HPAScalingRules < ::K8S::GenericObject
    include ::K8S::Types::Api::Autoscaling::V2::HPAScalingRules
    k8s_object_accessor("policies", policies : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy), true, false, "policies is a list of potential scaling polices which can be used during scaling. At least one policy must be specified, otherwise the HPAScalingRules will be discarded as invalid")
    k8s_object_accessor("selectPolicy", select_policy : String, true, false, "selectPolicy is used to specify which policy should be used. If not set, the default value Max is used.")
    ...
    def initialize(*, policies : ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)? = nil, select_policy : String? = nil, stabilization_window_seconds : Int32? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      {key: "policies", accessor: "policies", nilable: true, read_only: false, default: nil, kind: ::Array(::K8S::Api::Autoscaling::V2::HPAScalingPolicy)},
