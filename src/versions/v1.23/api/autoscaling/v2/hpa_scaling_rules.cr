...
module K8S
  ...
  @[::K8S::Properties(
    ...
    select_policy: {key: "selectPolicy", accessor: "select_policy", kind: "String", nilable: true, default: nil, read_only: false, description: "selectPolicy is used to specify which policy should be used. If not set, the default value Max is used."},
