...
::K8S::Kubernetes::Resource.define_object("HorizontalPodAutoscalerStatus",
  ...
  properties: [
    ...
    {name: "conditions", kind: ::Array(::K8S::Api::Autoscaling::V2::HorizontalPodAutoscalerCondition), key: "conditions", nilable: true, read_only: false, description: "conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met."},
    {name: "current_metrics", kind: ::Array(::K8S::Api::Autoscaling::V2::MetricStatus), key: "currentMetrics", nilable: true, read_only: false, description: "currentMetrics is the last read state of the metrics used by this autoscaler."},
    {name: "current_replicas", kind: Int32, key: "currentReplicas", nilable: true, read_only: false, description: "currentReplicas is current number of replicas of pods managed by this autoscaler, as last seen by the autoscaler."},
