...
module K8S
  ...
  class Api::Autoscaling::V2::HorizontalPodAutoscalerStatus
    ...
    def initialize(*, @desired_replicas : Int32, @conditions : Array | Nil = nil, @current_metrics : Array | Nil = nil, @current_replicas : Int32 | Nil = nil, @last_scale_time : Time | Nil = nil, @observed_generation : Int32 | Nil = nil)
    end
  end
end
