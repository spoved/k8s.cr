...
module K8S
  ...
  class Api::Core::V1::QuobyteVolumeSource < ::K8S::GenericObject
    ...
    k8s_object_accessor("tenant", tenant : String, true, false, "Tenant owning the given Quobyte volume in the Backend Used with dynamically provisioned Quobyte volumes, value is set by the plugin")
    ...
    def initialize(*, group : String? = nil, read_only : ::Bool? = nil, registry : String? = nil, tenant : String? = nil, user : String? = nil, volume : String? = nil)
      super()
      self.["group"] = group
