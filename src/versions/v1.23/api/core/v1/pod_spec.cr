...
module K8S
  ...
  @[::K8S::Properties(
    ...
    dns_policy: {key: "dnsPolicy", accessor: "dns_policy", kind: "String", nilable: true, default: nil, read_only: false, description: "Set DNS policy for the pod. Defaults to \"ClusterFirst\". Valid values are 'ClusterFirstWithHostNet', 'ClusterFirst', 'Default' or 'None'. DNS parameters given in DNSConfig will be merged with the policy selected with DNSPolicy. To have DNS options set along with hostNetwork, you have to specify DNS policy explicitly to 'ClusterFirstWithHostNet'.\n\nPossible enum values:\n - `\"ClusterFirst\"` indicates that the pod should use cluster DNS first unless hostNetwork is true, if it is available, then fall back on the default (as determined by kubelet) DNS settings.\n - `\"ClusterFirstWithHostNet\"` indicates that the pod should use cluster DNS first, if it is available, then fall back on the default (as determined by kubelet) DNS settings.\n - `\"Default\"` indicates that the pod should use the default (as determined by kubelet) DNS settings.\n - `\"None\"` indicates that the pod should use empty DNS settings. DNS parameters such as nameservers and search paths should be defined via DNSConfig.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    ephemeral_containers: {key: "ephemeralContainers", accessor: "ephemeral_containers", kind: "::Array(::K8S::Api::Core::V1::EphemeralContainer)", nilable: true, default: nil, read_only: false, description: "List of ephemeral containers run in this pod. Ephemeral containers may be run in an existing pod to perform user-initiated actions such as debugging. This list cannot be specified when creating a pod, and it cannot be modified by updating the pod spec. In order to add an ephemeral container to an existing pod, use the pod's ephemeralcontainers subresource. This field is beta-level and available on clusters that haven't disabled the EphemeralContainers feature gate.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    preemption_policy: {key: "preemptionPolicy", accessor: "preemption_policy", kind: "String", nilable: true, default: nil, read_only: false, description: "PreemptionPolicy is the Policy for preempting pods with lower priority. One of Never, PreemptLowerPriority. Defaults to PreemptLowerPriority if unset. This field is beta-level, gated by the NonPreemptingPriority feature-gate.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    set_hostname_as_fqd_n: {key: "setHostnameAsFQDN", accessor: "set_hostname_as_fqd_n", kind: "::Bool", nilable: true, default: nil, read_only: false, description: "If true the pod's hostname will be configured as the pod's FQDN, rather than the leaf name (the default). In Linux containers, this means setting the FQDN in the hostname field of the kernel (the nodename field of struct utsname). In Windows containers, this means setting the registry value of hostname for the registry key HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters to FQDN. If a pod does not have FQDN, this has no effect. Default to false.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Core::V1::PodSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("ephemeralContainers", ephemeral_containers : ::Array(::K8S::Api::Core::V1::EphemeralContainer), true, false, "List of ephemeral containers run in this pod. Ephemeral containers may be run in an existing pod to perform user-initiated actions such as debugging. This list cannot be specified when creating a pod, and it cannot be modified by updating the pod spec. In order to add an ephemeral container to an existing pod, use the pod's ephemeralcontainers subresource. This field is beta-level and available on clusters that haven't disabled the EphemeralContainers feature gate.")
    ...
    k8s_object_accessor("os", os : ::K8S::Api::Core::V1::PodOS, true, false, "Specifies the OS of the containers in the pod. Some pod and container fields are restricted if this is set.\n\nIf the OS field is set to linux, the following fields must be unset: -securityContext.windowsOptions\n\nIf the OS field is set to windows, following fields must be unset: - spec.hostPID - spec.hostIPC - spec.securityContext.seLinuxOptions - spec.securityContext.seccompProfile - spec.securityContext.fsGroup - spec.securityContext.fsGroupChangePolicy - spec.securityContext.sysctls - spec.shareProcessNamespace - spec.securityContext.runAsUser - spec.securityContext.runAsGroup - spec.securityContext.supplementalGroups - spec.containers[*].securityContext.seLinuxOptions - spec.containers[*].securityContext.seccompProfile - spec.containers[*].securityContext.capabilities - spec.containers[*].securityContext.readOnlyRootFilesystem - spec.containers[*].securityContext.privileged - spec.containers[*].securityContext.allowPrivilegeEscalation - spec.containers[*].securityContext.procMount - spec.containers[*].securityContext.runAsUser - spec.containers[*].securityContext.runAsGroup This is an alpha field and requires the IdentifyPodOS feature")
    k8s_object_accessor("overhead", overhead : ::Hash(String, ::Int32 | ::String), true, false, "Overhead represents the resource overhead associated with running a pod for a given RuntimeClass. This field will be autopopulated at admission time by the RuntimeClass admission controller. If the RuntimeClass admission controller is enabled, overhead must not be set in Pod create requests. The RuntimeClass admission controller will reject Pod create requests which have the overhead already set. If RuntimeClass is configured and selected in the PodSpec, Overhead will be set to the value defined in the corresponding RuntimeClass, otherwise it will remain unset and treated as zero. More info: [https://git.k8s.io/enhancements/keps/sig-node/688-pod-overhead/README.md This field is beta-level as of Kubernetes v1.18, and is only honored by servers that enable the PodOverhead feature.](https://git.k8s.io/enhancements/keps/sig-node/688-pod-overhead/README.md This field is beta-level as of Kubernetes v1.18, and is only honored by servers that enable the PodOverhead feature.)")
    k8s_object_accessor("preemptionPolicy", preemption_policy : String, true, false, "PreemptionPolicy is the Policy for preempting pods with lower priority. One of Never, PreemptLowerPriority. Defaults to PreemptLowerPriority if unset. This field is beta-level, gated by the NonPreemptingPriority feature-gate.")
    ...
    k8s_object_accessor("setHostnameAsFQDN", set_hostname_as_fqd_n : ::Bool, true, false, "If true the pod's hostname will be configured as the pod's FQDN, rather than the leaf name (the default). In Linux containers, this means setting the FQDN in the hostname field of the kernel (the nodename field of struct utsname). In Windows containers, this means setting the registry value of hostname for the registry key HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters to FQDN. If a pod does not have FQDN, this has no effect. Default to false.")
    ...
    k8s_object_accessor("topologySpreadConstraints", topology_spread_constraints : ::Array(::K8S::Api::Core::V1::TopologySpreadConstraint), true, false, "TopologySpreadConstraints describes how a group of pods ought to spread across topology domains. Scheduler will schedule pods in a way which abides by the constraints. All topologySpreadConstraints are ANDed.")
    ...
    def initialize(*, active_deadline_seconds : Int32? = nil, affinity : ::K8S::Api::Core::V1::Affinity? = nil, automount_service_account_token : ::Bool? = nil, containers : ::Array(::K8S::Api::Core::V1::Container)? = nil, dns_config : ::K8S::Api::Core::V1::PodDNSConfig? = nil, dns_policy : String? = nil, enable_service_links : ::Bool? = nil, ephemeral_containers : ::Array(::K8S::Api::Core::V1::EphemeralContainer)? = nil, host_aliases : ::Array(::K8S::Api::Core::V1::HostAlias)? = nil, host_ipc : ::Bool? = nil, host_network : ::Bool? = nil, host_pid : ::Bool? = nil, hostname : String? = nil, image_pull_secrets : ::Array(::K8S::Api::Core::V1::LocalObjectReference)? = nil, init_containers : ::Array(::K8S::Api::Core::V1::Container)? = nil, node_name : String? = nil, node_selector : ::Hash(String, String)? = nil, os : ::K8S::Api::Core::V1::PodOS? = nil, overhead : ::Hash(String, ::Int32 | ::String)? = nil, preemption_policy : String? = nil, priority : Int32? = nil, priority_class_name : String? = nil, readiness_gates : ::Array(::K8S::Api::Core::V1::PodReadinessGate)? = nil, restart_policy : String? = nil, runtime_class_name : String? = nil, scheduler_name : String? = nil, security_context : ::K8S::Api::Core::V1::PodSecurityContext? = nil, service_account : String? = nil, service_account_name : String? = nil, set_hostname_as_fqd_n : ::Bool? = nil, share_process_namespace : ::Bool? = nil, subdomain : String? = nil, termination_grace_period_seconds : Int32? = nil, tolerations : ::Array(::K8S::Api::Core::V1::Toleration)? = nil, topology_spread_constraints : ::Array(::K8S::Api::Core::V1::TopologySpreadConstraint)? = nil, volumes : ::Array(::K8S::Api::Core::V1::Volume)? = nil)
      super()
      ...
      self.["setHostnameAsFQDN"] = set_hostname_as_fqd_n
