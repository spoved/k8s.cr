...
module K8S
  ...
  @[::K8S::Properties(
    ...
    os: {type: Api::Core::V1::PodOS, nilable: true, key: "os", getter: false, setter: false},
  ...
  class Api::Core::V1::PodSpec
    ...
    @[::YAML::Field(key: "os", emit_null: false)]
    property os : Api::Core::V1::PodOS | Nil
    ...
    def initialize(*, @containers : Array(Api::Core::V1::Container), @active_deadline_seconds : Int32 | Nil = nil, @affinity : Api::Core::V1::Affinity | Nil = nil, @automount_service_account_token : Bool | Nil = nil, @dns_config : Api::Core::V1::PodDNSConfig | Nil = nil, @dns_policy : String | Nil = nil, @enable_service_links : Bool | Nil = nil, @ephemeral_containers : Array(Api::Core::V1::EphemeralContainer) | Nil = nil, @host_aliases : Array(Api::Core::V1::HostAlias) | Nil = nil, @host_ipc : Bool | Nil = nil, @host_network : Bool | Nil = nil, @host_pid : Bool | Nil = nil, @hostname : String | Nil = nil, @image_pull_secrets : Array(Api::Core::V1::LocalObjectReference) | Nil = nil, @init_containers : Array(Api::Core::V1::Container) | Nil = nil, @node_name : String | Nil = nil, @node_selector : Hash(String, String) | Nil = nil, @os : Api::Core::V1::PodOS | Nil = nil, @overhead : Hash(String, Int32 | String) | Nil = nil, @preemption_policy : String | Nil = nil, @priority : Int32 | Nil = nil, @priority_class_name : String | Nil = nil, @readiness_gates : Array(Api::Core::V1::PodReadinessGate) | Nil = nil, @restart_policy : String | Nil = nil, @runtime_class_name : String | Nil = nil, @scheduler_name : String | Nil = nil, @security_context : Api::Core::V1::PodSecurityContext | Nil = nil, @service_account : String | Nil = nil, @service_account_name : String | Nil = nil, @set_hostname_as_fqd_n : Bool | Nil = nil, @share_process_namespace : Bool | Nil = nil, @subdomain : String | Nil = nil, @termination_grace_period_seconds : Int32 | Nil = nil, @tolerations : Array(Api::Core::V1::Toleration) | Nil = nil, @topology_spread_constraints : Array(Api::Core::V1::TopologySpreadConstraint) | Nil = nil, @volumes : Array(Api::Core::V1::Volume) | Nil = nil)
    end
  end
end
