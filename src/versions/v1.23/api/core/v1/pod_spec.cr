...
module K8S
  ...
  module Types::Api::Core::V1::PodSpec
    ...
    abstract def os : ::K8S::Api::Core::V1::PodOS?
    # :ditto:
    abstract def os! : ::K8S::Api::Core::V1::PodOS
    # :ditto:
    abstract def os? : ::K8S::Api::Core::V1::PodOS?
    # :ditto:
    abstract def os=(value : ::K8S::Api::Core::V1::PodOS?)
  ...
  @[::K8S::Properties(
    ...
    os: {key: "os", accessor: "os", kind: "::K8S::Api::Core::V1::PodOS", nilable: true, default: nil, read_only: false, description: "Specifies the OS of the containers in the pod. Some pod and container fields are restricted if this is set.\n\nIf the OS field is set to linux, the following fields must be unset: -securityContext.windowsOptions\n\nIf the OS field is set to windows, following fields must be unset: - spec.hostPID - spec.hostIPC - spec.securityContext.seLinuxOptions - spec.securityContext.seccompProfile - spec.securityContext.fsGroup - spec.securityContext.fsGroupChangePolicy - spec.securityContext.sysctls - spec.shareProcessNamespace - spec.securityContext.runAsUser - spec.securityContext.runAsGroup - spec.securityContext.supplementalGroups - spec.containers[*].securityContext.seLinuxOptions - spec.containers[*].securityContext.seccompProfile - spec.containers[*].securityContext.capabilities - spec.containers[*].securityContext.readOnlyRootFilesystem - spec.containers[*].securityContext.privileged - spec.containers[*].securityContext.allowPrivilegeEscalation - spec.containers[*].securityContext.procMount - spec.containers[*].securityContext.runAsUser - spec.containers[*].securityContext.runAsGroup This is an alpha field and requires the IdentifyPodOS feature"},
  ...
  class Api::Core::V1::PodSpec < ::K8S::Types::Api::Core::V1::PodSpec::Instance
    ...
    #
    # If the OS field is set to windows, following fields must be unset: - spec.hostPID - spec.hostIPC - spec.securityContext.seLinuxOptions - spec.securityContext.seccompProfile - spec.securityContext.fsGroup - spec.securityContext.fsGroupChangePolicy - spec.securityContext.sysctls - spec.shareProcessNamespace - spec.securityContext.runAsUser - spec.securityContext.runAsGroup - spec.securityContext.supplementalGroups - spec.containers[*].securityContext.seLinuxOptions - spec.containers[*].securityContext.seccompProfile - spec.containers[*].securityContext.capabilities - spec.containers[*].securityContext.readOnlyRootFilesystem - spec.containers[*].securityContext.privileged - spec.containers[*].securityContext.allowPrivilegeEscalation - spec.containers[*].securityContext.procMount - spec.containers[*].securityContext.runAsUser - spec.containers[*].securityContext.runAsGroup This is an alpha field and requires the IdentifyPodOS feature
    def os : ::K8S::Api::Core::V1::PodOS?
      self.["os"].as(::K8S::Api::Core::V1::PodOS?)
    end

    # :ditto:
    def os! : ::K8S::Api::Core::V1::PodOS
      self.["os"].as(::K8S::Api::Core::V1::PodOS?).not_nil!
    end
    ...
    # :ditto:
    def os=(value : ::K8S::Api::Core::V1::PodOS?)
      self.["os"] = value
    end
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        ...
        { key: "os", accessor: "os", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Core::V1::PodOS },
