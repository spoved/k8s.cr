...
module K8S
  ...
  class Api::Core::V1::PodSpec
    ...
    def initialize(*, @containers : Array, @active_deadline_seconds : Int32 | Nil = nil, @affinity : Api::Core::V1::Affinity | Nil = nil, @automount_service_account_token : Bool | Nil = nil, @dns_config : Api::Core::V1::PodDNSConfig | Nil = nil, @dns_policy : String | Nil = nil, @enable_service_links : Bool | Nil = nil, @ephemeral_containers : Array | Nil = nil, @host_aliases : Array | Nil = nil, @host_ipc : Bool | Nil = nil, @host_network : Bool | Nil = nil, @host_pid : Bool | Nil = nil, @hostname : String | Nil = nil, @image_pull_secrets : Array | Nil = nil, @init_containers : Array | Nil = nil, @node_name : String | Nil = nil, @node_selector : Hash(String, String) | Nil = nil, @os : Api::Core::V1::PodOS | Nil = nil, @overhead : Hash(String, String) | Nil = nil, @preemption_policy : String | Nil = nil, @priority : Int32 | Nil = nil, @priority_class_name : String | Nil = nil, @readiness_gates : Array | Nil = nil, @restart_policy : String | Nil = nil, @runtime_class_name : String | Nil = nil, @scheduler_name : String | Nil = nil, @security_context : Api::Core::V1::PodSecurityContext | Nil = nil, @service_account : String | Nil = nil, @service_account_name : String | Nil = nil, @set_hostname_as_fqd_n : Bool | Nil = nil, @share_process_namespace : Bool | Nil = nil, @subdomain : String | Nil = nil, @termination_grace_period_seconds : Int32 | Nil = nil, @tolerations : Array | Nil = nil, @topology_spread_constraints : Array | Nil = nil, @volumes : Array | Nil = nil)
    end
  end
end
