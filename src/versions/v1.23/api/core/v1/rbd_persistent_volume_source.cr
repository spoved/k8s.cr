...
module K8S
  ...
  class Api::Core::V1::RBDPersistentVolumeSource < ::K8S::GenericObject
    ...
    k8s_object_accessor("secretRef", secret_ref : ::K8S::Api::Core::V1::SecretReference, true, false, "SecretRef is name of the authentication secret for RBDUser. If provided overrides keyring. Default is nil. More info: [https://examples.k8s.io/volumes/rbd/README.md#how-to-use-it](https://examples.k8s.io/volumes/rbd/README.md#how-to-use-it)")
