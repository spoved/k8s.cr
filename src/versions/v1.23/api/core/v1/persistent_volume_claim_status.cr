...
module K8S
  ...
  class Api::Core::V1::PersistentVolumeClaimStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("allocatedResources", allocated_resources : ::Hash(String, ::Int32 | ::String), true, false, "The storage resource within AllocatedResources tracks the capacity allocated to a PVC. It may be larger than the actual capacity when a volume expansion operation is requested. For storage quota, the larger value from allocatedResources and PVC.spec.resources is used. If allocatedResources is not set, PVC.spec.resources alone is used for quota calculation. If a volume expansion capacity request is lowered, allocatedResources is only lowered if there are no expansion operations in progress and if the actual volume capacity is equal or lower than the requested capacity. This is an alpha field and requires enabling RecoverVolumeExpansionFailure feature.")
    ...
    k8s_object_accessor("resizeStatus", resize_status : String, true, false, "ResizeStatus stores status of resize operation. ResizeStatus is not set by default but when expansion is complete resizeStatus is set to empty string by resize controller or kubelet. This is an alpha field and requires enabling RecoverVolumeExpansionFailure feature.")

    def initialize(*, access_modes : ::Array(String)? = nil, allocated_resources : ::Hash(String, ::Int32 | ::String)? = nil, capacity : ::Hash(String, ::Int32 | ::String)? = nil, conditions : ::Array(::K8S::Api::Core::V1::PersistentVolumeClaimCondition)? = nil, phase : String? = nil, resize_status : String? = nil)
      super()
      self.["accessModes"] = access_modes
      self.["allocatedResources"] = allocated_resources
      self.["capacity"] = capacity
      self.["conditions"] = conditions
      self.["phase"] = phase
      self.["resizeStatus"] = resize_status
    end
