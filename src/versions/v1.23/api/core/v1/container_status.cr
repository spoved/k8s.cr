...
module K8S
  ...
  @[::K8S::Properties(
    container_id: {key: "containerID", accessor: "container_id", kind: "String", nilable: true, default: nil, read_only: false, description: "Container's ID in the format 'docker://<container_id>'."},
    image: {key: "image", accessor: "image", kind: "String", nilable: false, default: nil, read_only: false, description: "The image the container is running. More info: [https://kubernetes.io/docs/concepts/containers/images.](https://kubernetes.io/docs/concepts/containers/images.)"},
    image_id: {key: "imageID", accessor: "image_id", kind: "String", nilable: false, default: nil, read_only: false, description: "ImageID of the container's image."},
    last_state: {key: "lastState", accessor: "last_state", kind: "::K8S::Api::Core::V1::ContainerState", nilable: true, default: nil, read_only: false, description: "Details about the container's last termination condition."},
    name: {key: "name", accessor: "name", kind: "String", nilable: false, default: nil, read_only: false, description: "This must be a DNS_LABEL. Each container in a pod must have a unique name. Cannot be updated."},
    ready: {key: "ready", accessor: "ready", kind: "::Bool", nilable: false, default: nil, read_only: false, description: "Specifies whether the container has passed its readiness probe."},
    restart_count: {key: "restartCount", accessor: "restart_count", kind: "Int32", nilable: false, default: nil, read_only: false, description: "The number of times the container has been restarted."},
    ...
    state: {key: "state", accessor: "state", kind: "::K8S::Api::Core::V1::ContainerState", nilable: true, default: nil, read_only: false, description: "Details about the container's current condition."},
  )]
