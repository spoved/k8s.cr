...
module K8S
  ...
  @[::K8S::Properties(
    ...
    restart_count: {key: "restartCount", accessor: "restart_count", kind: "Int32", nilable: false, default: nil, read_only: false, description: "The number of times the container has been restarted.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Core::V1::ContainerStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("restartCount", restart_count : Int32, false, false, "The number of times the container has been restarted.")
