...
::K8S::Kubernetes::Resource.define_object("Probe",
  ...
  properties: [
    ...
    {name: "grpc", kind: ::K8S::Api::Core::V1::GRPCAction, key: "grpc", nilable: true, read_only: false, description: "GRPC specifies an action involving a GRPC port. This is an alpha field and requires enabling GRPCContainerProbe feature gate."},
    ...
    {name: "tcp_socket", kind: ::K8S::Api::Core::V1::TCPSocketAction, key: "tcpSocket", nilable: true, read_only: false, description: "TCPSocket specifies an action involving a TCP port."},
