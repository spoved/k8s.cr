...
module K8S
  ...
  module Types::Api::Core::V1::Probe
    alias ValueType = ::K8S::Api::Core::V1::ExecAction | Int32 | ::K8S::Api::Core::V1::GRPCAction | ::K8S::Api::Core::V1::HTTPGetAction | ::K8S::Api::Core::V1::TCPSocketAction | Nil
    ...
    abstract def grpc : ::K8S::Api::Core::V1::GRPCAction?
    # :ditto:
    abstract def grpc! : ::K8S::Api::Core::V1::GRPCAction
    # :ditto:
    abstract def grpc? : ::K8S::Api::Core::V1::GRPCAction?
    # :ditto:
    abstract def grpc=(value : ::K8S::Api::Core::V1::GRPCAction?)
  ...
  @[::K8S::Properties(
    ...
    grpc: {key: "grpc", accessor: "grpc", kind: "::K8S::Api::Core::V1::GRPCAction", nilable: true, default: nil, read_only: false, description: "GRPC specifies an action involving a GRPC port. This is an alpha field and requires enabling GRPCContainerProbe feature gate."},
    ...
    tcp_socket: {key: "tcpSocket", accessor: "tcp_socket", kind: "::K8S::Api::Core::V1::TCPSocketAction", nilable: true, default: nil, read_only: false, description: "TCPSocket specifies an action involving a TCP port."},
  ...
  class Api::Core::V1::Probe < ::K8S::Types::Api::Core::V1::Probe::Instance
    ...
    # GRPC specifies an action involving a GRPC port. This is an alpha field and requires enabling GRPCContainerProbe feature gate.
    def grpc : ::K8S::Api::Core::V1::GRPCAction?
      self.["grpc"].as(::K8S::Api::Core::V1::GRPCAction?)
    end

    # :ditto:
    def grpc! : ::K8S::Api::Core::V1::GRPCAction
      self.["grpc"].as(::K8S::Api::Core::V1::GRPCAction?).not_nil!
    end
    ...
    # :ditto:
    def grpc=(value : ::K8S::Api::Core::V1::GRPCAction?)
      self.["grpc"] = value
    end
    ...
    macro finished
      ::K8S::Kubernetes::Resource.define_serialize_methods([
        ...
        { key: "grpc", accessor: "grpc", nilable: true, read_only: false, default: nil, kind: ::K8S::Api::Core::V1::GRPCAction },
