...
module K8S
  ...
  @[::K8S::Properties(
    ...
    grpc: {key: "grpc", accessor: "grpc", kind: "::K8S::Api::Core::V1::GRPCAction", nilable: true, default: nil, read_only: false, description: "GRPC specifies an action involving a GRPC port. This is an alpha field and requires enabling GRPCContainerProbe feature gate.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Core::V1::Probe < ::K8S::GenericObject
    ...
    k8s_object_accessor("grpc", grpc : ::K8S::Api::Core::V1::GRPCAction, true, false, "GRPC specifies an action involving a GRPC port. This is an alpha field and requires enabling GRPCContainerProbe feature gate.")
    ...
    k8s_object_accessor("tcpSocket", tcp_socket : ::K8S::Api::Core::V1::TCPSocketAction, true, false, "TCPSocket specifies an action involving a TCP port.")
