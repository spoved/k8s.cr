...
module K8S
  ...
  class Api::Core::V1::NodeCondition
    ...
    @[::JSON::Field(key: "lastHeartbeatTime", emit_null: false, converter: K8S::TimeFormat.new)]
    @[::YAML::Field(key: "lastHeartbeatTime", emit_null: false, converter: K8S::TimeFormat.new)]
