...
module K8S
  ...
  module Types::Api::Core::V1::NodeStatus
    ...
    #  - `"Pending"` means the node has been [[created/added by the system, but not configured.](created/added by the system, but not configured.)]([created/added by the system, but not configured.](created/added by the system, but not configured.))
  ...
  @[::K8S::Properties(
    ...
    phase: {key: "phase", accessor: "phase", kind: "String", nilable: true, default: nil, read_only: false, description: "NodePhase is the recently observed lifecycle phase of the node. More info: [https://kubernetes.io/docs/concepts/nodes/node/#phase The field is never populated, and now is deprecated.](https://kubernetes.io/docs/concepts/nodes/node/#phase The field is never populated, and now is deprecated.)\n\nPossible enum values:\n - `\"Pending\"` means the node has been [created/added by the system, but not configured.](created/added by the system, but not configured.)\n - `\"Running\"` means the node has been configured and has Kubernetes components running.\n - `\"Terminated\"` means the node has been removed from the cluster.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
