...
module K8S
  ...
  @[::K8S::Properties(
    ...
    seccomp_profile: {key: "seccompProfile", accessor: "seccomp_profile", kind: "::K8S::Api::Core::V1::SeccompProfile", nilable: true, default: nil, read_only: false, description: "The seccomp options to use by the containers in this pod. Note that this field cannot be set when spec.os.name is windows."},
