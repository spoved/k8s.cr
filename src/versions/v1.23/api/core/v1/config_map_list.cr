...
module K8S
  ...
  @[::K8S::Action(name: "list", verb: "get",
    path: "/api/v1/configmaps", toplevel: true,
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "binary_data", type: Hash(String, String) | Nil, default: nil},
           {name: "data", type: Hash(String, String) | Nil, default: nil},
           {name: "immutable", type: Bool | Nil, default: nil},
  ...
  class Api::Core::V1::ConfigMapList < ::K8S::Kubernetes::ResourceList(Api::Core::V1::ConfigMap)
    ...
    def initialize(*, @items : Array(Api::Core::V1::ConfigMap), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
