...
module K8S::Types::Api::Storage::V1::CSINodeDriver; end

require "./volume_node_resources"

module K8S
  # Namespace holding the types for `Api::Storage::V1::CSINodeDriver`.
  module Types::Api::Storage::V1::CSINodeDriver
    alias ValueType = ::K8S::Api::Storage::V1::VolumeNodeResources | String | ::Array(String) | Nil
  ...
  @[::K8S::Properties(
    allocatable: {key: "allocatable", accessor: "allocatable", kind: "::K8S::Api::Storage::V1::VolumeNodeResources", nilable: true, default: nil, read_only: false, description: "allocatable represents the volume resources of a node that are available for scheduling. This field is beta.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Storage::V1::CSINodeDriver < ::K8S::Types::Api::Storage::V1::CSINodeDriver::Instance
