...
module K8S
  ...
  class Api::Storage::V1::CSIDriver < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("spec", spec : ::K8S::Api::Storage::V1::CSIDriverSpec, false, false, "Specification of the CSI Driver.")

    def initialize(*, api_version : String? = "storage/v1", kind : String? = "CSIDriver", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, spec : ::K8S::Api::Storage::V1::CSIDriverSpec? = nil)
      super()
