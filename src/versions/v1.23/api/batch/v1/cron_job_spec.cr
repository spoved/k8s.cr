...
module K8S
  ...
  class Api::Batch::V1::CronJobSpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("failedJobsHistoryLimit", failed_jobs_history_limit : Int32, true, false, "The number of failed finished jobs to retain. Value must be non-negative integer. Defaults to 1.")
    k8s_object_accessor("jobTemplate", job_template : ::K8S::Api::Batch::V1::JobTemplateSpec, false, false, "Specifies the job that will be created when executing a CronJob.")
    ...
    k8s_object_accessor("successfulJobsHistoryLimit", successful_jobs_history_limit : Int32, true, false, "The number of successful finished jobs to retain. Value must be non-negative integer. Defaults to 3.")
    ...
    def initialize(*, concurrency_policy : String? = nil, failed_jobs_history_limit : Int32? = nil, job_template : ::K8S::Api::Batch::V1::JobTemplateSpec? = nil, schedule : String? = nil, starting_deadline_seconds : Int32? = nil, successful_jobs_history_limit : Int32? = nil, suspend : ::Bool? = nil)
      super()
