...
module K8S::Types::Api::Batch::V1::CronJob; end
...
module K8S
  ...
  module Types::Api::Batch::V1::CronJob
    alias ValueType = String | ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta | ::K8S::Api::Batch::V1::CronJobSpec | ::K8S::Api::Batch::V1::CronJobStatus | Nil
  ...
  @[::K8S::GroupVersionKind(group: "batch", kind: "CronJob", version: "v1", full: "io.k8s.api.batch.v1.CronJob")]
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Batch::V1::CronJobSpec", nilable: true, default: nil, read_only: false, description: "Specification of the desired behavior of a cron job, including the schedule. More info: [https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status)", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Batch::V1::CronJobStatus", nilable: true, default: nil, read_only: false, description: "Current status of a cron job. More info: [https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status)", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Batch::V1::CronJob < ::K8S::Types::Api::Batch::V1::CronJob::Instance
  ...
  module Resources::Batch::V1
    alias CronJob = ::K8S::Api::Batch::V1::CronJob
  end
end
