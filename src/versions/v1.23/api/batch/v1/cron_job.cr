...
module K8S
  ...
  @[::K8S::Properties(
    ...
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Batch::V1::CronJobStatus", nilable: true, default: nil, read_only: false, description: "Current status of a cron job. More info: [https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status)"},
  )]
