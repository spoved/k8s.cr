...
module K8S
  ...
  @[::K8S::Properties(
    ...
    ready: {type: Int32, nilable: true, key: "ready", getter: false, setter: false},
  ...
  class Api::Batch::V1::JobStatus
    ...
    def initialize(*, @active : Int32 | Nil = nil, @completed_indexes : String | Nil = nil, @completion_time : Time | Nil = nil, @conditions : Array(Api::Batch::V1::JobCondition) | Nil = nil, @failed : Int32 | Nil = nil, @ready : Int32 | Nil = nil, @start_time : Time | Nil = nil, @succeeded : Int32 | Nil = nil, @uncounted_terminated_pods : Api::Batch::V1::UncountedTerminatedPods | Nil = nil)
    end
  end
end
