...
module K8S
  ...
  @[::K8S::Properties(
    active: {key: "active", accessor: "active", kind: "Int32", nilable: true, default: nil, read_only: false, description: "The number of pending and running pods."},
