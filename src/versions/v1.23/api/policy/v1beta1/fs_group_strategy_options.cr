...
module K8S
  ...
  class Api::Policy::V1beta1::FSGroupStrategyOptions < ::K8S::GenericObject
    ...
    k8s_object_accessor("ranges", ranges : ::Array(::K8S::Api::Policy::V1beta1::IDRange), true, false, "ranges are the allowed ranges of fs groups.  If you would like to force a single fs group then supply a single range with the same start and end. Required for MustRunAs.")
