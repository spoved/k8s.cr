...
module K8S
  ...
  class Api::Policy::V1beta1::PodSecurityPolicyList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy), false, false, "items is a list of schema objects.")

    def initialize(*, api_version : String? = "policy/v1beta1", kind : String? = "PodSecurityPolicyList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Policy::V1beta1::PodSecurityPolicy)? = nil)
      super()
