...
module K8S::Types::Api::Policy::V1::Eviction; end

require "../../../apimachinery/apis/meta/v1/object_meta"
require "../../../apimachinery/apis/meta/v1/delete_options"

module K8S
  # Namespace holding the types for `Api::Policy::V1::Eviction`.
  module Types::Api::Policy::V1::Eviction
    ...
    abstract def delete_options : ::K8S::Apimachinery::Apis::Meta::V1::DeleteOptions?
    # :ditto:
    abstract def delete_options! : ::K8S::Apimachinery::Apis::Meta::V1::DeleteOptions
    # :ditto:
    abstract def delete_options? : ::K8S::Apimachinery::Apis::Meta::V1::DeleteOptions?
    # :ditto:
    abstract def delete_options=(value : ::K8S::Apimachinery::Apis::Meta::V1::DeleteOptions)
  end
  ...
  @[::K8S::GroupVersionKind(group: "policy", kind: "Eviction", version: "v1", full: "io.k8s.api.policy.v1.Eviction")]
  @[::K8S::Properties(
    ...
    kind: {key: "kind", accessor: "kind", kind: "String", nilable: false, default: "Eviction", read_only: true, description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Policy::V1::Eviction < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("deleteOptions", delete_options : ::K8S::Apimachinery::Apis::Meta::V1::DeleteOptions, true, false, "DeleteOptions may be provided")

    def initialize(*, api_version : String? = "policy/v1", kind : String? = "Eviction", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, delete_options : ::K8S::Apimachinery::Apis::Meta::V1::DeleteOptions? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "kind", accessor: "kind", nilable: false, read_only: true, default: "Eviction", kind: String},
      {key: "metadata", accessor: "metadata", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta},
      {key: "deleteOptions", accessor: "delete_options", nilable: true, read_only: false, default: nil, kind: ::K8S::Apimachinery::Apis::Meta::V1::DeleteOptions},
    ])
  end
