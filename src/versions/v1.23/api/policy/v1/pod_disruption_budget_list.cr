...
module K8S::Types::Api::Policy::V1::PodDisruptionBudgetList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./pod_disruption_budget"

module K8S
  # Namespace holding the types for `Api::Policy::V1::PodDisruptionBudgetList`.
  module Types::Api::Policy::V1::PodDisruptionBudgetList
    ...
    abstract def items : Array(::K8S::Api::Policy::V1::PodDisruptionBudget)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Policy::V1::PodDisruptionBudget)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Policy::V1::PodDisruptionBudget)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Policy::V1::PodDisruptionBudget))
  end

  # PodDisruptionBudgetList is a collection of PodDisruptionBudgets.
  @[::K8S::GroupVersionKind(group: "policy", kind: "PodDisruptionBudgetList", version: "v1", full: "io.k8s.api.policy.v1.PodDisruptionBudgetList")]
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Policy::V1::PodDisruptionBudget)", nilable: false, default: nil, read_only: false, description: "Items is a list of PodDisruptionBudgets", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Policy::V1::PodDisruptionBudgetList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Policy::V1::PodDisruptionBudget)
    include ::K8S::Types::Api::Policy::V1::PodDisruptionBudgetList
    k8s_object_accessor("apiVersion", api_version : String = "policy/v1", false, true, "APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources))")
    k8s_object_accessor("kind", kind : String = "PodDisruptionBudgetList", false, true, "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: [[https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds)](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds](https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds))")
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Policy::V1::PodDisruptionBudget), false, false, "Items is a list of PodDisruptionBudgets")

    def initialize(*, api_version : String? = "policy/v1", kind : String? = "PodDisruptionBudgetList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Policy::V1::PodDisruptionBudget)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Policy::V1::PodDisruptionBudget)},
    ])
  end
end
