...
module K8S
  ...
  class Api::Apps::V1::ReplicaSetStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("readyReplicas", ready_replicas : Int32, true, false, "readyReplicas is the number of pods targeted by this ReplicaSet with a Ready Condition.")
