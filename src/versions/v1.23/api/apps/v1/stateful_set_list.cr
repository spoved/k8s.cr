...
module K8S::Types::Api::Apps::V1::StatefulSetList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./stateful_set"

module K8S
  # Namespace holding the types for `Api::Apps::V1::StatefulSetList`.
  module Types::Api::Apps::V1::StatefulSetList
    ...
    abstract def items : Array(::K8S::Api::Apps::V1::StatefulSet)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Apps::V1::StatefulSet)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Apps::V1::StatefulSet)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Apps::V1::StatefulSet))
  end

  # StatefulSetList is a collection of StatefulSets.
  @[::K8S::GroupVersionKind(group: "apps", kind: "StatefulSetList", version: "v1", full: "io.k8s.api.apps.v1.StatefulSetList")]
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Apps::V1::StatefulSet)", nilable: false, default: nil, read_only: false, description: "Items is the list of stateful sets.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Apps::V1::StatefulSetList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Apps::V1::StatefulSet)
    include ::K8S::Types::Api::Apps::V1::StatefulSetList
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Apps::V1::StatefulSet), false, false, "Items is the list of stateful sets.")

    def initialize(*, api_version : String? = "apps/v1", kind : String? = "StatefulSetList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Apps::V1::StatefulSet)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Apps::V1::StatefulSet)},
    ])
  end
end
