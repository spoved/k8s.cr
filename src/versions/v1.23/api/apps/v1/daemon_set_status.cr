...
module K8S
  ...
  @[::K8S::Properties(
    ...
    number_ready: {key: "numberReady", accessor: "number_ready", kind: "Int32", nilable: false, default: nil, read_only: false, description: "numberReady is the number of nodes that should be running the daemon pod and have one or more of the daemon pod running with a Ready Condition.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
