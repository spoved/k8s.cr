...
module K8S
  ...
  @[::K8S::Properties(
    ...
    number_ready: {key: "numberReady", accessor: "number_ready", kind: "Int32", nilable: false, default: nil, read_only: false, description: "numberReady is the number of nodes that should be running the daemon pod and have one or more of the daemon pod running with a Ready Condition."},
