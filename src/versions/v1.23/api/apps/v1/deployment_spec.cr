...
module K8S
  ...
  module Types::Api::Apps::V1::DeploymentSpec
    alias ValueType = Int32 | ::Bool | ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector | ::K8S::Api::Apps::V1::DeploymentStrategy | ::K8S::Api::Core::V1::PodTemplateSpec | Nil
  ...
  @[::K8S::Properties(
    ...
    revision_history_limit: {key: "revisionHistoryLimit", accessor: "revision_history_limit", kind: "Int32", nilable: true, default: nil, read_only: false, description: "The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. Defaults to 10."},
    ...
    strategy: {key: "strategy", accessor: "strategy", kind: "::K8S::Api::Apps::V1::DeploymentStrategy", nilable: true, default: nil, read_only: false, description: "The deployment strategy to use to replace existing pods with new ones."},
  ...
  class Api::Apps::V1::DeploymentSpec < ::K8S::Types::Api::Apps::V1::DeploymentSpec::Instance
    ...
    # The deployment strategy to use to replace existing pods with new ones.
    def strategy : ::K8S::Api::Apps::V1::DeploymentStrategy?
      self.["strategy"].as(::K8S::Api::Apps::V1::DeploymentStrategy?)
    end

    # :ditto:
    def strategy! : ::K8S::Api::Apps::V1::DeploymentStrategy
      self.["strategy"].as(::K8S::Api::Apps::V1::DeploymentStrategy?).not_nil!
    end
    ...
    # :ditto:
    def strategy=(value : ::K8S::Api::Apps::V1::DeploymentStrategy?)
      self.["strategy"] = value
    end
