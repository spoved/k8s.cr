...
module K8S
  ...
  module Types::Api::Apps::V1::StatefulSetStatus
    # Total number of available pods (ready for at least minReadySeconds) targeted by this statefulset. This is a beta field and [[enabled/disabled by StatefulSetMinReadySeconds feature gate.](enabled/disabled by StatefulSetMinReadySeconds feature gate.)]([enabled/disabled by StatefulSetMinReadySeconds feature gate.](enabled/disabled by StatefulSetMinReadySeconds feature gate.))
  ...
  @[::K8S::Properties(
    available_replicas: {key: "availableReplicas", accessor: "available_replicas", kind: "Int32", nilable: false, default: nil, read_only: false, description: "Total number of available pods (ready for at least minReadySeconds) targeted by this statefulset. This is a beta field and [enabled/disabled by StatefulSetMinReadySeconds feature gate.](enabled/disabled by StatefulSetMinReadySeconds feature gate.)", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    ...
    ready_replicas: {key: "readyReplicas", accessor: "ready_replicas", kind: "Int32", nilable: true, default: nil, read_only: false, description: "readyReplicas is the number of pods created for this StatefulSet with a Ready Condition.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  ...
  class Api::Apps::V1::StatefulSetStatus < ::K8S::GenericObject
    ...
    k8s_object_accessor("readyReplicas", ready_replicas : Int32, true, false, "readyReplicas is the number of pods created for this StatefulSet with a Ready Condition.")
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      {key: "availableReplicas", accessor: "available_replicas", nilable: false, read_only: false, default: nil, kind: Int32},
