...
module K8S
  ...
  @[::K8S::Properties(
    available_replicas: {type: Int32, nilable: false, key: "availableReplicas", getter: false, setter: false},
  ...
  class Api::Apps::V1::StatefulSetStatus
    ...
    @[::YAML::Field(key: "availableReplicas", emit_null: true)]
    ...
    def initialize(*, @available_replicas : Int32, @replicas : Int32, @collision_count : Int32 | Nil = nil, @conditions : Array | Nil = nil, @current_replicas : Int32 | Nil = nil, @current_revision : String | Nil = nil, @observed_generation : Int32 | Nil = nil, @ready_replicas : Int32 | Nil = nil, @update_revision : String | Nil = nil, @updated_replicas : Int32 | Nil = nil)
    end
  end
end
