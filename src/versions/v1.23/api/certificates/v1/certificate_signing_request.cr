...
module K8S
  ...
  @[::K8S::Properties(
    ...
    spec: {key: "spec", accessor: "spec", kind: "::K8S::Api::Certificates::V1::CertificateSigningRequestSpec", nilable: false, default: nil, read_only: false, description: "spec contains the certificate request, and is immutable after creation. Only the request, signerName, expirationSeconds, and usages fields can be set on creation. Other fields are derived by Kubernetes and cannot be modified by users.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
    status: {key: "status", accessor: "status", kind: "::K8S::Api::Certificates::V1::CertificateSigningRequestStatus", nilable: true, default: nil, read_only: false, description: "status contains information about whether the request is approved or denied, and the certificate issued by the signer, or the failure condition indicating signer failure.", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Certificates::V1::CertificateSigningRequest < ::K8S::Kubernetes::Resource::Object
    ...
    k8s_object_accessor("spec", spec : ::K8S::Api::Certificates::V1::CertificateSigningRequestSpec, false, false, "spec contains the certificate request, and is immutable after creation. Only the request, signerName, expirationSeconds, and usages fields can be set on creation. Other fields are derived by Kubernetes and cannot be modified by users.")
    k8s_object_accessor("status", status : ::K8S::Api::Certificates::V1::CertificateSigningRequestStatus, true, false, "status contains information about whether the request is approved or denied, and the certificate issued by the signer, or the failure condition indicating signer failure.")

    def initialize(*, api_version : String? = "certificates/v1", kind : String? = "CertificateSigningRequest", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ObjectMeta? = nil, spec : ::K8S::Api::Certificates::V1::CertificateSigningRequestSpec? = nil, status : ::K8S::Api::Certificates::V1::CertificateSigningRequestStatus? = nil)
      super()
