...
module K8S
  ...
  class Api::Networking::V1::NetworkPolicySpec < ::K8S::GenericObject
    ...
    k8s_object_accessor("ingress", ingress : ::Array(::K8S::Api::Networking::V1::NetworkPolicyIngressRule), true, false, "List of ingress rules to be applied to the selected pods. Traffic is allowed to a pod if there are no NetworkPolicies selecting the pod (and cluster policy otherwise allows the traffic), OR if the traffic source is the pod's local node, OR if the traffic matches at least one ingress rule across all of the NetworkPolicy objects whose podSelector matches the pod. If this field is empty then this NetworkPolicy does not allow any traffic (and serves solely to ensure that the pods it selects are isolated by default)")
    ...
    def initialize(*, egress : ::Array(::K8S::Api::Networking::V1::NetworkPolicyEgressRule)? = nil, ingress : ::Array(::K8S::Api::Networking::V1::NetworkPolicyIngressRule)? = nil, pod_selector : ::K8S::Apimachinery::Apis::Meta::V1::LabelSelector? = nil, policy_types : ::Array(String)? = nil)
      super()
      self.["egress"] = egress
