...
module K8S
  ...
  @[::K8S::Properties(
    ...
    scope: {key: "scope", accessor: "scope", kind: "String", nilable: true, default: nil, read_only: false, description: "Scope represents if this refers to a cluster or namespace scoped resource. This may be set to \"Cluster\" (default) or \"Namespace\".", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Networking::V1::IngressClassParametersReference < ::K8S::GenericObject
    ...
    k8s_object_accessor("scope", scope : String, true, false, "Scope represents if this refers to a cluster or namespace scoped resource. This may be set to \"Cluster\" (default) or \"Namespace\".")
