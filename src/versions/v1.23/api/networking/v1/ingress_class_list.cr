...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "spec", type: Api::Networking::V1::IngressClassSpec | Nil, default: nil},
  ...
  class Api::Networking::V1::IngressClassList < ::K8S::Kubernetes::ResourceList(Api::Networking::V1::IngressClass)
    ...
    def initialize(*, @items : Array(Api::Networking::V1::IngressClass), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
