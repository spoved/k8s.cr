...
module K8S
  ...
  class Api::Admissionregistration::V1::ServiceReference < ::K8S::GenericObject
    ...
    def initialize(*, name : String? = nil, namespace : String? = nil, path : String? = nil, port : Int32? = nil)
      super()
      self.["name"] = name
