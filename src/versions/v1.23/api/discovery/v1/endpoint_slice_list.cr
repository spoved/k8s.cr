...
module K8S
  ...
  @[::K8S::Action(name: "post", verb: "post",
    ...
    args: [{name: "address_type", type: String},
           {name: "endpoints", type: Array(Api::Discovery::V1::Endpoint) | Nil, default: nil},
           {name: "metadata", type: Apimachinery::Apis::Meta::V1::ObjectMeta | Nil, default: nil},
           {name: "ports", type: Array(Api::Discovery::V1::EndpointPort) | Nil, default: nil},
  ...
  class Api::Discovery::V1::EndpointSliceList < ::K8S::Kubernetes::ResourceList(Api::Discovery::V1::EndpointSlice)
    ...
    def initialize(*, @items : Array(Api::Discovery::V1::EndpointSlice), @metadata : Apimachinery::Apis::Meta::V1::ListMeta | Nil = nil)
    end
  end
end
