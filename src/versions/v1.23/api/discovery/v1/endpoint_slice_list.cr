...
module K8S::Types::Api::Discovery::V1::EndpointSliceList; end

require "../../../apimachinery/apis/meta/v1/list_meta"
require "./endpoint_slice"

module K8S
  # Namespace holding the types for `Api::Discovery::V1::EndpointSliceList`.
  module Types::Api::Discovery::V1::EndpointSliceList
    ...
    abstract def items : Array(::K8S::Api::Discovery::V1::EndpointSlice)?
    # :ditto:
    abstract def items! : Array(::K8S::Api::Discovery::V1::EndpointSlice)
    # :ditto:
    abstract def items? : Array(::K8S::Api::Discovery::V1::EndpointSlice)?
    # :ditto:
    abstract def items=(value : Array(::K8S::Api::Discovery::V1::EndpointSlice))
  end
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Discovery::V1::EndpointSlice)", nilable: false, default: nil, read_only: false, description: "List of endpoint slices", x_kubernetes_embedded_resource: nil, x_kubernetes_int_or_string: nil, x_kubernetes_preserve_unknown_fields: nil, x_kubernetes_list_map_keys: nil, x_kubernetes_list_type: nil, x_kubernetes_map_type: nil},
  )]
  class Api::Discovery::V1::EndpointSliceList < ::K8S::Kubernetes::Resource::List(::K8S::Api::Discovery::V1::EndpointSlice)
    include ::K8S::Types::Api::Discovery::V1::EndpointSliceList
    ...
    k8s_object_accessor("items", items : Array(::K8S::Api::Discovery::V1::EndpointSlice), false, false, "List of endpoint slices")

    def initialize(*, api_version : String? = "discovery/v1", kind : String? = "EndpointSliceList", metadata : ::K8S::Apimachinery::Apis::Meta::V1::ListMeta? = nil, items : Array(::K8S::Api::Discovery::V1::EndpointSlice)? = nil)
      super()
    ...
    ::K8S::Kubernetes::Resource.define_serialize_methods([
      ...
      {key: "items", accessor: "items", nilable: false, read_only: false, default: nil, kind: Array(::K8S::Api::Discovery::V1::EndpointSlice)},
    ])
  end
end
