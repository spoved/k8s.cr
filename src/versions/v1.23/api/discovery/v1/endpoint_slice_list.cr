...
module K8S
  ...
  @[::K8S::Properties(
    ...
    items: {key: "items", accessor: "items", kind: "Array(::K8S::Api::Discovery::V1::EndpointSlice)", nilable: false, default: nil, read_only: false, description: "List of endpoint slices"},
  )]
